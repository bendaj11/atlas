...
export function ScopePicker({ value, disabled, onChange }: ScopePickerProps): JSX.Element {
  return (
    <Card className="scope-card">
      <Card.Content>
        <Box verticalAlign="middle" gap="12px">
          <Text weight="bold">Apply to</Text>
          <RadioGroup value={value} disabled={disabled} display="horizontal" onChange={(nextValue) => onChange(nextValue as Scope)}>
