import { ArtifactOverrideEditorPageActionsDriver } from './ArtifactOverrideEditorPageActions.driver';

describe('ArtifactOverrideEditorPageActions', () => {
  let driver: ArtifactOverrideEditorPageActionsDriver;

  beforeEach(() => {
    driver = new ArtifactOverrideEditorPageActionsDriver();
  });
  ...
  it('should disable save button when save is disabled', async () => {
    ...
    expect(
      await driver.get.button('save-overrideOptions').isButtonDisabled(),
    ).toBe(true);
  });
  ...
  it('should disable cancel button when cancel is disabled', async () => {
    ...
    expect(
      await driver.get.button('cancel-overrideOptions').isButtonDisabled(),
    ).toBe(true);
  });
