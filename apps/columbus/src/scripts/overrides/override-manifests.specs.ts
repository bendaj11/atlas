...
describe('extractActiveOverrideManifests', () => {
  let driver: OverrideManifestsDriver;

  beforeEach(() => {
    driver = new OverrideManifestsDriver();
  });
...
describe('includeOverrideAppsInCatalog', () => {
  ...
  it('should add the override as a widget provider when a catalog app depends on it', () => {
    ...
    hostData.catalog.apps.push(
      anAppManifest({ id: 'orders', externalAppsDependencies: ['widgets'] }),
    );
