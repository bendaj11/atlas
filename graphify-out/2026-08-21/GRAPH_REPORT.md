# Graph Report - atlas  (2026-08-21)

## Corpus Check
- 560 files · ~201,091 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4889 nodes · 9336 edges · 327 communities (259 shown, 68 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 139 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `9b5ea101`
...
1. `AtlasManifest` - 57 edges
2. `CliArguments` - 40 edges
3. `addIssue()` - 33 edges
4. `runtimeError()` - 31 edges
5. `AtlasHostManifest` - 28 edges
...
## Communities (327 total, 68 thin omitted)
...
Cohesion: 0.11
Nodes (19): ControlServerDriver, ControlServerDriver, createDevSession(), createLocalDevCatalog(), DevSessionEntry, DevelopmentSessionDriver, SessionScenario, HostDevSession (+11 more)
...
Cohesion: 0.19
Nodes (25): artifactKind(), assertDeploymentSelections(), assertDescriptorMap(), assertEnvironmentName(), assertRegistryContents(), assertStaticRegistry(), assertUniqueName(), canonicalJson() (+17 more)

### Community 6 - "overlay-controller.ts"
Cohesion: 0.08
Nodes (11): collect(), MemoryDeployStorage, StoredObject, AtlasPublicationBody, AtlasPublicationListedObject, AtlasPublicationObjectMetadata, AtlasPublicationReplaceCondition, collect() (+3 more)

### Community 7 - "index.ts"
Cohesion: 0.13
Nodes (21): createControlRequestHandler(), joinControlServer(), pathSegment(), readPublishedCatalog(), registerOverride(), respondWithDevelopmentSession(), respondWithSession(), setControlHeaders() (+13 more)
...
Cohesion: 0.08
Nodes (38): LocalBootstrapServerOptions, absoluteHttpUrl(), asRecord(), AssetExpectation, AtlasVerificationCheck, AtlasVerificationReport, AtlasVerificationStatus, AtlasVerifyOptions (+30 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.10
Nodes (31): withLease(), AtlasPublicationLease, AtlasPublicationStorage, createPublicationStorage(), AtlasRegistryConfig, artifactPrefix(), assertExpectedRegistryRevision(), assertMetadata() (+23 more)
...
Cohesion: 0.13
Nodes (5): Assets And Styles, React Production Build and Publication, App Routes And Host Layouts, Routing And Navigation, Troubleshooting
...
Cohesion: 0.09
Nodes (49): mapWithConcurrency(), loadAndMountHostCatalog(), assertDescriptorBytes(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl() (+41 more)
...
Cohesion: 0.09
Nodes (39): AtlasHostMountState, createMountBoundary(), createRoutePlacementPlan(), createRouteTitleController(), createWidgetCard(), createWidgetLoader(), defaultManifestTrustPolicy(), findDefaultPath() (+31 more)
...
Cohesion: 0.07
Nodes (15): createTestContainer(), createTestElement(), createAssetElement(), createHostStatusContainer(), createStylesheetDocument(), getItem(), importWidget(), isTestAssetElement() (+7 more)

### Community 37 - "atlas-host.ts"
Cohesion: 0.09
Nodes (38): createOverrideDocument(), disabledOverridesKey(), DisabledOverrideStorageLocation, AtlasHostDriver, MockTab, storageArea(), errorMessage(), findAtlasHostTab() (+30 more)

### Community 38 - "index.ts"
Cohesion: 0.10
Nodes (20): ATLAS_LOGO, ATLAS_LOGO_GRADIENT_END, ATLAS_LOGO_GRADIENT_START, UiDriver, UiScenario, formatLogo(), gradientColor(), indentContinuationLines() (+12 more)
...
Cohesion: 0.22
Nodes (9): AtlasAppIndex, AtlasArtifactIndex, AtlasExposeMap, AtlasDeploymentCatalog, AtlasHostIndex, AtlasAppManifest, digestToIntegrity(), hydrateApp() (+1 more)
...
Cohesion: 0.12
Nodes (5): AtlasGenerateService, availableAppsMessage(), AtlasScaffoldOptions, AtlasWorkspace, AngularStylesheetFormat

### Community 47 - "publication-storage.ts"
Cohesion: 0.14
Nodes (10): AppComponent, Component, bootstrap(), DemoRouteAnchorComponent, HostMountRequest, Component, HostLayout(), HostMountRequest (+2 more)
...
Cohesion: 0.20
Nodes (9): AtlasPublishResult, PublishServiceDriver, AtlasRegistryMutation, AtlasResolvedRelease, ExternalSnapshot, AtlasEnvironmentDeployment, AtlasManifestDescriptor, AtlasRegistryArtifact (+1 more)

### Community 54 - "AtlasGenerateService"
Cohesion: 0.12
Nodes (15): AtlasDeploymentConvergenceError, AtlasDeployResult, AtlasDeployService, APP_ENTRY, appManifest(), bytesResponse(), CrossRegistryTransfer, DeployServiceDriver (+7 more)
...
Cohesion: 0.11
Nodes (28): asDependencyMap(), AtlasNxProjectType, AtlasPackageManager, AtlasTask, AtlasWorkspaceKind, configuredNxOutputPaths(), createFormatGeneratedCommand(), createNxGenerationCommand() (+20 more)
...
Cohesion: 0.11
Nodes (23): CONTENT_TYPES, publicationContentType(), assertLease(), DeploymentLease, encodeLease(), environmentBoolean(), environmentS3LockMode(), errorName() (+15 more)

### Community 63 - "navigation-types.ts"
Cohesion: 0.15
Nodes (21): completedProcessOutput(), localOrigin(), writeDevOverrideDocument(), browserOpenCommand(), DevelopmentProcessDriver, RemoteEntryScenario, formatFrameworkServerError(), frameworkServerArguments() (+13 more)
...
Cohesion: 0.07
Nodes (27): AngularLiveDevelopmentDriver, SOURCE_PATH, BrowserStorage, isRecord(), readOverride(), restrictExtensionHosts(), StoredOverrideDocument, badgeText() (+19 more)
...
Cohesion: 0.26
Nodes (8): normalizePath(), routeMatches(), segments(), AtlasRouteMount, AtlasPlacement, AtlasPlacementKind, AtlasRouteContribution, AtlasRouteNavigation
...
Cohesion: 0.16
Nodes (12): BadgeCountMessage, clearHostDataCache(), HostDataSnapshot, isExtensionPage(), isHostDataSnapshot(), readHostDataCache(), ACTION_ICON_PATHS, actionIconPathsFor() (+4 more)
...
Cohesion: 0.11
Nodes (29): requiredManifestUrl(), AngularLocalManifest, AngularLocalRuntimeDriver, prepareAngularLocalRuntime(), artifactDirectoryUrl(), createNativeFederationImporters(), createTrustedNativeFederationImporters(), FederationRemote (+21 more)

### Community 92 - "loader.driver.ts"
Cohesion: 0.11
Nodes (15): AtlasAppMountRequest, AtlasAppMountResult, AtlasExportedWidgetMountResult, AppOptions, renderWithAtlasProviders(), RootAdapter, AtlasRuntimeContext, AtlasSdkProvider() (+7 more)
...
Cohesion: 0.11
Nodes (24): AtlasBootstrapService, bootstrapDigest(), cliActions(), cliSummary(), COMMAND_ALIASES, createCliError(), errorCauseMessage(), errorCauses() (+16 more)
...
Cohesion: 0.13
Nodes (14): Before a Pull Request, Contributing to Atlas, Documentation, File Extensions, Releases, Repository Layout, Setup, App Domain (+6 more)
...
Cohesion: 0.03
Nodes (77): AngularHostSdkReference, AngularHostStartServices, renderLoading(), AppBootstrap, createExportedWidget(), defineExportedWidget(), ATLAS_APP_CONTEXT, ATLAS_SDK (+69 more)
...
Cohesion: 0.07
Nodes (30): DomHostOptions, createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, RoutePlacement, AtlasHostRuntimeOptions (+22 more)
...
Cohesion: 0.15
Nodes (31): affectedHostIds(), asAsyncIterable(), assertBytes(), assertExpectedRevision(), assertResponseMetadata(), assertSelectedManifestIdentity(), assertStoredMetadata(), collectWidgetProviderIds() (+23 more)
...
Cohesion: 0.08
Nodes (42): SupportedFramework, asStringRecord(), DEPENDENCY_FIELDS, dependencyDeclared(), DependencyField, dependencyManifestPath(), existingFrameworkVersionInfo(), frameworkPrimaryDependency() (+34 more)
...
Cohesion: 0.18
Nodes (20): readAtlasNavigationItems(), subscribeAtlasNavigationItems(), anchorTag(), AtlasDefaultHostLayout(), AtlasHostAnchorsContext, AtlasHostProvider(), AtlasHostProviderProps, AtlasHostStatus() (+12 more)
...
Cohesion: 0.15
Nodes (25): AtlasAppConfig, AtlasBaseConfig, AtlasConfig, AtlasHostConfig, AtlasSlotMount, AtlasWidgetConfig, AtlasAppDomIsolation, AtlasDomIsolation (+17 more)
...
Cohesion: 0.18
Nodes (11): devDependencies, @babel/core, @babel/plugin-syntax-typescript, @stylable/runtime, @types/react, @wix/wix-ui-icons-common, @types/react, @babel/core (+3 more)
...
Cohesion: 0.14
Nodes (15): CliErrorDriver, ErrorScenario, actionableMessage(), AtlasError, AtlasErrorOptions, AtlasErrorSurface, ensureActionableError(), errorSummary() (+7 more)

### Community 235 - "generation.driver.ts"
Cohesion: 0.15
Nodes (9): CliArguments, DevelopmentPortsDriver, PortScenario, hostClientPortFallback(), resolveHostDevPorts(), DevelopmentScenario, DevServiceDriver, HostDevPorts (+1 more)
...
Cohesion: 0.36
Nodes (11): appendHostStylesheet(), defaultDependencies(), hasCompletedFederationBuild(), HostLoaderDependencies, installHostSharedDependencies(), loadHostModule(), loadHostStyles(), watchHostBuildNotifications() (+3 more)

### Community 239 - "react-dom"
Cohesion: 0.06
Nodes (28): addNavigationState(), AtlasNavigationTarget, createAppNavigator(), AppNavigatorDriver, AtlasAppContext, appendQueryValue(), matchRoutePart(), matchRoutePattern() (+20 more)

### Community 243 - "ts-jest"
Cohesion: 0.34
Nodes (12): AtlasLoaderDependencies, defaultDependencies(), deploymentReferences(), loadDeployment(), loadInitialCatalog(), mapWithConcurrency(), startAtlasLoader(), fetchBytes() (+4 more)

### Community 245 - "@types/babel__core"
Cohesion: 0.07
Nodes (33): ATLAS_BROWSER_LOADER, createBrowserAssetFiles(), MODULE_SHIM_SOURCE, require, createAtlasBootstrapFiles(), requiredRuntime(), runtimeAssetOrigins(), validateRuntime() (+25 more)

### Community 246 - "AngularLiveDevelopmentDriver"
Cohesion: 0.38
Nodes (3): digest(), providerManifest(), WidgetRegistryDriver
...
Cohesion: 0.57
Nodes (4): AtlasArtifactManifestBase, AtlasStylesheet, AtlasVersionChannel, CreateManifestFromConfigInput

### Community 260 - "Angular Generators"
Cohesion: 0.17
Nodes (15): createDeferred(), createHostCatalog(), createRouteManifest(), createRoutePlacement(), createSlotManifest(), createTestDocument(), createWidgetRendererContainer(), duplicateRegistryWidgetResult() (+7 more)
...
### Community 265 - "atlas-placement.ts"
Cohesion: 0.67
...
### Community 311 - "PromptTestDouble"
Cohesion: 0.17
...
- **Why does `AtlasManifest` connect `Static registry` to `index.ts`, `dom-host-runtime.ts`, `Contributing to Atlas`, `prepare-release.specs.ts`, `verify.service.ts`, `contracts.ts`, `react-dom`, `remote-assets.ts`, `cli.service.ts`, `react.ts`, `AngularLiveDevelopmentDriver`, `runtime-discovery.ts`, `react-router.ts`, `ArtifactsOverridesTable.tsx`, `AtlasManifest`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `versionPackages()` connect `prepare-release.js` to `content-script.ts`, `overlay-controller.ts`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `reference()` connect `AngularWidgetOutletController` to `runtime-discovery.ts`, `ts-jest`, `HttpClient`?**
