...
## Corpus Check
- 541 files · ~186,856 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4752 nodes · 8817 edges · 309 communities (243 shown, 66 thin omitted)
...
## Communities (309 total, 66 thin omitted)
...
Cohesion: 0.07
Nodes (33): ControlServerDriver, ControlServerDriver, startControlServer(), startOwnedControlServer(), closeServer(), isAddressInUse(), DevelopmentPortsDriver, PortScenario (+25 more)

### Community 4 - "workspace.ts"
Cohesion: 0.26
Nodes (8): findRoutePlacement(), normalizePath(), routeMatches(), segments(), AtlasPlacement, AtlasPlacementKind, AtlasRouteContribution, AtlasRouteNavigation
...
Cohesion: 0.14
Nodes (13): createControlRequestHandler(), pathSegment(), readProductionCatalog(), registerOverride(), respondWithCatalog(), respondWithSession(), respondWithVersionIndex(), setControlHeaders() (+5 more)
...
Cohesion: 0.16
Nodes (22): AtlasAppIndex, AtlasArtifactIndex, AtlasArtifactManifestBase, AtlasAppConfig, AtlasBaseConfig, AtlasConfig, AtlasHostConfig, AtlasRouteMount (+14 more)
...
Cohesion: 0.05
Nodes (67): mapWithConcurrency(), createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, AtlasHostRuntimeOptions, AtlasLoaderOptions (+59 more)
...
Cohesion: 0.11
Nodes (20): CliArguments, cliVersion(), configuredArtifactIds(), configuredRuntimeUrls(), positiveInteger(), printVerificationCheck(), publishAndVerify(), rollbackAndVerify() (+12 more)
...
Cohesion: 0.14
Nodes (5): AtlasGenerateService, availableAppsMessage(), AtlasNxProjectType, AtlasScaffoldOptions, AngularStylesheetFormat
...
Cohesion: 0.13
Nodes (18): completedProcessOutput(), writeDevOverrideDocument(), browserOpenCommand(), DevelopmentProcessDriver, RemoteEntryScenario, formatFrameworkServerError(), frameworkServerArguments(), logHostViewUrl() (+10 more)
...
Cohesion: 0.44
Nodes (6): createPublicationStorage(), assertExpectedRegistryRevision(), AtlasPublishService, publicationOrder(), readRegistry(), withPublicationLease()
...
Cohesion: 0.05
Nodes (33): renderLoading(), AppBootstrap, createExportedWidget(), defineExportedWidget(), AtlasEventMap, AtlasAppContext, AtlasAppMountRequest, AtlasAppMountResult (+25 more)
...
Cohesion: 0.07
Nodes (31): AngularWidgetRuntime, AtlasFetchHttpClient, HttpClientInput, HttpRequest, HttpRequestOptions, HttpRequestWithBody, HttpRequestWithBodyAndMethod, HttpRequestWithoutBody (+23 more)

### Community 129 - "angular.specs.ts"
Cohesion: 0.06
Nodes (18): AppComponent, Component, bootstrap(), DemoRouteAnchorComponent, HostMountRequest, Component, HostLayout(), HostMountRequest (+10 more)
...
Cohesion: 0.07
Nodes (29): addNavigationState(), AtlasNavigationTarget, createAppNavigator(), AppNavigatorDriver, createHostNavigation(), BrowserWindowLike, createBrowserNavigation(), appendQueryValue() (+21 more)
...
Cohesion: 0.10
Nodes (33): AtlasPublicationStorage, artifactIndexPath(), artifactPrefix(), assertPublicationMetadata(), AtlasPrPruneResult, AtlasPrRemovalResult, AtlasPublicationInventory, AtlasPublishResult (+25 more)
...
Cohesion: 0.20
Nodes (12): assertAtlasManifest(), AtlasValidationError, formatAtlasValidationMessage(), createManifestFromConfig(), identifierFromRoute(), identifierFromSlot(), placements(), routePlacementId() (+4 more)

### Community 160 - "env.ts"
Cohesion: 0.11
Nodes (24): SupportedFramework, FrameworkVersionInfo, readJsonFile(), writeJsonFile(), frameworkLabel(), alignDelegatedTsconfig(), NxDevTargetOptions, ATLAS_HOST_FILES (+16 more)
...
Cohesion: 0.15
Nodes (20): BootstrapScenario, BootstrapServerDriver, createBootstrapFileMap(), createBootstrapRequestHandler(), createUpgradeRequest(), hasFileExtension(), isBootstrapMethod(), matchesNativeProxyRoute() (+12 more)
...
Cohesion: 0.60
Nodes (3): RegistrySnapshot, AtlasProductionSelection, AtlasStaticRegistry
...
Cohesion: 0.18
Nodes (21): uniquePullRequests(), hostPlacements(), runtimeError(), RuntimeErrorOptions, assertRegistry(), assertWidgetId(), compareNewestFirst(), createRegistryWidgetResolver() (+13 more)
...
- **Why does `AtlasWorkspace` connect `CliArguments` to `env.ts`, `dom-host-runtime.ts`, `cli.service.ts`, `angular.ts`, `angular-widget.ts`, `cli.service.ts`, `types.ts`, `target.ts`, `navigation-types.ts`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `AtlasManifest` connect `ArtifactsOverridesTable.tsx` to `ArtifactConfigurationPage.tsx`, `dom-host-runtime.ts`, `Angular Generators`, `build.driver.ts`, `verify.service.ts`, `verify-generated-projects.js`, `background.ts`, `remote-assets.ts`, `cli.service.ts`, `Security`, `react-router.ts`, `runtime-discovery.ts`, `loader.driver.ts`, `React SDK`, `overlay.ts`?**
