...
## Corpus Check
- 541 files · ~185,291 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4734 nodes · 8289 edges · 323 communities (253 shown, 70 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 122 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `101ac8b6`
...
1. `AtlasManifest` - 37 edges
2. `addIssue()` - 33 edges
3. `CliArguments` - 32 edges
4. `AtlasHostManifest` - 28 edges
5. `generateAngularAppFiles()` - 26 edges
6. `runAtlasCli()` - 24 edges
7. `AtlasExtensionManifest` - 23 edges
8. `AtlasWorkspace` - 23 edges
9. `AtlasGenerateService` - 23 edges
10. `AtlasHostCatalog` - 23 edges

## Surprising Connections (you probably didn't know these)
- `loadAndMountHostCatalog()` --indirect_call--> `manifest()`  [INFERRED]
  packages/runtime/src/index.ts → apps/columbus/src/scripts/host/inspect-atlas-host/inspect-atlas-host.driver.ts
- `mountApp()` --indirect_call--> `manifest()`  [INFERRED]
  packages/runtime/src/index.ts → apps/columbus/src/scripts/host/inspect-atlas-host/inspect-atlas-host.driver.ts
- `findManifestTrustErrors()` --indirect_call--> `manifest()`  [INFERRED]
  packages/runtime/src/loader/runtime-discovery.ts → apps/columbus/src/scripts/host/inspect-atlas-host/inspect-atlas-host.driver.ts
- `resolveRuntimeCatalog()` --indirect_call--> `manifest()`  [INFERRED]
  packages/runtime/src/loader/runtime-discovery.ts → apps/columbus/src/scripts/host/inspect-atlas-host/inspect-atlas-host.driver.ts
- `verifyManifestIntegrity()` --indirect_call--> `manifest()`  [INFERRED]
  packages/runtime/src/loader/runtime-discovery.ts → apps/columbus/src/scripts/host/inspect-atlas-host/inspect-atlas-host.driver.ts
...
Cohesion: 0.18
Nodes (10): createHostCatalog(), createTestContainer(), createTestElement(), duplicateRegistryWidgetResult(), duplicateWidgetResult(), testHostManifest(), widgetManifest(), widgetProvider() (+2 more)
...
Cohesion: 0.21
Nodes (14): mapWithConcurrency(), artifactDirectoryUrl(), createNativeFederationImporters(), createTrustedNativeFederationImporters(), federationRemoteName(), fetchRemoteBytes(), hasMountFunction(), importNativeFederationRemote() (+6 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.06
Nodes (24): ControlServerDriver, ControlServerDriver, nonInteractivePrompter, AngularBuildPrivateApi, loadAngularHostProxy(), createDevSession(), createLocalDevCatalog(), DevSessionEntry (+16 more)
...
Cohesion: 0.07
Nodes (48): ATLAS_BROWSER_LOADER, createAtlasBootstrapFiles(), createBootstrapHtml(), createNginxConfig(), cspSources(), escapeHtml(), MODULE_SHIM_SOURCE, normalizedOrigins() (+40 more)
...
Cohesion: 0.14
Nodes (26): AtlasResolvedWidget, AtlasAppIndex, AtlasArtifactIndex, AtlasArtifactManifestBase, AtlasAppConfig, AtlasBaseConfig, AtlasHostConfig, AtlasRouteMount (+18 more)
...
Cohesion: 0.15
Nodes (3): Assets And Styles, App Routes And Host Layouts, Routing And Navigation

### Community 19 - "cli.service.ts"
Cohesion: 0.06
Nodes (34): AngularWorkspaceDocument, GeneratedFramework, GeneratedProjectType, GenerationE2eDriver, NxProjectDocument, PackageDocument, createPromptDriver(), GenerateScenario (+26 more)

### Community 20 - "AtlasNavigation"
Cohesion: 0.16
Nodes (6): AtlasHostRuntimeOptions, AtlasRuntimeController, createRuntimeMount(), placementKey(), startAtlasHostRuntime(), AtlasWidgetLoader

### Community 21 - "dev.service.ts"
Cohesion: 0.11
Nodes (23): cliActions(), cliSummary(), COMMAND_ALIASES, createCliError(), CliErrorDriver, ErrorScenario, errorCauseMessage(), errorCauses() (+15 more)

### Community 22 - "manifest-utils.ts"
Cohesion: 0.12
Nodes (27): OverrideVersionDropdown(), VersionDropdownProps, versionOptionLabel(), ArtifactOverrideVersion(), ArtifactOverrideVersionDriver, createArtifact(), manifest(), OVERRIDE_TYPE_LABELS (+19 more)
...
Cohesion: 0.12
Nodes (35): assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl(), bytesToBase64(), catalogSelectionError(), defaultFetchBytes() (+27 more)

### Community 25 - "native-federation.ts"
Cohesion: 0.06
Nodes (44): start(), bootstrapActions(), describeFatalError(), FatalErrorDriver, showFatalError(), FetchJsonDriver, fetchJson(), validateIntegrity() (+36 more)

### Community 26 - "ArtifactsOverridesTable.tsx"
Cohesion: 0.10
Nodes (13): withAtlasSdkProvider(), AppBootstrap, createExportedWidget(), defineExportedWidget(), provideAtlasSdk(), AtlasAppEntry, AtlasAppMountRequest, AtlasAppMountResult (+5 more)
...
Cohesion: 0.07
Nodes (10): createAssetElement(), createStylesheetDocument(), fetchJson(), importWidget(), isTestAssetElement(), isTestStyleLink(), TestAssetElement, TestStyleLink (+2 more)

### Community 37 - "atlas-host.ts"
Cohesion: 0.09
Nodes (37): createOverrideDocument(), disabledOverridesKey(), DisabledOverrideStorageLocation, AtlasHostDriver, MockTab, storageArea(), findAtlasHostTab(), hasTabId() (+29 more)

### Community 38 - "index.ts"
Cohesion: 0.12
Nodes (19): AngularHostBootstrapOptions, AngularHostDataInput, AngularHostDataOption, AtlasDefaultHostRouteComponent, AtlasNavigationItemsService, bootstrapAngularHost(), HostMountRequest, HostOptions (+11 more)
...
Cohesion: 0.14
Nodes (13): InspectAtlasHostDriver, installPage(), jsonResponse(), PageOptions, storage(), inspectAtlasHost(), ManifestUtilsDriver, ManifestVersionsDriver (+5 more)
...
Cohesion: 0.15
Nodes (16): AtlasRuntimeObserver, eventTimestamp(), actionForStage(), AtlasLoadError, AtlasOperationContext, AtlasRetryPolicy, AtlasRetryPolicySource, delay() (+8 more)
...
Cohesion: 0.07
Nodes (37): AppReadiness, AtlasLoaderOptions, AtlasMountedApp, AtlasWidgetErrorRenderContext, AtlasWidgetLoaderOptions, AtlasWidgetRenderContext, createAppReadiness(), createLoadingEmitter() (+29 more)
...
Cohesion: 0.08
Nodes (15): AtlasBootstrapBuildResult, AtlasBootstrapService, AtlasBootstrapServiceOptions, AtlasRuntimeConfigRenderResult, BootstrapBuildService, bootstrapDigest(), defaultDependencies, SupportedFramework (+7 more)

### Community 56 - "target.ts"
Cohesion: 0.11
Nodes (29): asDependencyMap(), AtlasNxProjectType, AtlasPackageManager, AtlasScaffoldOptions, AtlasTask, AtlasWorkspaceKind, configuredNxOutputPaths(), createFormatGeneratedCommand() (+21 more)
...
Cohesion: 0.26
Nodes (12): darkColorScheme, fetchAtlasConfig(), isLoopbackBadgeHost(), isOverrideDocument(), overrideCount(), parseJson(), readAtlasConfig(), readBadgeDisabledAppIds() (+4 more)
...
Cohesion: 0.29
Nodes (5): encodeLease(), isMissingObject(), requiredEtag(), S3PublicationStorage, storageError()

### Community 63 - "navigation-types.ts"
Cohesion: 0.09
Nodes (32): asObject(), configuredHostIds(), DevelopmentConfigDriver, firstObjectValue(), hostIdFromRoute(), isHostConfig(), objectValue(), parsePort() (+24 more)
...
Cohesion: 0.15
Nodes (16): assertLease(), AtlasPublicationStorageSource, DeploymentLease, environmentBoolean(), environmentS3LockMode(), errorName(), errorStatus(), externalPublicationLease() (+8 more)
...
Cohesion: 0.10
Nodes (52): UiDriver, UiScenario, indentContinuationLines(), Status, STATUS_COLORS, STATUS_SYMBOLS, style(), TerminalPrompter (+44 more)
...
Cohesion: 0.09
Nodes (24): ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdkFactory, createAtlasHostDataSignal(), injectAppLoaded(), injectAtlasAppContext(), injectAtlasSdk(), ActiveWidget (+16 more)
...
Cohesion: 0.19
Nodes (17): AtlasPublishConfig, AtlasPullRequestLookup, AtlasPullRequestResolver, AtlasPullRequestStatus, compilePublishConfig(), defineAtlasPublishConfig(), isNodeError(), isPublishConfig() (+9 more)
...
Cohesion: 0.16
Nodes (6): AtlasBootstrapFile, AtlasBootstrapOptions, AtlasBootstrapDependencies, AtlasBootstrapServiceDriver, BuildSetup, AtlasProject
...
Cohesion: 0.07
Nodes (31): readWidgetRuntime(), AtlasFetchHttpClient, HttpClientInput, HttpRequest, HttpRequestOptions, HttpRequestWithBody, HttpRequestWithBodyAndMethod, HttpRequestWithoutBody (+23 more)
...
Cohesion: 0.08
Nodes (23): Input, AtlasAnchorComponent, AtlasAngularHostAnchors, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot (+15 more)
...
Cohesion: 0.08
Nodes (23): appendQueryValue(), matchRoutePart(), matchRoutePattern(), normalizePath(), parseQuery(), scopePath(), splitRoutePath(), toInnerPath() (+15 more)
...
Cohesion: 0.09
Nodes (42): AtlasPublicationStorage, createPublicationStorage(), artifactIndexPath(), artifactPrefix(), assertPublicationMetadata(), AtlasPrPruneResult, AtlasPrRemovalResult, AtlasPublicationInventory (+34 more)
...
Cohesion: 0.15
Nodes (14): createHostNavigationItems(), documentNavigationItems, normalizeRoutePath(), routeMatches(), RoutePlacement, routePlacementsForHost(), uniqueRoutePlacements(), normalizePath() (+6 more)
...
Cohesion: 0.21
Nodes (4): hostRemoteBytes, remoteBytes, VerificationScenario, VerifyServiceDriver
...
Cohesion: 0.14
Nodes (23): DomHostOptions, DomHostServices, DomRuntimeOptions, assertCatalogMatchesConfig(), DomHostRuntimeInput, resolveDomSlotContainer(), resolveHostConfig(), startDomHostRuntime() (+15 more)
...
Cohesion: 0.08
Nodes (40): asStringRecord(), DEPENDENCY_FIELDS, dependencyDeclared(), DependencyField, dependencyManifestPath(), existingFrameworkVersionInfo(), frameworkPrimaryDependency(), FrameworkVersionInfo (+32 more)
...
Cohesion: 0.23
Nodes (4): AtlasNativeFederationImporters, AssetUrlDriver, AtlasManifest, AtlasSlotRenderRequest
...
Cohesion: 0.15
Nodes (12): ArtifactConfigurationActions(), ArtifactConfigurationActionsProps, ArtifactConfigurationActionsDriver, ArtifactConfigurationPage(), OverrideRadioCardProps, OverridesSelectionForm(), OverridesSelectionFormProps, ArtifactConfigurationLocationState (+4 more)
...
Cohesion: 0.25
Nodes (13): cliVersion(), configuredArtifactIds(), configuredRuntimeUrls(), positiveInteger(), printVerificationCheck(), publishAndVerify(), rollbackAndVerify(), runAtlasCli() (+5 more)
...
Cohesion: 0.20
Nodes (20): runtimeError(), assertRegistry(), assertWidgetId(), AtlasWidgetResolver, compareNewestFirst(), createRegistryWidgetResolver(), fetchRegistry(), indexWidgets() (+12 more)
...
Cohesion: 0.08
Nodes (18): App(), ArtifactsOverridesPage(), ArtifactName(), ArtifactOverrideActions(), ArtifactOverrideToggle(), ArtifactsOverridesTable(), OverridesTableToolbarDriver, OverridesTableToolbar() (+10 more)
...
Cohesion: 0.08
Nodes (8): createLocationStrategy(), notifyPopState(), PopStateListener, readInnerUrl(), LocationLike, LocationStrategyAdapter, RouterLike, AtlasAppContext
...
### Community 298 - "observability.ts"
Cohesion: 0.48
...
Cohesion: 0.10
Nodes (13): CliArguments, AtlasInvocation, InteractionDriver, InteractionScenario, resolveInvocation(), PromptTestDouble, title(), AtlasPrompter (+5 more)

### Community 302 - "angular.driver.ts"
Cohesion: 0.24
Nodes (3): createAppContext(), files(), splitUrl()

### Community 306 - "BrowserWindowLike"
Cohesion: 0.38
...
### Community 308 - "directory-publication-storage.ts"
Cohesion: 0.47
...
### Community 311 - "./federation-config"
Cohesion: 0.50
...
## Knowledge Gaps
- **1623 isolated node(s):** `Build And Install`, `Source Layout`, `Use`, `Verification`, `Troubleshooting` (+1618 more)
...
- `AtlasDevService` (2× useful, score=1.001336578) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `manifest()` connect `atlas-host.ts` to `AtlasManifest`, `loader.specs.ts`, `angular.ts`, `dependencies.ts`, `contracts.ts`, `Workspace integration`, `runtime-discovery.ts`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `CliArguments` connect `ui.specs.ts` to `process.ts`, `dom-host-runtime.ts`, `overlay-controller.ts`, `angular.ts`, `cli.service.ts`, `AtlasGenerateService`, `types.ts`, `AngularWidgetOutletController`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `PublishServiceDriver` connect `publication-storage.ts` to `overlay-controller.ts`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **What connects `Build And Install`, `Source Layout`, `Use` to the rest of the system?**
