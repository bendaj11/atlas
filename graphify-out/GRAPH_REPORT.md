# Graph Report - atlas  (2026-09-07)

## Corpus Check
- 638 files · ~226,635 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5273 nodes · 9441 edges · 363 communities (292 shown, 71 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 128 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `47e12a47`
...
- .run
- FailingMutableStorage
- compilerOptions
- contracts.ts
- compilerOptions
- angular-widget.ts
- publication-storage.ts
- package.json
- manifest.json
- static-registry.ts
- sdk-factory.ts
...
- resilience.ts
- deploy.service.driver.ts
- DirectoryPublicationStorage
...
- compilerOptions
- compilerOptions
- AtlasRuntimeController
- compilerOptions
- federation-config.specs.ts
- devDependencies
- prepare-release.js
- extension.specs.ts
...
- widget-adapters.specs.ts
- session.ts
- [Unreleased]
- angular-local-runtime.ts
- angular-bootstrap.driver.ts
...
- generation.driver.ts
- widget-registry.ts
- routing.md
- extraction-spec.md
- native-host-anchors.md
- README.md
- README.md
- README.md
- README.md
...
- es-module-shims
- prepare-release.driver.ts
- event-bus.ts
- bootstrap-server.driver.ts
- README.md
- bootstrap.specs.ts
- @stylable/optimizer
- publication-storage.driver.ts
- README.md
- README.md
- README.md
- README.md
...
- React SDK
- { createReactAppViteConfig, createReactHostViteConfig, createReactWidgetEntries, }
- {
...
- Build A React App
- publication-context.specs.ts
- create-manifest-from-config-input.ts
- createTaskCommand
- ports.driver.ts
- @atlas/sdk
...
- @types/jest
- dependencies
- publication-metadata.ts
- overlay.ts
- babel-plugin-react-compiler
- Releasing Atlas packages
- Get Started With Atlas
- vite.badge.config.ts
- @angular/animations
- mount
- BrowserWindowLike
- NetworkLimiter
...
1. `AtlasManifest` - 34 edges
2. `addIssue()` - 33 edges
3. `CliArguments` - 31 edges
4. `AtlasNavigation` - 28 edges
5. `AtlasPublicationStorage` - 26 edges
6. `AtlasExtensionManifest` - 26 edges
7. `detectWorkspace()` - 25 edges
8. `S3PublicationStorage` - 23 edges
9. `AtlasGenerateService` - 23 edges
10. `runtimeError()` - 23 edges

## Surprising Connections (you probably didn't know these)
- `readRuntimeErrors()` --indirect_call--> `message()`  [INFERRED]
  apps/columbus/src/scripts/host/inspect-atlas-host/inspect-atlas-host.ts → packages/cli/src/deployment/deploy.service.ts
- `loadDeployment()` --indirect_call--> `reference()`  [INFERRED]
  packages/bootstrap/src/atlas-loader/atlas-loader.ts → apps/columbus/src/scripts/host/inspect-atlas-host/inspect-atlas-host.ts
- `assertHostDeploymentManifest()` --indirect_call--> `reference()`  [INFERRED]
  packages/schema/src/publication-validation.ts → apps/columbus/src/scripts/host/inspect-atlas-host/inspect-atlas-host.ts
- `bootstrap()` --indirect_call--> `loadRemoteModule()`  [INFERRED]
  examples/hosts/demo-angular-host/src/bootstrap.ts → packages/runtime/src/index.specs.ts
- `mountHost()` --indirect_call--> `initFederation()`  [INFERRED]
  examples/hosts/demo-react-host/src/bootstrap.tsx → packages/runtime/src/index.specs.ts
...
## Communities (363 total, 71 thin omitted)

### Community 0 - "index.ts"
Cohesion: 0.09
Nodes (12): MountedWidgetState, AtlasAppMountRequest, AtlasAppMountResult, AtlasExportedWidgetMountRequest, AtlasExportedWidgetMountResult, AtlasHostClientEntry, AtlasMountedWidget, AppOptions (+4 more)

### Community 1 - "react-generator.ts"
Cohesion: 0.17
Nodes (26): appConfig(), atlasAppConfig(), atlasBootstrapHtml(), atlasHostConfig(), atlasHostStyles(), json(), title(), reactAppApp() (+18 more)

### Community 2 - "AtlasManifest"
Cohesion: 0.07
Nodes (10): createAssetElement(), createStylesheetDocument(), importWidget(), isTestAssetElement(), isTestStyleLink(), mount(), TestAssetElement, TestStyleLink (+2 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.22
Nodes (11): AtlasArtifactPreviewState, AtlasArtifactPreviewStateEntry, AtlasPreviewStateFile, defaultDependencies, PullRequestStateDriver, StateScenario, isArtifactPreviewStateEntry(), isPreviewNumber() (+3 more)

### Community 4 - "workspace.ts"
Cohesion: 0.11
Nodes (16): RoutePlacement, AtlasNativeFederationImporters, AtlasRuntimeOverride, AssetUrlDriver, normalizePath(), routeMatches(), segments(), AtlasRouteMount (+8 more)

### Community 5 - "build.driver.ts"
Cohesion: 0.19
Nodes (24): angularAppAppComponent(), angularAppConfig(), angularAppDetailsComponent(), angularAppEntry(), angularAppHomeComponent(), angularAppMain(), angularAppRoutes(), angularSinglePageAppComponent() (+16 more)

### Community 6 - "overlay-controller.ts"
Cohesion: 0.14
Nodes (12): AppReadiness, AtlasMountedApp, AtlasRuntimeController, createAppReadiness(), createLoadingEmitter(), createRuntimeMount(), findRoutePlacement(), hostPlacements() (+4 more)

### Community 7 - "index.ts"
Cohesion: 0.12
Nodes (23): BootstrapScenario, BootstrapServerDriver, createControlRequestHandler(), developmentSession(), joinControlServer(), pathSegment(), registerOverride(), respondWithDevelopmentSession() (+15 more)
...
Cohesion: 0.15
Nodes (15): build, serve, serve-original, builder, configurations, options, architect, dev (+7 more)

### Community 10 - "verify.service.ts"
Cohesion: 0.08
Nodes (34): absoluteHttpUrl(), asRecord(), AssetExpectation, AtlasVerificationCheck, AtlasVerificationReport, AtlasVerificationStatus, AtlasVerifyOptions, AtlasVerifyService (+26 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.10
Nodes (29): writeJson(), AtlasPublicationStorage, artifactPrefix(), assertExpectedRegistryRevision(), assertMetadata(), assertPayload(), assertPreviewIsCurrent(), assertPublicRegistryConfigured() (+21 more)
...
Cohesion: 0.07
Nodes (57): AssetResolver, createRemoteAssetResolver(), isExternalUrl(), isFragmentUrl(), rewriteCssUrls(), addDocumentStyleRewriteSession(), angularStyleScopeAttributeNames(), createDocumentStyleRewriteRegistry() (+49 more)
...
Cohesion: 0.13
Nodes (10): Architecture, Assets And Styles, Manifest contracts, React Production Build and Publication, Columbus extension policy, Package checks, Prepare a release, Publishing policy (+2 more)

### Community 19 - "cli.service.ts"
Cohesion: 0.12
Nodes (21): angularComponentCount(), appDocument(), assertSingleComponentDeclaration(), availablePort(), catalogManifestIds(), closeServer(), closingJoinedAppPreservesHost(), defaultProject (+13 more)

### Community 20 - "AtlasNavigation"
Cohesion: 0.08
Nodes (39): AngularLocalManifest, AngularLocalRuntimeDriver, prepareAngularLocalRuntime(), artifactDirectoryUrl(), createNativeFederationImporters(), createTrustedNativeFederationImporters(), FederationRemote, federationRemoteName() (+31 more)
...
Cohesion: 0.19
Nodes (16): DomRuntimeOptions, MountStateRenderingOptions, prepareStatusElement(), renderErrorState(), renderHostMountState(), renderLoadingState(), AtlasHostNavigationItem, createHostNavigationItems() (+8 more)
...
Cohesion: 0.13
Nodes (13): AtlasBootstrapFile, assertHostConfig(), AtlasBootstrapBuildResult, AtlasBootstrapDependencies, AtlasBootstrapService, bootstrapDigest(), defaultDependencies, AtlasBootstrapServiceDriver (+5 more)

### Community 26 - "ArtifactsOverridesTable.tsx"
Cohesion: 0.10
Nodes (21): jest-environment-jsdom, devDependencies, @angular/compiler, @angular/compiler-cli, @faker-js/faker, jest-environment-jsdom, react-dom, @testing-library/dom (+13 more)
...
Cohesion: 0.05
Nodes (42): es-module-shims, esbuild, bugs, dependencies, @atlas/schema, es-module-shims, description, devDependencies (+34 more)

### Community 30 - "publish.service.ts"
Cohesion: 0.18
Nodes (18): asObject(), configuredHostIds(), DevelopmentConfigDriver, firstObjectValue(), hostIdFromRoute(), isHostConfig(), objectValue(), parsePort() (+10 more)

### Community 31 - "compilerOptions"
Cohesion: 0.05
Nodes (37): compilerOptions, baseUrl, composite, declaration, lib, module, moduleResolution, noUnusedLocals (+29 more)

### Community 32 - "package.json"
Cohesion: 0.06
Nodes (32): bugs, dependencies, @atlas/bootstrap, @atlas/schema, description, engines, node, exports (+24 more)
...
### Community 34 - "app.ts"
Cohesion: 0.14
Nodes (20): BrowserOverrideScopePicker(), BrowserOverrideScopePickerDriver, ScopePickerProps, OverridesContext, OverridesContextValue, SessionContext, SessionContextValue, clearAllOverridesInSession() (+12 more)
...
Cohesion: 0.16
Nodes (23): readAtlasNavigationItems(), subscribeAtlasNavigationItems(), anchorTag(), AtlasDefaultHostLayout(), AtlasHostAnchorsContext, AtlasHostLayout(), AtlasHostProvider(), AtlasHostProviderProps (+15 more)

### Community 37 - "atlas-host.ts"
Cohesion: 0.08
Nodes (41): readActiveHost(), createOverrideDocument(), disabledOverridesKey(), DisabledOverrideStorageLocation, AtlasHostDriver, MockTab, storageArea(), errorMessage() (+33 more)

### Community 38 - "index.ts"
Cohesion: 0.08
Nodes (27): readWidgetRuntime(), AtlasEventBus, AtlasEventListener, createAtlasEventBus(), EventKey, notifyListener(), PayloadEventKey, PayloadlessEventKey (+19 more)

### Community 39 - "compilerOptions"
Cohesion: 0.06
Nodes (32): apps/**/*.driver.ts, apps/**/*.driver.tsx, apps/**/*.specs.ts, apps/**/*.specs.tsx, dist, jest, node, node_modules (+24 more)

### Community 40 - "Production deployment and CI"
Cohesion: 0.19
Nodes (20): addUniquePolyfill(), asObject(), configureAngularBuildNotifications(), configureAngularDevelopmentTargets(), AngularGenerationDriver, enableAngularBuildNotifications(), ensureAngularBuildNotifications(), ensureAngularFederationPolyfills() (+12 more)

### Community 41 - ".run"
Cohesion: 0.24
Nodes (14): artifactUrl(), assertAtlasRuntimeConfig(), assertDevelopmentSessionUrl(), assertOptionalInteger(), assertRegistryUrl(), assertRuntimeConfigFields(), assertSegment(), RuntimeConfigDriver (+6 more)

### Community 42 - "FailingMutableStorage"
Cohesion: 0.12
Nodes (21): artifactoryOptions(), artifactoryPublicUrl(), assertLease(), AtlasPublicationStorageSource, createPublicationStorage(), DeploymentLease, PublicationStorageDriver, STORAGE_ENVIRONMENT_KEYS (+13 more)

### Community 43 - "compilerOptions"
Cohesion: 0.06
Nodes (32): compilerOptions, baseUrl, composite, declaration, declarationMap, exactOptionalPropertyTypes, experimentalDecorators, lib (+24 more)

### Community 44 - "contracts.ts"
Cohesion: 0.26
Nodes (13): appendHostStylesheet(), defaultDependencies(), hasCompletedFederationBuild(), HostLoaderDependencies, installHostSharedDependencies(), loadHostModule(), loadHostStyles(), watchHostBuildNotifications() (+5 more)
...
Cohesion: 0.08
Nodes (17): App(), ArtifactConfigurationPage, ArtifactsOverridesPage(), ArtifactName(), ArtifactOverrideActions(), ArtifactOverrideToggle(), ArtifactsOverridesTable(), OverridesTableToolbarDriver (+9 more)

### Community 48 - "package.json"
Cohesion: 0.07
Nodes (28): bugs, description, engines, node, exports, files, homepage, app (+20 more)
...
Cohesion: 0.23
Nodes (11): assertPacked(), canonicalLicense, exportedTargets(), normalizeText(), outputDirectory, packageDirectories, readArchiveFile(), root (+3 more)
...
Cohesion: 0.17
Nodes (10): ModuleShimDriver, moduleShim, DevSession, HostEntry, HostModule, HostMountRequest, ModuleShimGlobal, RemoteMetadata (+2 more)

### Community 54 - "AtlasGenerateService"
Cohesion: 0.12
Nodes (35): readPublishedCatalog(), mapWithConcurrency(), assertDescriptorBytes(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl() (+27 more)

### Community 55 - "types.ts"
Cohesion: 0.08
Nodes (33): AtlasHostRuntimeOptions, AtlasLoaderOptions, AtlasWidgetErrorRenderContext, AtlasWidgetLoaderOptions, AtlasWidgetRenderContext, AtlasWidgetUiOptions, createMountBoundary(), createRoutePlacementPlan() (+25 more)

### Community 56 - "target.ts"
Cohesion: 0.10
Nodes (42): asDependencyMap(), AtlasPackageManager, AtlasScaffoldOptions, AtlasTask, AtlasWorkspaceKind, configuredNxOutputPaths(), createFormatGeneratedCommand(), createNxGenerationCommand() (+34 more)
...
Cohesion: 0.07
Nodes (26): compilerOptions, baseUrl, composite, declaration, declarationMap, exactOptionalPropertyTypes, lib, module (+18 more)
...
Cohesion: 0.19
Nodes (15): addStalePreview(), artifactRecord(), descriptor(), DescriptorFixture, emptyArtifactRecord(), InspectAtlasHostDriver, installPage(), jsonResponse() (+7 more)

### Community 63 - "deploy.service.driver.ts"
Cohesion: 0.17
Nodes (18): DomHostOptions, DomHostServices, assertCatalogMatchesConfig(), DomHostRuntimeInput, resolveDomSlotContainer(), startDomHostRuntime(), createDomHostSdk(), createSdkProviders() (+10 more)

### Community 64 - "DirectoryPublicationStorage"
Cohesion: 0.16
Nodes (17): COMMAND_HELP, CommandHelp, HelpEntry, ROOT_COMMANDS, ROOT_EXAMPLES, appendEntries(), COMMAND_ALIASES, formatCommandHelp() (+9 more)

### Community 65 - "Production Readiness"
Cohesion: 0.13
Nodes (13): Angular Production Build and Publication, Native Federation, Verify, Angular Compiler Rejects `emitDeclarationOnly`, Angular Remote Entry Does Not Load, Angular Troubleshooting, Host APIs Are Missing, Inner Routing Escapes The App (+5 more)
...
Cohesion: 0.07
Nodes (26): compilerOptions, composite, declaration, declarationMap, exactOptionalPropertyTypes, lib, module, moduleResolution (+18 more)
...
### Community 69 - "generate.service.ts"
Cohesion: 0.08
Nodes (46): ANGULAR_FEDERATION_SKIP, ANGULAR_SHARED_DEPENDENCY_OPTIONS, angularWidgetConfigArgument(), angularWidgetConfigImport(), angularWidgetConfigPath(), commonJsNamedExports(), createAngularFederationConfig(), createAngularFederationOptions() (+38 more)

### Community 70 - "nx.ts"
Cohesion: 0.08
Nodes (49): addUniqueString(), defaultIgnoreFileDependencies, existingPackageName(), removeDelegatedReactViteConfigs(), takeOverAppSource(), writeGenerated(), readJsonFile(), writeJsonFile() (+41 more)
...
Cohesion: 0.19
Nodes (39): AtlasValidationIssue, validateHostCatalog(), validateUniqueManifestIds(), FRAMEWORKS, isRoutePattern(), normalizeRoutePath(), PlacementUniqueness, validateExportedWidget() (+31 more)

### Community 75 - "compilerOptions"
Cohesion: 0.10
Nodes (20): compilerOptions, composite, declaration, declarationMap, exactOptionalPropertyTypes, lib, module, moduleResolution (+12 more)

### Community 76 - "federation-config.specs.ts"
Cohesion: 0.12
Nodes (20): angularFederationSharedEntry(), angularFederationSkipEntries(), AtlasVitePlugin, createCommonJsFixturePackage(), createFixturePackage(), { createReactAppViteConfig, createReactHostViteConfig }, createReactFederationFixture(), createStyleFixturePackage() (+12 more)

### Community 77 - "devDependencies"
Cohesion: 0.12
Nodes (16): @angular/common, @angular/common, @angular/core, @angular/platform-browser, react, vite, @angular/core, @angular/platform-browser (+8 more)

### Community 78 - "prepare-release.js"
Cohesion: 0.25
Nodes (12): createReleaseWorkspace(), packageDirectories, writeJson(), main(), nextVersion(), prepareRelease(), releaseForArgument(), releaseTypes (+4 more)

### Community 79 - "extension.specs.ts"
Cohesion: 0.12
Nodes (12): ArtifactoryOptions, ArtifactoryPublicationStorage, assertReplaceCondition(), collectBody(), ArtifactoryStorageDriver, StorageClient, AtlasPublicationBody, AtlasPublicationLease (+4 more)

### Community 80 - "atlas-host.driver.ts"
Cohesion: 0.19
Nodes (9): AppComponent, Component, bootstrap(), DemoRouteAnchorComponent, HostMountRequest, Component, HostWidgets, Component (+1 more)

### Community 81 - "React Routing"
Cohesion: 0.17
Nodes (8): AtlasAppAssets, createAtlasAppAssetFacade(), createAtlasAppAssets(), AppAssetsDriver, resolveAssetUrl(), createAppContext(), ReactWidgetDriver, ReactAtlasSdk

### Community 82 - "devDependencies"
Cohesion: 0.11
Nodes (19): jest, devDependencies, cross-spawn, jest, @playwright/test, tar, ts-jest, tsx (+11 more)

### Community 83 - "scripts"
Cohesion: 0.11
Nodes (18): scripts, atlas, build, build:examples, ci:affected, ci:full, pack:verify, release (+10 more)

### Community 84 - "help.ts"
Cohesion: 0.11
Nodes (29): deployedManifest, createLoadedHost(), HostContext, HostContextValue, HostLoadResult, HostProvider(), readCachedHost(), OverridesProvider() (+21 more)
...
Cohesion: 0.11
Nodes (18): renderLoading(), HostFixture(), HostSdk, ReactHostDriver, AtlasHostDataContext, AtlasRuntimeContext, AtlasSdk, AtlasSdkContext (+10 more)
...
Cohesion: 0.17
Nodes (9): AtlasLoaderDependencies, defaultDependencies(), deploymentReferences(), AtlasLoaderDriver, loadDeployment(), loadInitialCatalog(), mapWithConcurrency(), publishRuntimeSnapshot() (+1 more)
...
Cohesion: 0.26
Nodes (6): bridgeMarkerSelector(), defaultDependencies(), DevelopmentSessionBridgeDependencies, DevelopmentSessionDriver, isMatchingResponse(), requestDevelopmentSession()
...
Cohesion: 0.07
Nodes (32): ControlServerDriver, ControlServerLease, StartControlServerOptions, nonInteractivePrompter, AngularBuildPrivateApi, loadAngularHostProxy(), createDevSession(), createLocalDevCatalog() (+24 more)
...
Cohesion: 0.11
Nodes (9): AtlasDeployResult, appManifest(), collect(), DeployServiceDriver, digest(), file(), hostManifest(), jsonBytes() (+1 more)

### Community 102 - "Atlas Overview"
Cohesion: 0.06
Nodes (79): canonicalJson(), isRecord(), registryRevision(), sortJson(), artifactKind(), assertUniqueName(), cloneRegistry(), emptyRevision() (+71 more)
...
Cohesion: 0.10
Nodes (23): withAtlasSdkProvider(), AppBootstrap, AtlasAngularAppOptions, createExportedWidget(), defineExportedWidget(), provideAtlasAngularStyles(), provideAtlasApp(), ATLAS_APP_CONTEXT (+15 more)

### Community 109 - "publication-context.ts"
Cohesion: 0.15
Nodes (8): Context, { createSharedModuleProxy, sharedProxyId }, LoadHook, Resolver, SharedModuleProxyDriver, SharedModuleProxyDependencies, SharedModuleProxyOptions, ViteResolver
...
### Community 112 - "HostRuntimeDriver"
Cohesion: 0.14
Nodes (13): CliArguments, DevelopmentPortsDriver, PortScenario, hostClientPortFallback(), resolveHostDevPorts(), ResolveHostDevPortsOptions, HostDevPorts, ATLAS_HOST_FILES (+5 more)
...
### Community 117 - "delay"
Cohesion: 0.13
Nodes (16): cliVersion(), configuredHostUrls(), previewSelector(), printVerificationCheck(), runAtlasCli(), runWorkspaceFreeCommand(), splitUrls(), verifyHostUrls() (+8 more)

### Community 118 - "detectWorkspace"
Cohesion: 0.09
Nodes (16): AtlasHostMountState, createHostCatalog(), createTestContainer(), createTestElement(), createWidgetRendererContainer(), duplicateWidgetResult(), testHostManifest(), TestProductionSelection (+8 more)
...
### Community 127 - "MemoryPublicationStorage"
Cohesion: 0.10
Nodes (5): AtlasPublicationListedObject, AtlasProjectBuilder, MemoryPublicationStorage, PublishServiceDriver, StoredObject

### Community 128 - "HttpClient"
Cohesion: 0.11
Nodes (15): AngularHostSdkReference, AngularHostStartServices, AtlasSdk, AngularInjectionDriver, CustomerHostSdk, CreateWidgetBindingInput, createHostDataListeners(), HOST_DATA_LISTENERS (+7 more)
...
Cohesion: 0.29
Nodes (6): bridgeResponse(), controlPort, isDevelopmentSessionRequest(), messageFromError(), publishResponse(), relayDevelopmentSessionRequest()
...
Cohesion: 0.13
Nodes (14): angularDependencyRange(), angularPackage(), AngularPackageOptions, nativeFederationPackage(), usesNativeFederationV4(), AngularWorkspaceGeneratorDriver, angularVersionProfile, atlasPackageRange() (+6 more)

### Community 140 - "host-ui.ts"
Cohesion: 0.12
Nodes (16): apps/columbus/src/scripts/build/**/*.ts, scripts/**/*.ts, tests/e2e/directory-publication-storage.ts, tests/e2e/prepare.ts, tests/e2e/static-server.ts, compilerOptions, esModuleInterop, module (+8 more)
...
Cohesion: 0.21
Nodes (9): AtlasNavigateOptions, createAtlasSdk(), Orders, SdkFactoryDriver, readSdkProperties(), createTestHostSdk(), createTestManifest(), createMemoryNavigation() (+1 more)
...
Cohesion: 0.18
Nodes (11): optional, optional, optional, peerDependenciesMeta, @angular/common, @angular/core, @angular/platform-browser, react (+3 more)

### Community 151 - "AngularWidgetOutletController"
Cohesion: 0.13
Nodes (29): AtlasDeployService, DeploymentWrite, digest(), envPath(), hostManifests(), hostPath(), isLoopback(), isSecureRegistryProtocol() (+21 more)

### Community 153 - "tsconfig.angular.json"
Cohesion: 0.15
Nodes (12): angularCompilerOptions, compilationMode, compilerOptions, experimentalDecorators, paths, extends, ../schema/dist/index.d.ts, ./tsconfig.json (+4 more)
...
Cohesion: 0.25
Nodes (11): completedProcessOutput(), browserOpenCommand(), developmentPreviewUrl(), DevelopmentProcessDriver, RemoteEntryScenario, formatFrameworkServerError(), frameworkServerArguments(), openBrowserWhenReady() (+3 more)

### Community 158 - "React SDK"
Cohesion: 0.17
Nodes (17): isPublicationStorage(), PullRequestDriver, providerFetch(), providerToken(), requiredString(), resolveBitbucketPullRequest(), resolveGitHubPullRequest(), resolveGitLabMergeRequest() (+9 more)

### Community 159 - "angular.ts"
Cohesion: 0.14
Nodes (24): ArtifactoryClient, ArtifactoryConnectionOptions, ArtifactoryDependencies, ArtifactoryResponse, ArtifactUpload, discardResponse(), downloadResponse(), ArtifactoryClientDriver (+16 more)
...
Cohesion: 0.16
Nodes (12): Input, AtlasAnchorComponent, AtlasAngularHostAnchors, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot (+4 more)
...
Cohesion: 0.24
Nodes (6): { createReactAppViteConfig, createReactHostViteConfig }, namedExports, PackageFixture, PackageFormat, ReactSharedPackagesDriver, ReactViteConfigFactory

### Community 165 - "Documentation Guidelines"
Cohesion: 0.14
Nodes (17): AngularHostBootstrapOptions, AngularHostDataInput, AngularHostDataOption, AtlasDefaultHostRouteComponent, AtlasNavigationItemsService, bootstrapAngularHost(), HostMountRequest, HostOptions (+9 more)
...
Cohesion: 0.20
Nodes (6): assertLocalPreviewPort(), AtlasDevService, DevelopmentScenario, DevServiceDriver, AtlasDevBuildService, testTypeScriptConfig()
...
### Community 176 - "angular-location-strategy.ts"
Cohesion: 0.38
Nodes (5): HostLayout(), HostMountRequest, mountHost(), HostWidgets(), loadRemoteModule()

### Community 178 - "session.ts"
Cohesion: 0.24
...
Cohesion: 0.16
Nodes (9): AngularWorkspaceDocument, GeneratedFramework, GeneratedProjectType, GenerationE2eDriver, NxProjectDocument, PackageDocument, cliEntrypointPath(), run() (+1 more)

### Community 181 - "angular-bootstrap.driver.ts"
Cohesion: 0.27
Nodes (13): assertSupportedGeneratorFramework(), assertValidAtlasId(), assertValidGeneratorOptions(), AtlasGeneratedFile, AtlasGeneratorOptions, AtlasPackageManager, angularWidgetConfig(), generateWidgetFiles() (+5 more)

### Community 182 - "AtlasValidationIssue"
Cohesion: 0.20
Nodes (13): assertAtlasHostCatalog(), assertAtlasManifest(), AtlasValidationError, formatAtlasValidationMessage(), createManifestFromConfig(), identifierFromRoute(), identifierFromSlot(), placements() (+5 more)
...
Cohesion: 0.29
Nodes (5): artifacts, Framework, HostWidgetsDriver, WidgetScenario, workspace
...
Cohesion: 0.17
Nodes (11): compilerOptions, declaration, module, moduleResolution, noEmitOnError, skipLibCheck, strict, target (+3 more)
...
### Community 205 - "entry.ts"
Cohesion: 0.25
Nodes (5): AtlasAppRootComponent, Component, polyfills, es-module-shims, zone.js

### Community 206 - "package.json"
Cohesion: 0.15
Nodes (13): devDependencies, @babel/plugin-syntax-typescript, @file-services/node, jest-environment-jsdom, @types/react, @vitejs/plugin-react, @wix/design-system, jest-environment-jsdom (+5 more)
...
Cohesion: 0.14
Nodes (17): appendQueryValue(), matchRoutePart(), matchRoutePattern(), normalizePath(), parseQuery(), scopePath(), splitRoutePath(), toInnerPath() (+9 more)
...
### Community 212 - "files"
Cohesion: 0.25
Nodes (8): files, dist/**/*.d.ts, dist/**/*.js, dist/**/*.cjs, dist/**/*.d.cts, federation-config.cjs, federation-config.d.cts, federation-config.mjs
...
Cohesion: 0.10
Nodes (24): ArtifactConfigurationActions(), ArtifactConfigurationActionsProps, ArtifactConfigurationActionsDriver, ArtifactConfigurationPage(), OverrideRadioCard(), OverrideRadioCardProps, OverridesSelectionForm(), OverridesSelectionFormProps (+16 more)
...
Cohesion: 0.11
Nodes (38): artifactRegistryRoot(), assertDescriptor(), createLocalOverrides(), Descriptor, fetchManifestReference(), fetchWithTimeout(), HostDeployment, inspectAtlasHost() (+30 more)

### Community 232 - "ts-jest"
Cohesion: 0.50
Nodes (4): CI, Deployment E2E, Faster Browser Iteration, Testing The Atlas Repository

### Community 233 - "index.ts"
Cohesion: 0.28
Nodes (10): ATLAS_BROWSER_LOADER, createBrowserAssetFiles(), ES_MODULE_SHIM, createAtlasBootstrapFiles(), withTrailingNewline(), createBootstrapHtml(), escapeHtml(), validateBootstrapHtml() (+2 more)
...
### Community 237 - "delay"
Cohesion: 0.12
Nodes (19): devDependencies, @angular/compiler, @angular/compiler-cli, @angular/core, @angular/platform-browser, react, @types/css-tree, @types/react (+11 more)
...
Cohesion: 0.13
Nodes (21): ArtifactOverrideVersion(), ArtifactOverrideVersionDriver, createArtifact(), manifest(), OVERRIDE_TYPE_LABELS, useArtifacts(), artifactSourceDescription(), baseUrlFromRemoteEntry() (+13 more)

### Community 242 - "S3PublicationStorage"
Cohesion: 0.20
Nodes (9): encodeLease(), errorName(), errorStatus(), isMissingObject(), isPreconditionFailure(), requestBody(), requiredEtag(), S3PublicationStorage (+1 more)

### Community 244 - "navigation-paths.ts"
Cohesion: 0.27
...
### Community 246 - "create-manifest-from-config.ts"
Cohesion: 0.09
Nodes (21): RetryDriver, isRetryableHttpStatus(), isTransientError(), RetryOptions, statusCode(), transientNetworkCode(), transientStatus(), wait() (+13 more)

### Community 248 - "widget-registry.ts"
Cohesion: 0.16
Nodes (6): addNavigationState(), AtlasNavigationTarget, createAppNavigator(), AppNavigatorDriver, AtlasNavigation, AtlasNavigationState

### Community 249 - "routing.md"
Cohesion: 0.14
Nodes (9): anchorKey(), AtlasHostAnchorListener, AtlasHostAnchorRegistry, AtlasHostUi, AtlasHostUiOptions, createHostUi(), renderDefaultError(), renderDefaultLoading() (+1 more)
...
### Community 258 - "route-matcher.ts"
Cohesion: 0.21
Nodes (12): FetchJsonDriver, fetchBytes(), fetchJson(), fetchJsonRequest(), validateIntegrity(), applyOverrides(), artifactRegistryRoot(), descriptorReference() (+4 more)
...
Cohesion: 0.11
Nodes (19): BadgeCountMessage, fetchDevelopmentSession(), isDevelopmentSessionMessage(), isMessage(), loadForTab(), previewIdentity(), assertControlPort(), assertDevelopmentSession() (+11 more)

### Community 264 - "prepare-release.driver.ts"
Cohesion: 0.40
Nodes (5): Atlas Host, Build a Host, Build The Host, Reference, Ship The Host

### Community 266 - "bootstrap-server.driver.ts"
Cohesion: 0.19
Nodes (9): GeneratedFilesDriver, IgnoreScenario, ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS, hasAtlasIgnorePattern(), IgnoreFileDependencies, isContainedBy(), isMissingFileError() (+1 more)

### Community 268 - "bootstrap.specs.ts"
Cohesion: 0.40
Nodes (5): scripts, build, test, test:e2e, typecheck

### Community 270 - "publication-storage.driver.ts"
Cohesion: 0.25
Nodes (12): ensureLeaseDirectory(), isActiveLease(), LEASE_DIRECTORY, leaseId(), leasePath(), processExists(), readActiveControlServerLeases(), readLease() (+4 more)

### Community 285 - "atlas-host.driver.ts"
Cohesion: 0.10
Nodes (11): AtlasBootstrapServiceOptions, SupportedFramework, frameworkLabel(), NxDevTargetOptions, displayTarget(), AtlasGenerateService, availableAppsMessage(), WidgetAppSelection (+3 more)

### Community 287 - "dependencies.ts"
Cohesion: 0.37
Nodes (11): BrowserErrorContext, createBrowserError(), logBrowserError(), emitHostError(), emitHostReady(), emitHostStart(), emitMountState(), reportRetryFailure() (+3 more)

### Community 288 - "publication-context.specs.ts"
Cohesion: 0.40
Nodes (5): @atlas/testkit, devDependencies, @atlas/testkit, @faker-js/faker, @faker-js/faker

### Community 289 - "React SDK"
Cohesion: 0.11
Nodes (15): ActiveWidget, AngularGetWidgetOptions, AngularWidgetBinding, AngularWidgetOutletController, AngularWidgetRuntime, createAngularAtlasSdk(), createAngularLoadingRenderer(), createWidgetBinding() (+7 more)

### Community 293 - "host-assets.ts"
Cohesion: 0.67
Nodes (3): files, dist/**/*.d.ts, dist/**/*.js
...
### Community 296 - "artifactory-client.driver.ts"
Cohesion: 0.17
Nodes (13): esbuild, development, production, buildTarget, dev, optimization, sourceMap, target (+5 more)
...
### Community 300 - "Releasing Atlas packages"
Cohesion: 0.21
...
### Community 307 - "cli-error.specs.ts"
Cohesion: 0.43
...
### Community 309 - "Build A React App"
Cohesion: 0.67
Nodes (3): Change Gate, Coverage Inventory, Documentation Coverage

### Community 311 - "create-manifest-from-config-input.ts"
Cohesion: 0.11
Nodes (37): ResolveHostDevTargetOptions, AtlasRegistryMutation, AtlasResolvedRelease, AtlasResolvedWidget, AtlasAppConfig, AtlasBaseConfig, AtlasHostConfig, AtlasSlotMount (+29 more)

### Community 312 - "createTaskCommand"
Cohesion: 0.29
...
### Community 316 - "Angular Production Build and Publication"
Cohesion: 0.22
Nodes (3): AtlasHostMountEvent, AtlasHostRuntime, HostRuntimeDriver

### Community 317 - "@types/jest"
Cohesion: 0.24
...
### Community 318 - "dependencies"
Cohesion: 0.22
Nodes (9): A Local Workspace Package Loads From The CDN, Asset URLs Break In Production, Host APIs Are Missing, Inner Routing Escapes The App, Install Fails With Peer Conflicts, Local Development Reports A Missing Named Export, React Troubleshooting, Spinner Never Disappears (+1 more)

### Community 320 - "overlay.ts"
Cohesion: 0.22
Nodes (9): options, assets, browser, index, outputPath, preserveSymlinks, styles, tsConfig (+1 more)

### Community 322 - "Releasing Atlas packages"
Cohesion: 0.40
Nodes (3): Scenario, ShadowStylesBrowserDriver, workspace

### Community 323 - "Get Started With Atlas"
Cohesion: 0.40
Nodes (5): 1. Install Atlas, 2. Generate a Host, 3. Generate an App, Before You Start, Get Started With Atlas

### Community 329 - "NetworkLimiter"
Cohesion: 0.36
Nodes (4): digestToIntegrity(), hydrateApp(), hydratePublishedArtifactManifest(), DIGEST
...
### Community 333 - "sdk-factory.driver.ts"
Cohesion: 0.29
Nodes (4): AngularBootstrapDriver, ASSET_BASE_URL, CustomerSdk, LOGO_URL
...
### Community 336 - ".ensureTurboTasks"
Cohesion: 0.29
...
### Community 337 - "demo-angular-host"
Cohesion: 0.29
Nodes (6): projectType, root, sourceRoot, projects, demo-angular-host, version

### Community 340 - "babel-plugin-react-compiler"
Cohesion: 0.38
Nodes (3): BrowserWindowLike, createBrowserNavigation(), createFakeWindow()

### Community 341 - "@angular/animations"
Cohesion: 0.11
Nodes (21): absolutizeUrls(), importPrelude(), prepareShadowImports(), readImport(), wrapImport(), wrapPrelude(), adaptRules(), adaptShadowStyleSheet() (+13 more)

### Community 342 - "Build A React App"
Cohesion: 0.33
...
### Community 343 - "React Project Guide"
Cohesion: 0.40
...
### Community 348 - "repository"
Cohesion: 0.50
Nodes (4): repository, directory, type, url

### Community 351 - "engines"
Cohesion: 0.67
Nodes (3): engines, node, pnpm

## Knowledge Gaps
- **1673 isolated node(s):** `RegistryArtifact`, `Registry`, `PreviewLoadResult`, `HostDeployment`, `manifestReferences` (+1668 more)
...
- `AtlasDevService` (2× useful, score=0.705290658) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `bootstrap()` connect `atlas-host.driver.ts` to `angular-location-strategy.ts`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `polyfills` connect `entry.ts` to `overlay.ts`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `options` connect `overlay.ts` to `artifactory-client.driver.ts`, `entry.ts`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **What connects `RegistryArtifact`, `Registry`, `PreviewLoadResult` to the rest of the system?**
