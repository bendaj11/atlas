...
## Corpus Check
- 1370 files · ~353,303 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7122 nodes · 16454 edges · 365 communities (313 shown, 52 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 142 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `29ddb138`
...
1. `AtlasManifest` - 83 edges
2. `CliArguments` - 61 edges
3. `AtlasSdk` - 51 edges
4. `ArtifactVersion` - 40 edges
5. `AtlasRuntimeError` - 40 edges
6. `toRecord()` - 39 edges
7. `isRecord()` - 38 edges
8. `AtlasWorkspace` - 38 edges
...
- `HostReadResult` --references--> `HostData`  [EXTRACTED]
  apps/columbus/src/utils/load-columbus-state/load-columbus-state.ts → apps/columbus/src/types/host-data.ts
- `IncludeOverrideAppsOptions` --references--> `HostData`  [EXTRACTED]
  apps/columbus/src/utils/override-artifact-versions/override-artifact-versions.ts → apps/columbus/src/types/host-data.ts
...
Cohesion: 0.10
Nodes (37): AtlasRuntimeOverrideDocument, flushAsyncWork(), aHostConfig(), anAppConfig(), aHostCatalog(), aHostRuntimeConfig(), createTestHostSdk(), aHostManifest() (+29 more)

### Community 1 - "react-generator.ts"
Cohesion: 0.10
Nodes (19): AtlasAppMountResult, AtlasExportedWidgetMountResult, createRoutedApp(), CreateRoutedAppDriver, defineApp(), DefineAppDriver, defineExportedWidget(), DefineExportedWidgetDriver (+11 more)

### Community 2 - "AtlasManifest"
Cohesion: 0.08
Nodes (41): fetchDevelopmentSession(), loadForTab(), previewIdentity(), previewUrl, ACTION_ICON_PATHS, actionIconPathsFor(), loadArtifactVersionFromHostTab(), readPageStateFromHostTab() (+33 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.07
Nodes (40): EntryBehavior, startAtlasHostRuntime(), AnchorsListener, AppReadiness, AtlasHostRuntimeOptions, HostPlacement, IsMountCurrent, LoadingStateEmitter (+32 more)
...
Cohesion: 0.10
Nodes (34): AtlasArtifactPreviewState, assertPreviewIsCurrent(), prunePreviewsOnce(), removeClosedPreviews(), removePreviewOnce(), requireRegistry(), derivePublicationIdentity(), PublicationFiles (+26 more)
...
Cohesion: 0.11
Nodes (20): CreateAngularAtlasSdkInput, AngularLoadingRendererRequest, createAngularLoadingRenderer(), AngularLoadingRendererDriver, Component, WidgetSkeleton, createWidgetBinding(), CreateWidgetBindingRequest (+12 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.06
Nodes (54): PreviewPruningDriver, groupObjectsByGeneration(), isExpiredGeneration(), pruneUnreferencedPreviewGenerations(), isRegistryReferencing(), RegistryState, isSameDescriptor(), ArtifactResolutionDriver (+46 more)
...
Cohesion: 0.09
Nodes (29): applyOverrides(), applyOverridesDocument, ApplyOverridesDriver, applyOverridesDocument(), ApplyOverridesDocumentDriver, resolveOverrideManifest, extractAppManifestFromOverride(), DevelopmentSessionSourceContext (+21 more)
...
Cohesion: 0.07
Nodes (43): requireAppEntryExport(), requireWidgetEntryExport(), isMountableEntry(), MountableEntry, unwrapDefaultExport(), createWidgetCard(), createWidgetRenderContext(), attemptWidgetMount() (+35 more)

### Community 20 - "AtlasNavigation"
Cohesion: 0.13
Nodes (61): collectAtlasHostCatalogIssues(), validateAppManifestList(), collectAtlasHostManifestIssues(), validateAtlasHostManifest(), collectAtlasManifestIssues(), PlacementUniqueness, validateExportedWidget(), validateExportedWidgets() (+53 more)

### Community 21 - "dev.service.ts"
Cohesion: 0.09
Nodes (43): captureProcessOutput(), CliProcessDriver, forwardAndCaptureOutput(), ProcessCommand, processOutput, processOutputClosed, ProcessOutputDestinations, require (+35 more)

### Community 22 - "manifest-utils.ts"
Cohesion: 0.06
Nodes (40): ArgumentsDriver, AngularLocalRuntimeDriver, AtlasDeploymentCatalog, AtlasHostManifest, REQUIRED_STRING_FIELDS, AtlasArtifactManifestBase, ATLAS_DOM_ISOLATIONS, AtlasExposeMap (+32 more)
...
Cohesion: 0.05
Nodes (75): DomRuntimeOptions, AtlasHostMountState, AngularLocalManifest, prepareAngularLocalRuntime(), LoadHostDeploymentOptions, LoadPublishedManifestOptions, FetchBytesDriver, FetchBytes (+67 more)

### Community 26 - "ArtifactsOverridesTable.tsx"
Cohesion: 0.09
Nodes (23): @testing-library/dom, @testing-library/user-event, devDependencies, @angular/compiler, @angular/compiler-cli, @faker-js/faker, jest-environment-jsdom, react-dom (+15 more)
...
Cohesion: 0.11
Nodes (17): ValidateAtlasHostCatalogDriver, validateAtlasHostCatalog(), AtlasValidationError, AtlasValidationErrorDriver, formatAtlasValidationMessage(), AtlasValidationIssue, ValidateAtlasHostManifestDriver, ReleaseVersionDriver (+9 more)
...
### Community 34 - "app.ts"
Cohesion: 0.07
Nodes (40): BadgeRefreshDependencies, createBadgeRefresher(), artifactRegistry, countStoredOverrides(), darkColorScheme, addWindowListener, artifactRegistry, BadgeScriptDriver (+32 more)
...
Cohesion: 0.09
Nodes (28): AtlasLoaderDependencies, LoaderContext, collectDeploymentManifestReferences(), DeploymentCatalogContext, DeploymentCatalogDependencies, DeploymentCatalogDriver, PublishedManifest, fetchDeploymentManifest() (+20 more)

### Community 38 - "index.ts"
Cohesion: 0.12
Nodes (19): isAbsoluteUrl(), resolveRegistryRootUrl(), validateRegistryRootUrl(), assertAtlasHostRuntimeConfig(), BASE_FIELDS, collectDevelopmentFieldIssues(), collectRegistryRootIssues(), collectRuntimeConfigFieldIssues() (+11 more)
...
### Community 41 - ".run"
Cohesion: 0.12
Nodes (23): assertAtlasHostCatalog(), AssertAtlasHostCatalogDriver, assertAtlasHostManifest(), AssertAtlasHostManifestDriver, assertReleaseVersion(), validateReleaseVersion(), assertSafeArtifactId(), assertSafeRelativePath() (+15 more)

### Community 42 - "FailingMutableStorage"
Cohesion: 0.07
Nodes (39): DomSdkOptions, AtlasHostAnchorRegistry, createAnchorKey(), HostAnchorsDriver, AtlasHostAnchorKind, AtlasHostAnchorListener, ReleaseAnchor, UnsubscribeAnchorListener (+31 more)
...
Cohesion: 0.09
Nodes (34): AtlasMountedApp, createFederationRemoteFromWidget(), importNativeFederationRemote(), assertAssetUrlIsTrusted(), assertLocalManifestUsesLoopbackUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), createRemoteTrustPolicy() (+26 more)

### Community 47 - "publication-storage.ts"
Cohesion: 0.07
Nodes (27): resolveGenerationRoot(), readArtifactoryOptionsFromEnvironment(), resolveArtifactoryPublicUrl(), createStorageFromEnvironment(), DEFAULT_FACTORIES, PublicationStorageDriver, STORAGE_ENVIRONMENT_KEYS, AtlasPublicationStorageSource (+19 more)
...
Cohesion: 0.07
Nodes (49): WINDOW_EVENTS, aHostData(), findAtlasHostTabMock, loadArtifactVersionFromHostTabMock, readPageStateFromHostTabMock, reloadHostTabMock, HostData, HostPageState (+41 more)

### Community 52 - "content-script.ts"
Cohesion: 0.12
Nodes (16): buildBrowserOpenCommand(), formatFrameworkServerError(), isRemoteEntryReady(), openBrowserWhenReady(), waitForRemoteEntry(), waitForShutdown(), buildFrameworkServerArguments, FakeChildProcess (+8 more)

### Community 53 - "Workspace integration"
Cohesion: 0.04
Nodes (72): AngularAdapterDriver, EagerSdkHostRoot, HostRoot, HostSdk, startDomHost, StartDomHostForHostSdk, Component, DomHostDriver (+64 more)

### Community 54 - "AtlasGenerateService"
Cohesion: 0.14
Nodes (24): buildLeaseFileId(), buildLeaseFilePath(), ControlServerLeaseDriver, ensureLeaseDirectory(), isActiveLease(), isProcessRunning(), LEASE_DIRECTORY, readActiveControlServerLeases() (+16 more)
...
Cohesion: 0.08
Nodes (12): CliProcessResult, runCli(), EntrypointDriver, AngularWorkspaceDocument, GeneratedFramework, GeneratedProjectType, GenerationDriver, NxProjectDocument (+4 more)

### Community 63 - "deploy.service.driver.ts"
Cohesion: 0.14
Nodes (25): AtlasDevSessionDocument, assertOverrideDocumentTargetsHost(), OverridesDriver, isOverrideDocumentShape(), isOverrideEntryShape(), isRecord(), loadBrowserRuntimeOverrides(), parseDevelopmentOffersFromValue() (+17 more)
...
Cohesion: 0.13
Nodes (19): AtlasAppConfig, AtlasBaseConfig, AtlasHostConfig, AtlasRouteMount, AtlasSlotMount, AtlasWidgetConfig, assertAtlasManifest(), AssertAtlasManifestDriver (+11 more)
...
Cohesion: 0.06
Nodes (40): AtlasAnchorComponent, AtlasAngularHostAnchors, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot, AnchorsRoot (+32 more)
...
Cohesion: 0.07
Nodes (53): artifactVersionFromSelection(), UseHostArtifactVersionQueryDriver, HostArtifactVersionQueryOptions, HOST_SELECTION_TYPES, UseSaveArtifactOverrideMutationDriver, SaveArtifactOverrideMutationOptions, HOST_OVERRIDE_TYPES, OverridesSelectionFormDriver (+45 more)
...
Cohesion: 0.11
Nodes (13): buildDevelopmentBridgeMarkerSelector(), createBrowserBridgeDependencies(), DevelopmentSessionDriver, matchDevelopmentSessionResponse(), requestDevelopmentSession(), DevelopmentSessionBridgeDependencies, DevelopmentSessionDriver, isSessionRequest() (+5 more)
...
Cohesion: 0.17
Nodes (9): describeManifest(), ValidateArtifactUrlDriver, LOOPBACK_HOSTS, validateLocalArtifactUrl(), assertAppManifests(), ValidateCatalogDriver, validateCatalog(), ValidateHostManifestDriver (+1 more)
...
Cohesion: 0.14
Nodes (16): DeployServiceDriver, assertMetadata(), assertPayload(), createImmutable(), PublicationFilesDriver, isUnknownOutcome(), preparePublicationFiles(), PublicationFile (+8 more)
...
Cohesion: 0.10
Nodes (20): bugs, description, engines, node, homepage, app, typescript, keywords (+12 more)
...
Cohesion: 0.08
Nodes (33): aPublishedArtifact(), aRegistry(), aRegistryArtifactOf(), PublishedArtifact, isAppArtifactVersion(), ArtifactRegistry, ArtifactVersions, createArtifactRegistry() (+25 more)
...
Cohesion: 0.05
Nodes (49): extractErrorMessage(), VerifiedManifest, verifyAsset(), verifyExposes(), verifyFederationReferences(), verifyManifestAssets(), verifyCatalog(), verifyCatalogHost() (+41 more)
...
Cohesion: 0.05
Nodes (55): HostFixture(), HostSdk, ReactHostDriver, CounterWidget, CreateExportedWidgetDriver, Component, Input, WidgetProps (+47 more)

### Community 129 - "Angular Generators"
Cohesion: 0.10
Nodes (28): ArtifactOverrideEditorPageDriver, useArtifactOverrideOptions, ArtifactsListPageDriver, ArtifactsListTable, NOT_LOADED_HOST_STATUSES, ArtifactNameDriver, ArtifactOverrideActionsDriver, ArtifactOverrideToggleDriver (+20 more)
...
Cohesion: 0.15
Nodes (13): AtlasLoaderDriver, loadStartupCatalog, publishRuntimeSnapshot, LoaderDocument, RuntimeSnapshotDriver, publishRuntimeSnapshot(), HostEntry, HostModule (+5 more)
...
Cohesion: 0.13
Nodes (14): createBrowserAtlasLoaderDependencies(), startAtlasLoader(), describeFatalError(), DescribeFatalErrorDriver, inferSuggestedActionsFromMessage, describeFatalError, FatalErrorDriver, showFatalError() (+6 more)
...
Cohesion: 0.15
Nodes (12): dependencies, @atlas/schema, name, private, scripts, build, lint, test (+4 more)
...
Cohesion: 0.11
Nodes (19): vite, @angular/common, @angular/core, @angular/platform-browser, react, vite, @angular/common, @angular/core (+11 more)
...
Cohesion: 0.22
Nodes (12): parseRegistryRoot(), resolveRegistryLocations(), RegistryLocations, UrlDriver, isLoopbackUrl(), isSecureOrLoopbackUrl(), LOOPBACK_HOSTNAMES, normalizeRoutePath() (+4 more)
...
Cohesion: 0.06
Nodes (49): AngularAtlasSdkDriver, WidgetInputs, AngularWidgetOutletControllerDriver, HandleWidgetError, Component, WidgetInputs, WidgetSkeleton, AngularAtlasSdk (+41 more)
...
Cohesion: 0.11
Nodes (24): ATLAS_HOST_FILES, ATLAS_INTEGRATION_FILES, DELEGATED_APP_FILES, DELEGATED_HOST_FILES, OverlayDriver, generatedOverlay(), isAngularStylesheet(), AngularHostFilesOptions (+16 more)
...
Cohesion: 0.22
Nodes (14): ControlRequest, ControlRequestHandler, createControlRequestHandler(), extractPathSegmentBetween(), isWebPageUrl(), loadPublishedCatalog(), parseControlRequest(), registerOverride() (+6 more)

### Community 177 - "widget-adapters.specs.ts"
Cohesion: 0.11
Nodes (27): BuildNotificationsDependencies, BuildNotificationsDriver, isFederationRebuildCompleteEvent(), watchHostBuildNotifications(), createBrowserHostLoaderDependencies(), HostLoaderDriver, installHostSharedDependencies, loadHostStyles (+19 more)
...
Cohesion: 0.10
Nodes (40): GeneratorOptionOverrides, AngularFederationDriver, selectNativeFederationBuilder(), selectNativeFederationPackage(), LEGACY_CONFIG_API_MAJORS, MAIN_PACKAGE_MAJORS, V4_CONFIG_API_MAJORS, V4_PACKAGE_MAJORS (+32 more)

### Community 182 - "asset-checks.ts"
Cohesion: 0.13
Nodes (21): ScopePickerProps, Scope, OverrideStorageLocation, PersistedOverridesPayload, persistOverridesInPage(), writeDisabledArtifactVersionOverrides(), writeList(), writeOverrideDocument() (+13 more)
...
Cohesion: 0.04
Nodes (47): devDependencies, @atlas/testkit, babel-plugin-react-compiler, eslint, @eslint/js, eslint-plugin-react-hooks, @faker-js/faker, @file-services/node (+39 more)

### Community 207 - "keywords"
Cohesion: 0.06
Nodes (42): bootstrap(), compileConfig(), develop(), generate(), publish(), resolveProjectArgument(), runWorkspaceCommand(), WorkspaceCommandContext (+34 more)

### Community 208 - "repository"
Cohesion: 0.07
Nodes (30): BackgroundDriver, clearHostDataCache, fetch, focusPreviewTab, loadDevelopmentSession, addWindowListener, DevelopmentSessionContentDriver, postMessage (+22 more)
...
Cohesion: 0.13
Nodes (19): appendNavigationStateToPath(), createAppNavigator(), AppNavigatorDriver, AtlasNavigationTarget, NavigateToApp, AdapterOnlyOptionName, createDomHostSdk(), DomHostSdkDriver (+11 more)
...
Cohesion: 0.18
Nodes (8): ControlServerDriver, ControlServerLease, DevSessionRuntime, resolveFrameworkDevTask(), runDevSession(), RunDevSessionOptions, AtlasDevOverrideDocument, DevControlServer
...
Cohesion: 0.50
Nodes (7): assertHostDeploymentManifest(), collectHostDeploymentManifestIssues(), validateHostDeploymentManifest(), validateManifestReference(), validateManifestReferences(), validateManifestDescriptor(), validateSha256Digest()
...
Cohesion: 0.14
Nodes (19): defaultIgnoreFileDependencies, GeneratedFilesDriver, ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS, hasAtlasIgnorePattern(), IgnoreFileDependencies, isContainedBy(), isMissingFileError() (+11 more)
...
Cohesion: 0.40
Nodes (4): ValidatorsDriver, SAFE_IDENTIFIERS, UNSAFE_IDENTIFIERS, UNSAFE_PATHS
...
### Community 304 - "Atlas"
Cohesion: 0.12
Nodes (32): ReactAppComponentOptions, renderReactAppBootstrap(), renderReactAppComponent(), renderReactAppDetails(), renderReactAppHome(), renderReactAppRoutes(), renderReactCreateRootImport(), generateReactAppFiles() (+24 more)
...
Cohesion: 0.12
Nodes (16): @angular/router, @angular/common, @angular/core, @angular/platform-browser, @angular/router, react, @angular/common, @angular/core (+8 more)
...
Cohesion: 0.22
Nodes (10): AtlasStyleTargetMissingError, createMountBoundary(), ALL_ISOLATIONS, ALL_KINDS, MountBoundaryDriver, requireStyleTarget(), MountBoundary, MountBoundaryInput (+2 more)
...
Cohesion: 0.12
Nodes (20): writeDevOverrideDocument(), DevelopmentPortsDriver, resolveHostClientPortFallback(), resolveHostDevPorts(), ResolveHostDevPortsOptions, developmentPreviewUrl(), logHostViewUrl(), nonInteractivePrompter (+12 more)

### Community 327 - "publication-metadata.specs.ts"
Cohesion: 0.07
Nodes (21): assertLease(), createExternalPublicationLease(), DeploymentLease, ConditionalPutError, MissingObjectError, S3LeaseDriver, StoredObject, requiredEtag() (+13 more)
...
### Community 342 - "typescript"
Cohesion: 0.50
Nodes (4): react-router-dom, react-router-dom, react-router-dom, react-router-dom
...
Cohesion: 0.06
Nodes (49): HOST_CHANNELS, NOT_ERROR_OVERRIDE_STATUSES, BrowserOverrideScopePicker(), BrowserOverrideScopePickerDriver, ScopePickerProps, UseArtifactOverrideOptionsDriver, UseArtifactsDriver, ColumbusStateUpdater (+41 more)
...
Cohesion: 0.11
Nodes (18): PortsDriver, ProjectOptionsDriver, anAppConfigSource(), GenerateServiceDriver, WidgetAppsDriver, createdRoots, MANAGERS, TURBO_BYPASSED_TASKS (+10 more)

### Community 388 - "App.driver.tsx"
Cohesion: 0.07
Nodes (36): App(), ArtifactOverrideEditorPage(), initialOverrideSelection(), ArtifactOverrideEditorPageActions(), ArtifactOverrideEditorPageActionsProps, ActionsProps, ArtifactOverrideEditorPageActionsDriver, ArtifactOverrideLocationState (+28 more)
...
## Knowledge Gaps
- **1957 isolated node(s):** `name`, `version`, `private`, `type`, `@atlas/schema` (+1952 more)
...
- `AtlasDevService` (2× useful, score=0.424672477)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `loadBrowserRuntimeOverrides()` connect `deploy.service.driver.ts` to `native-federation.ts`, `AtlasManifest`, `Workspace integration`, `overlay.specs.ts`?**
  _High betweenness centrality (0.040) - this node is a cross-community bridge._
- **Why does `fetchBytes()` connect `atlas-host.ts` to `atlas-host.driver.ts`, `Architecture`, `nx.ts`?**
  _High betweenness centrality (0.029) - this node is a cross-community bridge._
- **Why does `AtlasManifest` connect `Workspace integration` to `index.ts`, `dom-host-runtime.ts`, `Atlas Overview`, `devDependencies`, `angular-widget.ts`, `cli.service.ts`, `angular-local-runtime.ts`, `publish-config.ts`, `manifest-utils.ts`, `native-federation.ts`, `runtime-discovery.ts`, `validation.specs.ts`, `overlay.ts`?**
