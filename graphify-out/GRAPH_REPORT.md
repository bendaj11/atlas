...
## Corpus Check
- 584 files · ~211,767 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5048 nodes · 9084 edges · 351 communities (279 shown, 72 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 131 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `0b9cbed4`
...
- WorkspaceDriver
- ArtifactOverrideVersion.driver.tsx
- README.md
- bootstrap.specs.ts
- ArtifactOverrideVersion.driver.tsx
- jest
...
1. `AtlasManifest` - 46 edges
2. `addIssue()` - 33 edges
3. `runtimeError()` - 29 edges
4. `CliArguments` - 26 edges
5. `AtlasNavigation` - 26 edges
6. `AtlasSdk` - 26 edges
7. `AtlasGenerateService` - 23 edges
8. `assertPublishedArtifactManifest()` - 23 edges
9. `S3PublicationStorage` - 23 edges
10. `detectWorkspace()` - 23 edges

## Surprising Connections (you probably didn't know these)
- `compositionContains()` --indirect_call--> `manifest()`  [INFERRED]
  packages/cli/src/deployment/deploy.service.ts → apps/columbus/src/scripts/host/inspect-atlas-host/inspect-atlas-host.driver.ts
- `createHostProjections()` --indirect_call--> `manifest()`  [INFERRED]
  packages/cli/src/deployment/deploy.service.ts → apps/columbus/src/scripts/host/inspect-atlas-host/inspect-atlas-host.driver.ts
- `verifyRelease()` --indirect_call--> `file()`  [INFERRED]
  scripts/publish-release.ts → packages/cli/src/deployment/deploy.service.driver.ts
- `bootstrap()` --indirect_call--> `AtlasAngularHostAnchors`  [INFERRED]
  examples/hosts/demo-angular-host/src/bootstrap.ts → packages/runtime/src/angular-anchors.ts
- `createExternalWidgetRegistry()` --calls--> `registryRevision()`  [EXTRACTED]
  tests/e2e/prepare.ts → packages/cli/src/publication/static-registry/revision/registry-revision.ts
...
- 5-file cycle: `packages/runtime/src/index.ts -> packages/runtime/src/widget-registry.ts -> packages/runtime/src/loader/runtime-discovery.ts -> packages/runtime/src/resilience.ts -> packages/runtime/src/observability.ts -> packages/runtime/src/index.ts`

## Communities (351 total, 72 thin omitted)

### Community 0 - "index.ts"
Cohesion: 0.06
Nodes (40): emitHostError(), emitHostReady(), emitHostStart(), reportRetryFailure(), toError(), DomHostServices, startDomHost(), anchorKey() (+32 more)

### Community 1 - "react-generator.ts"
Cohesion: 0.19
Nodes (10): atlasPackageRange(), frameworkMajor(), pinSimpleReactVersion(), reactVersionProfile, generateReactAppFiles(), generateReactHostFiles(), reactAppIndex(), reactIndex() (+2 more)

### Community 2 - "AtlasManifest"
Cohesion: 0.07
Nodes (16): createTestContainer(), createTestElement(), createAssetElement(), createHostStatusContainer(), createStylesheetDocument(), getItem(), importWidget(), isTestAssetElement() (+8 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.13
Nodes (23): ui, createControlRequestHandler(), joinControlServer(), pathSegment(), registerOverride(), respondWithDevelopmentSession(), respondWithSession(), setControlHeaders() (+15 more)

### Community 4 - "workspace.ts"
Cohesion: 0.08
Nodes (47): darkColorScheme, fetchAtlasConfig(), isLoopbackBadgeHost(), isOverrideDocument(), overrideCount(), parseJson(), readAtlasConfig(), readBadgeDisabledAppIds() (+39 more)

### Community 5 - "build.driver.ts"
Cohesion: 0.17
Nodes (24): canonicalJson(), isRecord(), registryRevision(), sortJson(), artifactKind(), assertUniqueName(), bindHostDeployment(), cloneRegistry() (+16 more)
...
Cohesion: 0.09
Nodes (36): LocalBootstrapServerOptions, absoluteHttpUrl(), asRecord(), AssetExpectation, AtlasVerificationCheck, AtlasVerificationReport, AtlasVerificationStatus, AtlasVerifyOptions (+28 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.12
Nodes (26): AtlasPublicationLease, AtlasPreviewHeadLookup, AtlasPreviewHeadResolver, AtlasRegistryConfig, compileConfig(), configExists(), defineAtlasRegistryConfig(), isNodeError() (+18 more)
...
Cohesion: 0.06
Nodes (58): AssetResolver, createRemoteAssetResolver(), AssetUrlDriver, isExternalUrl(), isFragmentUrl(), rewriteCssUrls(), addDocumentStyleRewriteSession(), angularStyleScopeAttributeNames() (+50 more)
...
Cohesion: 0.15
Nodes (3): Assets And Styles, React Production Build and Publication, Troubleshooting
...
Cohesion: 0.06
Nodes (43): renderLoading(), AngularWidgetRuntime, AtlasEventMap, AtlasFetchHttpClient, HttpClientInput, HttpRequest, HttpRequestOptions, HttpRequestWithBody (+35 more)

### Community 21 - "dev.service.ts"
Cohesion: 0.17
Nodes (19): asObject(), configuredHostIds(), DevelopmentConfigDriver, firstObjectValue(), hostIdFromRoute(), isHostConfig(), objectValue(), parsePort() (+11 more)

### Community 22 - "manifest-utils.ts"
Cohesion: 0.14
Nodes (24): OverrideVersionDropdown(), VersionDropdownProps, versionOptionLabel(), artifactSourceDescription(), baseUrlFromRemoteEntry(), createCustomManifest(), CreateCustomManifestOptions, createEditorDraft() (+16 more)
...
Cohesion: 0.12
Nodes (32): mapWithConcurrency(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl(), bytesToBase64(), catalogSelectionError() (+24 more)

### Community 25 - "native-federation.ts"
Cohesion: 0.13
Nodes (21): AtlasNavigationItemsService, Injectable, DomRuntimeOptions, prepareStatusElement(), renderErrorState(), renderHostMountState(), renderHostNavigation(), renderLoadingState() (+13 more)
...
Cohesion: 0.05
Nodes (42): esbuild, bugs, dependencies, @atlas/schema, es-module-shims, description, devDependencies, esbuild (+34 more)

### Community 30 - "publish.service.ts"
Cohesion: 0.16
Nodes (17): cliActions(), cliSummary(), COMMAND_ALIASES, createCliError(), errorCauseMessage(), errorCauses(), errorStatus(), formatErrorWithCauses() (+9 more)
...
Cohesion: 0.29
Nodes (10): PullRequestDriver, providerFetch(), providerToken(), requiredString(), resolveBitbucketPullRequest(), resolveGitHubPullRequest(), resolveGitLabMergeRequest(), resolvePullRequestStatus() (+2 more)

### Community 37 - "atlas-host.ts"
Cohesion: 0.11
Nodes (36): createLoadedHost(), HostContext, HostContextValue, HostLoadResult, readActiveHost(), disabledOverridesKey(), DisabledOverrideStorageLocation, AtlasHostDriver (+28 more)

### Community 38 - "index.ts"
Cohesion: 0.14
Nodes (11): assertHostConfig(), AtlasBootstrapBuildResult, AtlasBootstrapDependencies, AtlasBootstrapService, AtlasBootstrapServiceOptions, bootstrapDigest(), defaultDependencies, AtlasBootstrapServiceDriver (+3 more)
...
Cohesion: 0.33
Nodes (6): ATLAS_HOST_FILES, ATLAS_INTEGRATION_FILES, DELEGATED_APP_FILES, DELEGATED_HOST_FILES, generatedOverlay(), isAngularStylesheet()

### Community 41 - ".run"
Cohesion: 0.07
Nodes (31): Input, AtlasAnchorComponent, AtlasAngularHostAnchors, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot (+23 more)

### Community 42 - "FailingMutableStorage"
Cohesion: 0.17
Nodes (31): assertAppManifest(), assertDigest(), assertExposes(), assertFramework(), assertHostDeploymentManifest(), assertHostManifest(), assertIdentifierArray(), assertManifestDescriptor() (+23 more)
...
Cohesion: 0.07
Nodes (28): compilerOptions, composite, declaration, exactOptionalPropertyTypes, jsx, lib, module, moduleResolution (+20 more)

### Community 46 - "angular-widget.ts"
Cohesion: 0.13
Nodes (15): CreateOverrideDocumentOptions, MockTab, storageArea(), clearHostDataCache(), HostDataSnapshot, isExtensionPage(), isHostDataSnapshot(), readHostDataCache() (+7 more)

### Community 47 - "publication-storage.ts"
Cohesion: 0.10
Nodes (18): ControlServerDriver, ControlServerDriver, createDevSession(), createLocalDevCatalog(), DevSessionEntry, DevelopmentSessionDriver, SessionScenario, HostDevSession (+10 more)
...
Cohesion: 0.24
Nodes (10): assertPacked(), canonicalLicense, exportedTargets(), normalizeText(), outputDirectory, packageDirectories, readArchiveFile(), root (+2 more)
...
Cohesion: 0.12
Nodes (17): createDeferred(), createHostCatalog(), createRouteManifest(), createRoutePlacement(), createSlotManifest(), createTestDocument(), createWidgetRendererContainer(), duplicateRegistryWidgetResult() (+9 more)

### Community 54 - "AtlasGenerateService"
Cohesion: 0.10
Nodes (17): AtlasDeploymentConvergenceError, AtlasDeployResult, APP_ENTRY, appManifest(), bytesResponse(), CrossRegistryTransfer, DeployServiceDriver, digest() (+9 more)

### Community 55 - "types.ts"
Cohesion: 0.25
Nodes (13): BootstrapScenario, BootstrapServerDriver, createBootstrapFileMap(), createBootstrapRequestHandler(), createUpgradeRequest(), hasFileExtension(), isBootstrapMethod(), matchesNativeProxyRoute() (+5 more)

### Community 56 - "target.ts"
Cohesion: 0.12
Nodes (25): asDependencyMap(), AtlasNxProjectType, AtlasPackageManager, AtlasScaffoldOptions, AtlasTask, AtlasWorkspaceKind, configuredNxOutputPaths(), createFormatGeneratedCommand() (+17 more)
...
Cohesion: 0.08
Nodes (25): compilerOptions, baseUrl, composite, declaration, declarationMap, exactOptionalPropertyTypes, lib, module (+17 more)
...
Cohesion: 0.24
Nodes (7): BadgeRefreshDependencies, countDevSessionOverrides(), CountDevSessionOverridesOptions, createBadgeRefresher(), DevSessionBadgeState, BadgeRefreshDriver, Deferred
...
Cohesion: 0.22
Nodes (9): Angular Compiler Rejects `emitDeclarationOnly`, Angular Remote Entry Does Not Load, Angular Troubleshooting, Host APIs Are Missing, Inner Routing Escapes The App, Install Fails With Peer Conflicts, Native Federation Warns `No entry point found for <package>`, Spinner Never Disappears (+1 more)

### Community 66 - "Atlas CLI user experience"
Cohesion: 0.20
Nodes (9): Atlas error handling, Boundary ownership, Browser runtime and SDK, CLI, Columbus, Error contract, Standards references, Surface rules (+1 more)
...
Cohesion: 0.09
Nodes (23): 1. Build framework output, 2. Publish immutable releases, 3. Build static bootstrap once, 4. Roll out bootstrap, 5. Deploy the host selection and bind its URL, 6. Deploy apps, 7. Verify the public host, Artifact names in CI (+15 more)
...
Nodes (51): {
  ...
  createAngularFederationConfig,
}, ANGULAR_FEDERATION_SKIP, ANGULAR_SHARED_DEPENDENCY_OPTIONS, angularWidgetConfigArgument(), angularWidgetConfigImport(), angularWidgetConfigPath() (+43 more)

### Community 70 - "nx.ts"
Cohesion: 0.16
Nodes (26): alignDelegatedAngularFederationConfig(), angularNativeFederationBuilder(), asObject(), atlasCommand(), collectNxPathValues(), commandValues(), declaresAtlasConfigOutput(), delegatesToDevTarget() (+18 more)
...
Cohesion: 0.14
Nodes (46): assertAtlasHostCatalog(), assertAtlasHostManifest(), assertAtlasManifest(), AtlasValidationError, formatAtlasValidationMessage(), AtlasValidationIssue, validateHostCatalog(), validateUniqueManifestIds() (+38 more)
...
Cohesion: 0.12
Nodes (20): devDependencies, @angular/compiler, @angular/compiler-cli, @angular/core, @angular/platform-browser, react, @types/react, vite (+12 more)
...
Cohesion: 0.07
Nodes (31): AngularLiveDevelopmentDriver, SOURCE_PATH, BrowserStorage, isRecord(), readOverride(), restrictExtensionHosts(), StoredOverrideDocument, badgeText() (+23 more)

### Community 80 - "atlas-host.driver.ts"
Cohesion: 0.24
Nodes (17): assertArtifactCollections(), assertDeployments(), assertDeploymentSelections(), assertDescriptorMap(), assertEnvironmentDoesNotMatchRelease(), assertEnvironmentName(), assertExternalRegistrySelections(), assertHostSelection() (+9 more)

### Community 81 - "React Routing"
Cohesion: 0.14
Nodes (12): createBootstrapHtml(), escapeHtml(), appConfig(), assertValidAtlasId(), atlasAppConfig(), atlasBootstrapHtml(), atlasHostConfig(), title() (+4 more)

### Community 82 - "devDependencies"
Cohesion: 0.11
Nodes (19): jest, devDependencies, cross-spawn, jest, @playwright/test, prettier, ts-jest, turbo (+11 more)
...
Cohesion: 0.10
Nodes (17): BrowserErrorContext, createBrowserError(), logBrowserError(), AppReadiness, AtlasRuntimeController, createAppReadiness(), createLoadingEmitter(), createRoutePlacementPlan() (+9 more)

### Community 85 - "publish-config.ts"
Cohesion: 0.13
Nodes (15): assertLease(), AtlasPublicationStorageSource, createPublicationStorage(), DeploymentLease, PublicationStorageDriver, environmentBoolean(), environmentS3LockMode(), externalPublicationLease() (+7 more)

### Community 86 - "react.ts"
Cohesion: 0.16
Nodes (12): alignDelegatedTsconfig(), atlasConfigNxTarget(), NxDriver, ProjectType, nxTarget(), availableAppsMessage(), interactiveTurboDevTask(), isRecord() (+4 more)
...
Cohesion: 0.17
Nodes (12): deploymentCatalog, isDeploymentCatalog(), isManifest(), isRecord(), runCli(), artifactsRoot, cdnRoot, externalCdnRoot (+4 more)

### Community 91 - "AtlasManifest"
Cohesion: 0.13
Nodes (24): AtlasHostMountState, AtlasBrowserOverrideOptions, AtlasAppEvent, AtlasEventBase, AtlasHostEvent, AtlasOperationEvent, AtlasRuntimeEvent, AtlasRuntimeObserver (+16 more)

### Community 92 - "loader.driver.ts"
Cohesion: 0.13
Nodes (8): AtlasPublicationBody, AtlasPublicationListedObject, AtlasPublicationObjectMetadata, AtlasPublicationReplaceCondition, collect(), MemoryPublicationStorage, StoredObject, PublicationFile
...
Cohesion: 0.12
Nodes (15): 1. Generate, 2. Choose Where The App Appears, 3. Build Feature UI, 4. Run Inside Host, 5. Test And Continue, Build An Angular App, Angular SDK, App Domain (+7 more)

### Community 99 - "navigation-paths.ts"
Cohesion: 0.33
Nodes (7): createAtlasBootstrapFiles(), withTrailingNewline(), AtlasBootstrapFile, AtlasBootstrapOptions, createNginxConfig(), cspSources(), normalizedOrigins()
...
Cohesion: 0.26
Nodes (10): generateAngularAppFiles(), generateAngularHostFiles(), angularDependencyRange(), angularIndex(), angularPackage(), AngularPackageOptions, nativeFederationPackage(), usesNativeFederationV4() (+2 more)

### Community 102 - "Atlas Overview"
Cohesion: 0.33
Nodes (8): AtlasBootstrapManifest, atlasHostDiscoveryUrl(), matchesLocation(), resolveHostDiscovery(), atlasDiscoveryRequest, resolveAtlasHostRuntime(), bootstrap, discovery

### Community 103 - "dependencies"
Cohesion: 0.15
Nodes (13): @angular/animations, @angular/common, dependencies, @angular/animations, @angular/common, @angular/core, @atlas/runtime, es-module-shims (+5 more)
...
Cohesion: 0.18
Nodes (7): AtlasInvocation, InteractionDriver, InteractionScenario, resolveInvocation(), PromptTestDouble, title(), AtlasPrompter

### Community 109 - "publication-context.ts"
Cohesion: 0.32
Nodes (12): absoluteUrl(), assertAssetOrigin(), assertAtlasBootstrapManifest(), assertBootstrapFiles(), assertDevelopmentRuntime(), assertRegistryUrl(), assertSecureHttpUrl(), isRecord() (+4 more)
...
### Community 112 - "background.ts"
Cohesion: 0.20
Nodes (10): Active host manifest, Canonical artifact manifest, Host discovery, HTTP and caching, Layout, Locking and custom storage, Registry and Storage Reference, `registry.json` v2 (+2 more)
...
Cohesion: 0.50
Nodes (4): `@atlas/cli`, Build, publish, deploy, Commands, Storage
...
### Community 117 - "React production deployment"
Cohesion: 0.21
...
Cohesion: 0.21
Nodes (8): AtlasPublicationStorage, artifactPrefix(), assertMetadata(), assertPayload(), createAndVerify(), createImmutable(), digest(), publicationFiles()
...
Cohesion: 0.18
Nodes (11): @angular/cli, @angular-devkit/build-angular, devDependencies, @angular/cli, @angular/compiler-cli, @angular-devkit/build-angular, @types/node, typescript (+3 more)
...
Cohesion: 0.09
Nodes (21): CliArguments, completedProcessOutput(), writeDevOverrideDocument(), browserOpenCommand(), DevelopmentProcessDriver, RemoteEntryScenario, formatFrameworkServerError(), frameworkServerArguments() (+13 more)

### Community 128 - "HttpClient"
Cohesion: 0.17
Nodes (8): wait(), Bytes, collect(), contentType(), DirectoryPublicationStorage, isMutable(), listFiles(), metadata()

### Community 129 - "angular.specs.ts"
Cohesion: 0.23
Nodes (11): angularRemoteName(), angularCompilerOptions(), angularFederationConfig(), angularFederationConfigFile(), angularNativeFederationBuilder(), angularRootTsconfig(), angularTemplateCompilerOptions(), angularWorkspace() (+3 more)
...
Cohesion: 0.22
Nodes (9): Architecture, Build-once promotion, Deliberate boundaries, Deployment and convergence, External widgets, One source of truth per concern, Ownership, Preview correctness (+1 more)

### Community 134 - "Local development and Columbus"
Cohesion: 0.18
Nodes (11): Columbus selection model, Local development and Columbus, Prepare without starting servers, Proxy host API requests, Recovery from a broken host, Run a local app, Run a local host client, Safety checks (+3 more)

### Community 135 - "federation-config.mjs"
Cohesion: 0.20
Nodes (19): binding(), AtlasHostBindingRequest, BindSelectedHostOptions, parseExternalRegistry(), readExternalRegistries(), readHostBaseUrls(), readHostBindingRequest(), AtlasRegistryMutation (+11 more)
...
Cohesion: 0.13
Nodes (17): devDependencies, @angular/compiler, @angular/compiler-cli, @angular/core, @angular/platform-browser, react, @types/react, @angular/compiler (+9 more)
...
### Community 145 - "Angular SDK"
Cohesion: 0.05
Nodes (40): AngularHostSdkReference, AngularHostStartServices, AppBootstrap, createExportedWidget(), defineExportedWidget(), ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk (+32 more)

### Community 146 - "Host bootstrap"
Cohesion: 0.12
Nodes (16): Additional asset origins, Build bootstrap, Common mistakes, Custom HTML, Docker and Nginx, Host bootstrap, How the browser selects an environment, Migration from runtime templates (+8 more)

### Community 147 - "Static registry"
Cohesion: 0.24
...
Cohesion: 0.50
Nodes (4): Active host manifest, Artifact manifests, Bootstrap and host discovery, Manifest Contracts
...
Cohesion: 0.11
Nodes (41): affectedHostIds(), asAsyncIterable(), assertBytes(), assertExpectedRevision(), assertResponseMetadata(), assertSelectedManifestIdentity(), assertStoredMetadata(), AtlasDeployService (+33 more)
...
### Community 157 - "Exported Widgets"
Cohesion: 0.31
Nodes (6): AppComponent, Component, bootstrap(), DemoRouteAnchorComponent, HostMountRequest, Component

### Community 158 - "React SDK"
Cohesion: 0.13
Nodes (3): HttpClient, IHttpClient, withBody()

### Community 159 - "overlay.ts"
Cohesion: 0.06
Nodes (22): AtlasDeploymentCatalog, createLocationStrategy(), notifyPopState(), PopStateListener, readInnerUrl(), AtlasAppContext, AtlasAppMountRequest, AtlasAppMountResult (+14 more)

### Community 160 - "env.ts"
Cohesion: 0.21
...
Cohesion: 0.43
Nodes (4): bootstrapActions(), describeFatalError(), FatalErrorDriver, showFatalError()
...
### Community 164 - "Contributing to Atlas"
Cohesion: 0.09
Nodes (19): 1. Generate, 2. Choose Where The App Appears, 3. Build Feature UI, 4. Run Inside Host, 5. Test And Continue, Build A React App, App Files, Choose Your Role (+11 more)

### Community 165 - "Documentation Guidelines"
Cohesion: 0.30
Nodes (12): assertSupportedGeneratorFramework(), assertValidGeneratorOptions(), AtlasGeneratedFile, AtlasGeneratorOptions, AtlasPackageManager, angularWidgetConfig(), generateWidgetFiles(), pascal() (+4 more)
...
### Community 168 - "./federation-config"
Cohesion: 0.50
Nodes (5): createNxGenerationCommand(), createTaskCommand(), packageExecutor(), turboTask(), workspaceTask()
...
### Community 172 - "angular.ts"
Cohesion: 0.06
Nodes (53): addUniquePolyfill(), asObject(), configureAngularBuildNotifications(), configureAngularDevelopmentTargets(), AngularGenerationDriver, enableAngularBuildNotifications(), ensureAngularBuildNotifications(), ensureAngularFederationPolyfills() (+45 more)
...
Cohesion: 0.33
Nodes (4): HostLayout(), HostMountRequest, mountHost(), root

### Community 178 - "@angular-architects/native-federation"
Cohesion: 0.17
Nodes (8): AtlasEventBus, AtlasEventListener, createAtlasEventBus(), EventKey, notifyListener(), PayloadEventKey, PayloadlessEventKey, StoredEventListener

### Community 179 - "[Unreleased]"
Cohesion: 0.40
Nodes (4): Added, Changed, Changelog, [Unreleased]

### Community 180 - "StaticRegistryDriver"
Cohesion: 0.43
Nodes (5): digest(), hostCatalog(), providerManifest(), registry(), WidgetRegistryDriver

### Community 181 - "package.json"
Cohesion: 0.50
Nodes (3): name, private, version

### Community 182 - "react-router.ts"
Cohesion: 0.10
Nodes (27): AtlasArtifactManifestBase, AtlasAppConfig, AtlasBaseConfig, AtlasHostConfig, AtlasRouteMount, AtlasSlotMount, AtlasWidgetConfig, AtlasAppDomIsolation (+19 more)
...
### Community 197 - "Angular Troubleshooting"
Cohesion: 0.29
...
### Community 204 - "loadBrowserRuntimeOverrides"
Cohesion: 0.67
...
### Community 227 - "ports.ts"
Cohesion: 0.24
Nodes (12): ControlServerLease, isActiveLease(), LEASE_DIRECTORY, leaseId(), leasePath(), processExists(), readActiveControlServerLeases(), readLease() (+4 more)

### Community 232 - "./federation-config"
Cohesion: 0.24
Nodes (12): createOverrideDocument(), overrideCount(), overrideReason(), persistOverrides(), reloadHostTab(), validateLocalOverride(), validateLocalRemoteEntry(), writeDisabledOverrides() (+4 more)

### Community 233 - "publishFiles"
Cohesion: 0.28
Nodes (13): readPublishedCatalog(), assertDescriptorBytes(), isHttpUrl(), loadHostDeployment(), loadHostRuntimeConfig(), loadPublishedManifest(), parseArtifact(), parseHostDeployment() (+5 more)

### Community 234 - "@babel/plugin-syntax-jsx"
Cohesion: 0.23
Nodes (10): CliErrorDriver, ErrorScenario, actionableMessage(), AtlasError, AtlasErrorOptions, AtlasErrorSurface, ensureActionableError(), errorSummary() (+2 more)

### Community 235 - "Atlas Overview"
Cohesion: 0.12
Nodes (25): PublishServiceDriver, AtlasResolvedRelease, ExternalSnapshot, AtlasHostDiscovery, AtlasHostDiscoveryBinding, AtlasExternalRegistrySelection, AtlasAppArtifactManifest, AtlasArtifactKind (+17 more)
...
### Community 237 - "jest-environment-jsdom"
Cohesion: 0.21
Nodes (6): angularAppAppComponent(), angularAppEntry(), angularAppHomeComponent(), angularSinglePageAppComponent(), angularSinglePageAppEntry(), angularRootSelector()

### Community 238 - "React Troubleshooting"
Cohesion: 0.21
...
### Community 240 - "verify-bootstrap-container.ts"
Cohesion: 0.33
Nodes (6): App Domain, Consumer Testing, Deployment Domain, Host Domain, Local Integration, What To Test

### Community 243 - "ts-jest"
Cohesion: 0.50
Nodes (7): AtlasLoaderDependencies, deploymentReferences(), loadDeployment(), loadInitialCatalog(), mapWithConcurrency(), resolveRuntime(), startAtlasLoader()

### Community 244 - "@testing-library/user-event"
Cohesion: 0.29
Nodes (7): Before a Pull Request, Contributing to Atlas, Documentation, File Extensions, Releases, Repository Layout, Setup

### Community 245 - "@types/babel__core"
Cohesion: 0.33
Nodes (11): runtimeError(), RuntimeErrorOptions, assertRegistry(), assertWidgetId(), createRegistryWidgetResolver(), descriptorReference(), discoverExternalWidgets(), fetchRegistry() (+3 more)

### Community 246 - "@babel/core"
Cohesion: 0.22
Nodes (12): acquireStylesheet(), AtlasStyleRelease, AtlasStylesheetLoadInput, AtlasStylesheetLoadOptions, createRelease(), defaultManifestPolicy(), isStylesheetLoadOptions(), LoadedStylesheet (+4 more)

### Community 247 - "publication-storage.driver.ts"
Cohesion: 0.06
Nodes (45): FetchJsonDriver, fetchBytes(), fetchJson(), fetchJsonRequest(), isLoopbackUrl(), validateIntegrity(), appendHostStylesheet(), defaultDependencies() (+37 more)
...
Cohesion: 0.06
Nodes (68): DomHostOptions, createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, RoutePlacement, AtlasHostRuntimeOptions (+60 more)
...
Cohesion: 0.24
Nodes (6): BadgeCountMessage, ACTION_ICON_PATHS, actionIconPathsFor(), actionThemeMessage, ColorScheme, isActionThemeMessage()

### Community 264 - "prepare-release.driver.ts"
Cohesion: 0.40
Nodes (5): Atlas Host, Build a Host, Build The Host, Reference, Ship The Host

### Community 265 - "WorkspaceDriver"
Cohesion: 0.43
Nodes (4): digestToIntegrity(), hydrateApp(), hydratePublishedArtifactManifest(), DIGEST

### Community 266 - "ArtifactOverrideVersion.driver.tsx"
Cohesion: 0.12
Nodes (19): App(), ArtifactConfigurationLocationState, ArtifactsOverridesPage(), ArtifactName(), ArtifactOverrideActions(), ArtifactOverrideToggle(), ArtifactOverrideVersion(), ArtifactOverrideVersionDriver (+11 more)

### Community 268 - "bootstrap.specs.ts"
Cohesion: 0.40
Nodes (5): scripts, build, test, test:e2e, typecheck

### Community 269 - "ArtifactOverrideVersion.driver.tsx"
Cohesion: 0.29
...
### Community 270 - "jest"
Cohesion: 0.27
Nodes (6): SupportedFramework, DevelopmentPortsDriver, PortScenario, hostClientPortFallback(), resolveHostDevPorts(), HostDevPorts

### Community 279 - "proxy-config.ts"
Cohesion: 0.40
Nodes (5): Angular Project Guide, App Files, Choose Your Role, Host Files, Task Guides

### Community 285 - "ports.driver.ts"
Cohesion: 0.47
Nodes (5): docker(), execute, requireOk(), root, waitForHealth()

### Community 287 - "NetworkLimiter"
Cohesion: 0.40
...
### Community 289 - "@testing-library/react"
Cohesion: 0.33
...
### Community 294 - "AngularWidgetOutletController"
Cohesion: 0.40
...
### Community 296 - "zone.js"
Cohesion: 0.29
Nodes (6): Atlas CLI user experience, Color and accessibility, Command inventory, Design references, Output contract, Prompts
...
### Community 298 - "angular-location-strategy.ts"
Cohesion: 0.16
Nodes (12): ArtifactConfigurationActions(), ArtifactConfigurationActionsProps, ArtifactConfigurationActionsDriver, ArtifactConfigurationPage(), OverrideRadioCard(), OverrideRadioCardProps, OverridesSelectionForm(), OverridesSelectionFormProps (+4 more)

### Community 299 - "react"
Cohesion: 0.67
Nodes (3): createReleaseWorkspace(), packageDirectories, writeJson()

### Community 300 - "fetchJson"
Cohesion: 0.33
...
### Community 311 - "React Project Guide"
Cohesion: 0.43
Nodes (6): emitMountState(), assertCatalogMatchesConfig(), DomHostRuntimeInput, resolveDomSlotContainer(), resolveHostConfig(), startDomHostRuntime()

### Community 315 - "AtlasRouteContext"
Cohesion: 0.33
Nodes (3): OverridesTableToolbarDriver, OverridesTableToolbar(), OverridesTableToolbarProps

### Community 322 - "host-loader.driver.ts"
Cohesion: 0.33
Nodes (3): EmptyHostDataStateDriver, EmptyHostDataState(), EmptyHostDataStateProps

### Community 330 - "angular-local-runtime.ts"
Cohesion: 0.47
Nodes (3): AngularLocalManifest, AngularLocalRuntimeDriver, prepareAngularLocalRuntime()

### Community 331 - "bootstrap-assets.ts"
Cohesion: 0.50
Nodes (4): ATLAS_BROWSER_LOADER, createBrowserAssetFiles(), MODULE_SHIM_SOURCE, require

### Community 332 - "proxy-config.ts"
Cohesion: 0.50
Nodes (3): AngularBuildPrivateApi, loadAngularHostProxy(), LocalNativeProxy

### Community 333 - "react-vite-generator.ts"
Cohesion: 0.60
Nodes (4): reactAppViteConfig(), reactHostViteConfig(), reactViteConfig(), ReactViteConfigTemplateOptions

### Community 334 - "route-matcher.ts"
Cohesion: 0.60
Nodes (4): findRoutePlacement(), normalizePath(), routeMatches(), segments()

### Community 335 - "./federation-config"
Cohesion: 0.50
Nodes (4): ./federation-config, import, require, types

### Community 339 - "engines"
Cohesion: 0.67
Nodes (3): engines, node, pnpm

## Knowledge Gaps
- **1640 isolated node(s):** `Start Here`, `How Atlas Fits Together`, `First Local System`, `Packages`, `Contributing` (+1635 more)
...
- `AtlasDevService` (2× useful, score=0.911506754)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `delay()` connect `extension.specs.ts` to `HttpClient`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `versionPackages()` connect `prepare-release.js` to `HttpClient`, `content-script.ts`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `AtlasAngularHostAnchors` connect `.run` to `index.ts`, `Exported Widgets`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **What connects `Start Here`, `How Atlas Fits Together`, `First Local System` to the rest of the system?**
