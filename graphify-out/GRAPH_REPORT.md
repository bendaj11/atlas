...
## Corpus Check
- 591 files · ~205,537 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5029 nodes · 9341 edges · 333 communities (264 shown, 69 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 139 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4883917b`
...
- Atlas Documentation
- entry.ts
- angular-workspace-generator.ts
- exports
- schema.driver.ts
...
- `developmentSession()` --indirect_call--> `manifest()`  [INFERRED]
  packages/runtime/src/index.specs.ts → apps/columbus/src/scripts/host/inspect-atlas-host/inspect-atlas-host.driver.ts
...
## Communities (333 total, 69 thin omitted)
...
Cohesion: 0.07
Nodes (10): createAssetElement(), createStylesheetDocument(), importWidget(), isTestAssetElement(), isTestStyleLink(), renderLoading(), TestAssetElement, TestStyleLink (+2 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.08
Nodes (43): asStringRecord(), DEPENDENCY_FIELDS, dependencyDeclared(), DependencyField, dependencyManifestPath(), existingFrameworkVersionInfo(), frameworkPrimaryDependency(), FrameworkVersionInfo (+35 more)

### Community 4 - "workspace.ts"
Cohesion: 0.12
Nodes (10): createHostCatalog(), createTestContainer(), createTestElement(), createWidgetRendererContainer(), duplicateWidgetResult(), testHostManifest(), TestProductionSelection, widgetManifest() (+2 more)
...
Cohesion: 0.08
Nodes (35): absoluteHttpUrl(), asRecord(), AssetExpectation, AtlasVerificationCheck, AtlasVerificationReport, AtlasVerificationStatus, AtlasVerifyOptions, AtlasVerifyService (+27 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.09
Nodes (35): AtlasArtifactPreviewState, AtlasPublicationLease, AtlasPublicationStorage, createPublicationStorage(), AtlasRegistryConfig, artifactPrefix(), assertExpectedRegistryRevision(), assertMetadata() (+27 more)
...
Cohesion: 0.15
Nodes (11): AtlasRuntimeController, createRuntimeMount(), findRoutePlacement(), navigationTargets(), placementKey(), mount(), startAtlasHostRuntime(), normalizePath() (+3 more)
...
Cohesion: 0.05
Nodes (55): AtlasNavigationItemsService, Injectable, BrowserErrorContext, createBrowserError(), logBrowserError(), emitHostError(), emitHostReady(), emitHostStart() (+47 more)
...
Cohesion: 0.05
Nodes (68): createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, AppReadiness, AtlasHostRuntimeOptions, AtlasLoaderOptions (+60 more)
...
Cohesion: 0.06
Nodes (40): ATLAS_BROWSER_LOADER, createBrowserAssetFiles(), ES_MODULE_SHIM, createAtlasBootstrapFiles(), withTrailingNewline(), createBootstrapHtml(), escapeHtml(), validateBootstrapHtml() (+32 more)
...
### Community 34 - "app.ts"
Cohesion: 0.12
Nodes (22): BrowserOverrideScopePicker(), BrowserOverrideScopePickerDriver, ScopePickerProps, OverridesContext, OverridesContextValue, OverridesProvider(), SessionContext, SessionContextValue (+14 more)
...
Cohesion: 0.10
Nodes (39): createOverrideDocument(), disabledOverridesKey(), DisabledOverrideStorageLocation, errorMessage(), findAtlasHostTab(), hasTabId(), InspectableTab, inspectTab() (+31 more)
...
### Community 41 - ".run"
Cohesion: 0.06
Nodes (35): Input, AtlasAnchorComponent, AtlasAngularHostAnchors, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot (+27 more)

### Community 42 - "FailingMutableStorage"
Cohesion: 0.17
Nodes (8): AtlasHostDriver, MockTab, storageArea(), clearHostDataCache(), HostDataSnapshot, isExtensionPage(), isHostDataSnapshot(), readHostDataCache()
...
Cohesion: 0.16
Nodes (16): readOverride(), badgeText(), builtExtensionPath, editApp(), ExtensionSession, livePackagePath, liveSourcePath, openPopup() (+8 more)
...
Cohesion: 0.16
Nodes (11): ModuleShimDriver, moduleShim, BootstrapFailure, DevSession, HostEntry, HostModule, HostMountRequest, ModuleShimGlobal (+3 more)

### Community 54 - "AtlasGenerateService"
Cohesion: 0.14
Nodes (19): assertAtlasHostManifest(), assertAtlasManifest(), AtlasAppConfig, AtlasBaseConfig, AtlasHostConfig, AtlasSlotMount, AtlasWidgetConfig, AtlasAppDomIsolation (+11 more)

### Community 55 - "types.ts"
Cohesion: 0.11
Nodes (16): createDevSession(), createLocalDevCatalog(), DevSessionEntry, DevelopmentSessionDriver, SessionScenario, HostDevSession, localHostPlaceholder(), uniqueArtifacts() (+8 more)
...
Cohesion: 0.39
Nodes (5): AtlasRouteMount, AtlasPlacement, AtlasPlacementKind, AtlasRouteContribution, AtlasRouteNavigation

### Community 63 - "navigation-types.ts"
Cohesion: 0.13
Nodes (34): assertDescriptorBytes(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl(), AtlasBrowserOverrideOptions, bytesToBase64() (+26 more)
...
### Community 70 - "nx.ts"
Cohesion: 0.12
Nodes (29): addUniqueString(), angularNativeFederationBuilder(), asObject(), atlasCommand(), atlasConfigNxTarget(), collectNxPathValues(), commandValues(), declaresAtlasConfigOutput() (+21 more)
...
Cohesion: 0.05
Nodes (39): AngularHostSdkReference, AngularHostStartServices, AppBootstrap, createExportedWidget(), defineExportedWidget(), ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk (+31 more)

### Community 80 - "atlas-host.driver.ts"
Cohesion: 0.14
Nodes (12): AtlasDeployResult, appManifest(), DeployServiceDriver, digest(), file(), hostManifest(), AtlasRegistryMutation, AtlasResolvedRelease (+4 more)

### Community 81 - "React Routing"
Cohesion: 0.17
Nodes (4): HostLoaderDriver, Faker, @faker-js/faker, ValidationDriver
...
Cohesion: 0.16
Nodes (16): createLoadedHost(), HostContext, HostContextValue, HostLoadResult, readActiveHost(), readCachedHost(), OverrideManifestsDriver, extractActiveOverrideManifests() (+8 more)
...
Cohesion: 0.06
Nodes (46): mapWithConcurrency(), AtlasHostMountState, AngularLocalManifest, AngularLocalRuntimeDriver, prepareAngularLocalRuntime(), artifactDirectoryUrl(), AtlasFederationAdapter, createNativeFederationImporters() (+38 more)
...
Cohesion: 0.18
Nodes (15): createLocalOverrides(), artifactRecord(), descriptor(), DescriptorFixture, emptyArtifactRecord(), InspectAtlasHostDriver, installPage(), jsonResponse() (+7 more)
...
Cohesion: 0.08
Nodes (32): cliActions(), cliSummary(), COMMAND_ALIASES, createCliError(), CliErrorDriver, ErrorScenario, errorCauseMessage(), errorCauses() (+24 more)
...
Cohesion: 0.12
Nodes (18): DevelopmentPortsDriver, PortScenario, hostClientPortFallback(), resolveHostDevPorts(), ResolveHostDevPortsOptions, nonInteractivePrompter, assertLocalPreviewPort(), AtlasDevService (+10 more)
...
Cohesion: 0.06
Nodes (37): AngularWidgetRuntime, readWidgetRuntime(), AtlasEventBus, AtlasEventListener, createAtlasEventBus(), EventKey, notifyListener(), PayloadEventKey (+29 more)
...
Cohesion: 0.12
Nodes (28): isDeployedProductionVersion(), OverrideVersionDropdown(), deployedManifest, VersionDropdownProps, ArtifactConfigurationLocationState, useArtifactConfiguration(), CreateOverrideDocumentOptions, artifactSourceDescription() (+20 more)
...
### Community 168 - "angular-workspace-generator.ts"
Cohesion: 0.21
...
Cohesion: 0.39
Nodes (6): applyOverrides(), artifactRegistryRoot(), descriptorReference(), OverridesDriver, mergeDevSessionCatalog(), resolveOverrideManifest()
...
### Community 182 - "local-development.specs.ts"
Cohesion: 0.23
...
Cohesion: 0.11
Nodes (36): artifactRegistryRoot(), assertDescriptor(), Descriptor, fetchManifestReference(), fetchWithTimeout(), HostDeployment, inspectAtlasHost(), loadArtifactVersion() (+28 more)
...
Cohesion: 0.33
Nodes (6): BrowserStorage, isRecord(), restrictExtensionHosts(), StoredOverrideDocument, createTestExtension(), launchExtension()
...
### Community 238 - "ArtifactOverrideVersion.driver.tsx"
Cohesion: 0.67
...
Cohesion: 0.08
Nodes (12): collect(), jsonBytes(), MemoryStorage, AtlasPublicationBody, AtlasPublicationListedObject, AtlasPublicationObjectMetadata, AtlasPublicationReplaceCondition, collect() (+4 more)

### Community 248 - "AtlasPlacement"
Cohesion: 0.06
Nodes (29): AtlasEventMap, AtlasAppContext, AtlasAppMountRequest, AtlasAppMountResult, AtlasExportedWidgetMountResult, AtlasHostClientEntry, AtlasRouteContext, AtlasScopedNavigation (+21 more)
...
### Community 296 - "@angular/animations"
Cohesion: 0.31
...
Cohesion: 0.15
Nodes (26): DeploymentWrite, AtlasArtifactManifestBase, AtlasDomIsolation, AtlasExposeMap, AtlasFramework, AtlasAppManifest, AtlasMetadata, AtlasMetadataValue (+18 more)

### Community 316 - "WorkspaceDriver"
Cohesion: 0.21
Nodes (5): ProcessCommand, createInstallCommand(), CommandScenario, WorkspaceDriver, WorkspaceScenario

### Community 318 - "hydrate-published-artifact.ts"
Cohesion: 0.39
Nodes (5): AtlasAppArtifactManifest, digestToIntegrity(), hydrateApp(), hydratePublishedArtifactManifest(), DIGEST

### Community 321 - "@angular/compiler"
Cohesion: 0.50
...
## Knowledge Gaps
- **1604 isolated node(s):** `HostContext`, `HostLoadResult`, `DescriptorFixture`, `RegistryArtifact`, `Registry` (+1599 more)
...
- `AtlasDevService` (2× useful, score=0.829244781) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `HostLoaderDriver` connect `React Routing` to `contracts.ts`, `Workspace integration`, `manifest-utils.ts`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `createReactAppViteConfig()` connect `generate.service.ts` to `routing.md`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `loadBrowserRuntimeOverrides()` connect `navigation-types.ts` to `runtime-discovery.ts`, `FailingMutableStorage`, `manifest-utils.ts`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **What connects `HostContext`, `HostLoadResult`, `DescriptorFixture` to the rest of the system?**
