# Graph Report - atlas  (2026-09-08)

## Corpus Check
- 638 files · ~226,847 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5276 nodes · 9939 edges · 354 communities (284 shown, 70 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 147 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b804db44`
...
1. `CliArguments` - 42 edges
2. `AtlasManifest` - 39 edges
3. `addIssue()` - 33 edges
4. `AtlasExtensionManifest` - 28 edges
5. `AtlasNavigation` - 28 edges
6. `AtlasPublicationStorage` - 26 edges
7. `generateAngularAppFiles()` - 26 edges
8. `detectWorkspace()` - 25 edges
9. `AtlasHostCatalog` - 25 edges
10. `AtlasHostManifest` - 25 edges
...
## Communities (354 total, 70 thin omitted)

### Community 0 - "index.ts"
Cohesion: 0.09
Nodes (17): MountedWidgetState, AppBootstrap, createExportedWidget(), defineApp(), defineExportedWidget(), provideAtlasAngularStyles(), provideAtlasApp(), AtlasAppMountRequest (+9 more)

### Community 1 - "react-generator.ts"
Cohesion: 0.05
Nodes (86): angularAppAppComponent(), angularAppConfig(), angularAppDetailsComponent(), angularAppEntry(), angularAppHomeComponent(), angularAppMain(), angularAppRoutes(), angularSinglePageAppComponent() (+78 more)

### Community 2 - "AtlasManifest"
Cohesion: 0.05
Nodes (29): createDeferred(), createHostCatalog(), createRouteManifest(), createRoutePlacement(), createSlotManifest(), createTestContainer(), createTestDocument(), createTestElement() (+21 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.29
Nodes (8): AtlasArtifactPreviewStateEntry, AtlasPreviewStateFile, defaultDependencies, isArtifactPreviewStateEntry(), isPreviewNumber(), isPreviewStateFile(), PullRequestStateDependencies, readOpenPreviews()
...
Cohesion: 0.11
Nodes (31): AtlasMountedApp, AtlasWidgetErrorRenderContext, AtlasWidgetRenderContext, createAppReadiness(), createExportedWidgetContext(), createLoadingEmitter(), createMountBoundary(), createRoutePlacementPlan() (+23 more)

### Community 7 - "index.ts"
Cohesion: 0.14
Nodes (22): createControlRequestHandler(), developmentSession(), joinControlServer(), readActiveControlServerLeases(), pathSegment(), registerOverride(), respondWithDevelopmentSession(), respondWithSession() (+14 more)
...
Cohesion: 0.13
Nodes (30): HostDevSession, absoluteHttpUrl(), asRecord(), AssetExpectation, AtlasVerificationStatus, AtlasVerifyService, createReport(), errorMessage() (+22 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.09
Nodes (35): AtlasArtifactPreviewState, PullRequestStateDriver, StateScenario, AtlasPublicationLease, AtlasPublicationStorage, createPublicationStorage(), AtlasRegistryConfig, artifactPrefix() (+27 more)
...
Cohesion: 0.12
Nodes (36): readPublishedCatalog(), assertDescriptorBytes(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl(), AtlasBrowserOverrideOptions (+28 more)
...
Cohesion: 0.21
Nodes (8): AtlasDeployResult, appManifest(), DeployServiceDriver, digest(), file(), hostManifest(), descriptorFor(), AtlasPublishedArtifactManifest
...
Cohesion: 0.11
Nodes (20): ATLAS_BROWSER_LOADER, createBrowserAssetFiles(), ES_MODULE_SHIM, createAtlasBootstrapFiles(), withTrailingNewline(), createBootstrapHtml(), escapeHtml(), validateBootstrapHtml() (+12 more)
...
Cohesion: 0.14
Nodes (22): anchorKey(), readAtlasNavigationItems(), subscribeAtlasNavigationItems(), anchorTag(), AtlasDefaultHostLayout(), AtlasHostAnchorsContext, AtlasHostProvider(), AtlasHostProviderProps (+14 more)
...
Cohesion: 0.07
Nodes (26): AtlasEventBus, AtlasEventListener, AtlasEventMap, createAtlasEventBus(), EventKey, notifyListener(), PayloadEventKey, PayloadlessEventKey (+18 more)

### Community 39 - "compilerOptions"
Cohesion: 0.06
Nodes (32): apps/**/*.driver.ts, apps/**/*.driver.tsx, apps/**/*.specs.ts, apps/**/*.specs.tsx, jest, node_modules, packages/**/*.driver.ts, packages/**/*.driver.tsx (+24 more)
...
Cohesion: 0.28
Nodes (4): AtlasPublicationStorageSource, PublicationStorageDriver, STORAGE_ENVIRONMENT_KEYS, S3Options
...
Cohesion: 0.20
Nodes (9): ModuleShimDriver, moduleShim, HostEntry, HostModule, HostMountRequest, ModuleShimGlobal, RemoteMetadata, RuntimeAppOverride (+1 more)

### Community 54 - "AtlasGenerateService"
Cohesion: 0.24
Nodes (12): createInstallCommand(), createNxGenerationCommand(), createNxPluginInstallCommand(), createTaskCommand(), detectWorkspace(), CommandScenario, WorkspaceScenario, installationRoot() (+4 more)

### Community 55 - "types.ts"
Cohesion: 0.29
Nodes (9): RetryDriver, isRetryableHttpStatus(), isTransientError(), RetryOptions, statusCode(), transientNetworkCode(), transientStatus(), wait() (+1 more)

### Community 56 - "target.ts"
Cohesion: 0.10
Nodes (33): asDependencyMap(), AtlasPackageManager, AtlasScaffoldOptions, AtlasTask, AtlasWorkspaceKind, configuredNxOutputPaths(), createFormatGeneratedCommand(), declaredNxOutputPaths() (+25 more)
...
Cohesion: 0.20
Nodes (14): addStalePreview(), artifactRecord(), descriptor(), DescriptorFixture, emptyArtifactRecord(), InspectAtlasHostDriver, installPage(), jsonResponse() (+6 more)
...
Cohesion: 0.17
Nodes (16): COMMAND_HELP, CommandHelp, HelpEntry, ROOT_COMMANDS, ROOT_EXAMPLES, appendEntries(), COMMAND_ALIASES, formatCommandHelp() (+8 more)
...
Nodes (49): {
  ...
  createAngularFederationConfig,
}, ANGULAR_FEDERATION_SKIP, ANGULAR_SHARED_DEPENDENCY_OPTIONS, angularWidgetConfigArgument(), angularWidgetConfigImport(), angularWidgetConfigPath() (+41 more)
...
Cohesion: 0.08
Nodes (62): cliActions(), cliSummary(), COMMAND_ALIASES, createCliError(), CliErrorDriver, ErrorScenario, errorCauseMessage(), errorCauses() (+54 more)
...
Cohesion: 0.12
Nodes (16): @angular/common, @angular/core, @angular/platform-browser, react, vite, @angular/common, @angular/core, @angular/platform-browser (+8 more)
...
Cohesion: 0.14
Nodes (11): ArtifactoryOptions, ArtifactoryPublicationStorage, assertReplaceCondition(), collectBody(), ArtifactoryStorageDriver, StorageClient, AtlasPublicationBody, AtlasPublicationObjectMetadata (+3 more)

### Community 80 - "atlas-host.driver.ts"
Cohesion: 0.19
Nodes (8): AppComponent, Component, bootstrap(), DemoRouteAnchorComponent, HostMountRequest, Component, HostWidgets, Component
...
Cohesion: 0.20
Nodes (15): BootstrapScenario, BootstrapServerDriver, createBootstrapFileMap(), createBootstrapRequestHandler(), createUpgradeRequest(), hasFileExtension(), isBootstrapMethod(), matchesNativeProxyRoute() (+7 more)

### Community 86 - "react.ts"
Cohesion: 0.10
Nodes (21): renderLoading(), HostFixture(), HostSdk, ReactHostDriver, AtlasHostDataContext, AtlasRuntimeContext, AtlasSdk, AtlasSdkContext (+13 more)

### Community 87 - "exports"
Cohesion: 0.09
Nodes (23): default, types, exports, ./angular, ./federation, ./federation-config, ./host, ./lifecycle (+15 more)
...
Cohesion: 0.15
Nodes (10): createDevSession(), createLocalDevCatalog(), DevSessionEntry, DevelopmentSessionDriver, SessionScenario, localHostPlaceholder(), uniqueArtifacts(), uniqueManifests() (+2 more)
...
Cohesion: 0.14
Nodes (4): collect(), jsonBytes(), MemoryStorage, AtlasPublicationListedObject
...
Cohesion: 0.29
Nodes (5): AngularComponentStyleHost, AngularComponentStyleHostMount, attachAngularComponentStyles(), AngularStyleHostDriver, RecordingStyleHost
...
Cohesion: 0.07
Nodes (33): AngularHostSdkReference, AngularBootstrapDriver, ASSET_BASE_URL, createAppConfig(), CustomerSdk, LOGO_URL, AtlasAngularAppOptions, ATLAS_APP_CONTEXT (+25 more)
...
Cohesion: 0.27
Nodes (10): cliVersion(), configuredHostUrls(), previewSelector(), printVerificationCheck(), runAtlasCli(), runWorkspaceFreeCommand(), splitUrls(), verifyHostUrls() (+2 more)

### Community 128 - "HttpClient"
Cohesion: 0.11
Nodes (17): ControlServerDriver, ControlServerDriver, ControlServerLease, ensureLeaseDirectory(), isActiveLease(), LEASE_DIRECTORY, leaseId(), leasePath() (+9 more)

### Community 129 - "angular.specs.ts"
Cohesion: 0.08
Nodes (8): createHostNavigation(), createLocationStrategy(), notifyPopState(), PopStateListener, readInnerUrl(), LocationLike, LocationStrategyAdapter, RouterLike
...
Cohesion: 0.12
Nodes (20): readWidgetRuntime(), AtlasNavigateOptions, sdkError(), SdkErrorOptions, assertPropertiesDoNotReplaceCore(), createAtlasCoreSdk(), createAtlasSdk(), createHostData() (+12 more)
...
Cohesion: 0.47
Nodes (3): ArtifactoryConnectionOptions, ArtifactoryClientDriver, TransportFailureDetails
...
Cohesion: 0.20
Nodes (3): cacheControl(), options, root
...
Cohesion: 0.16
Nodes (19): isPublicationStorage(), PullRequestDriver, providerFetch(), providerToken(), requiredString(), resolveBitbucketPullRequest(), resolveGitHubPullRequest(), resolveGitLabMergeRequest() (+11 more)

### Community 159 - "angular.ts"
Cohesion: 0.18
Nodes (21): ArtifactoryClient, ArtifactoryDependencies, ArtifactoryResponse, ArtifactUpload, discardResponse(), downloadResponse(), encodePath(), lastModified() (+13 more)
...
Cohesion: 0.16
Nodes (11): Input, AtlasAnchorComponent, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot, Component (+3 more)
...
Cohesion: 0.13
Nodes (17): AngularHostBootstrapOptions, AngularHostDataInput, AngularHostDataOption, AngularHostStartServices, AtlasDefaultHostRouteComponent, bootstrapAngularHost(), HostMountRequest, HostOptions (+9 more)
...
Cohesion: 0.33
Nodes (4): DevelopmentSessionDriver, restoreGlobal(), isMatchingResponse(), requestDevelopmentSession()
...
Cohesion: 0.10
Nodes (26): CliArguments, completedProcessOutput(), ui, writeDevOverrideDocument(), hostClientPortFallback(), resolveHostDevPorts(), ResolveHostDevPortsOptions, browserOpenCommand() (+18 more)
...
Cohesion: 0.38
Nodes (4): HostLayout(), HostMountRequest, mountHost(), HostWidgets()
...
Cohesion: 0.13
Nodes (20): mapWithConcurrency(), AngularLocalManifest, AngularLocalRuntimeDriver, prepareAngularLocalRuntime(), artifactDirectoryUrl(), createNativeFederationImporters(), createTrustedNativeFederationImporters(), FederationRemote (+12 more)

### Community 181 - "angular-bootstrap.driver.ts"
Cohesion: 0.17
Nodes (13): DevelopmentPortsDriver, PortScenario, AngularBuildPrivateApi, loadAngularHostProxy(), AppDevelopmentOptions, DevTarget, HostDevPorts, HostDevTarget (+5 more)

### Community 182 - "AtlasValidationIssue"
Cohesion: 0.19
Nodes (6): AppReadiness, AtlasRuntimeController, createRuntimeMount(), placementKey(), startAtlasHostRuntime(), unmountIfStale()
...
Cohesion: 0.10
Nodes (20): BrowserWindowLike, createBrowserNavigation(), appendQueryValue(), matchRoutePart(), matchRoutePattern(), normalizePath(), parseQuery(), scopePath() (+12 more)
...
Cohesion: 0.12
Nodes (31): assertDescriptor(), Descriptor, fetchManifestReference(), fetchWithTimeout(), HostDeployment, loadArtifactVersion(), loadCachedManifest(), loadedManifests (+23 more)
...
### Community 234 - "jest"
Cohesion: 0.25
Nodes (10): requireInitializedRemoteName(), runtimeError(), RuntimeErrorOptions, assertWidgetId(), createRegistryWidgetResolver(), catalog(), host(), provider() (+2 more)
...
Cohesion: 0.12
Nodes (24): artifactoryOptions(), artifactoryPublicUrl(), assertLease(), DeploymentLease, encodeLease(), environmentBoolean(), environmentS3LockMode(), errorName() (+16 more)

### Community 244 - "navigation-paths.ts"
Cohesion: 0.12
Nodes (27): addUniqueString(), defaultIgnoreFileDependencies, GeneratedFilesDriver, IgnoreScenario, ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS, existingPackageName(), hasAtlasIgnorePattern() (+19 more)
...
Cohesion: 0.14
Nodes (11): AtlasVerificationReport, AtlasVerifyOptions, canonicalArtifact(), hostRemoteBytes, remoteBytes, sha256Digest(), VerificationScenario, VerifyServiceDriver (+3 more)
...
Cohesion: 0.21
Nodes (20): AtlasLoaderDependencies, defaultDependencies(), deploymentReferences(), loadDeployment(), loadInitialCatalog(), mapWithConcurrency(), publishRuntimeSnapshot(), startAtlasLoader() (+12 more)
...
Cohesion: 0.16
Nodes (18): AtlasHostMountState, AtlasAppEvent, AtlasEventBase, AtlasHostEvent, AtlasOperationEvent, AtlasRuntimeEvent, eventTimestamp(), actionForStage() (+10 more)

### Community 285 - "atlas-host.driver.ts"
Cohesion: 0.11
Nodes (11): AtlasBootstrapServiceOptions, SupportedFramework, frameworkLabel(), displayTarget(), AtlasGenerateService, availableAppsMessage(), isRecord(), turboTasks() (+3 more)
...
Cohesion: 0.12
Nodes (14): ActiveWidget, AngularGetWidgetOptions, AngularWidgetBinding, AngularWidgetOutletController, AngularWidgetRuntime, createAngularAtlasSdk(), createAngularLoadingRenderer(), createWidgetBinding() (+6 more)
...
Cohesion: 0.17
Nodes (11): DomRuntimeOptions, MountStateRenderingOptions, prepareStatusElement(), renderErrorState(), renderHostMountState(), renderLoadingState(), AtlasHostMountEvent, HostRuntimeDriver (+3 more)
...
Cohesion: 0.08
Nodes (46): DeploymentWrite, AtlasResolvedWidget, AtlasArtifactManifestBase, AtlasAppConfig, AtlasBaseConfig, AtlasRouteMount, AtlasSlotMount, AtlasWidgetConfig (+38 more)
...
Cohesion: 0.15
Nodes (10): AtlasAngularHostAnchors, Injectable, AtlasHostAnchorRegistry, AtlasHostUi, AtlasHostUiOptions, createHostUi(), renderDefaultError(), renderDefaultLoading() (+2 more)

### Community 318 - "dom-host-events.ts"
Cohesion: 0.25
Nodes (12): BrowserErrorContext, createBrowserError(), logBrowserError(), emitHostError(), emitHostReady(), emitHostStart(), emitMountState(), reportRetryFailure() (+4 more)

### Community 320 - "AtlasNavigation"
Cohesion: 0.18
...
### Community 323 - "AtlasHostRuntimeOptions"
Cohesion: 0.15
Nodes (8): AtlasHostRuntimeOptions, AtlasLoaderOptions, AtlasWidgetLoaderOptions, AtlasWidgetUiOptions, MountResolvedWidgetInput, AtlasAppEntry, AtlasExportedWidgetEntry, AtlasWidgetLoader

### Community 328 - "ui.ts"
Cohesion: 0.20
Nodes (13): ATLAS_LOGO, formatLogo(), indentContinuationLines(), RgbColor, Status, STATUS_COLORS, STATUS_SYMBOLS, style() (+5 more)

### Community 329 - "dependencies.ts"
Cohesion: 0.27
...
### Community 333 - "host-navigation.ts"
Cohesion: 0.23
Nodes (10): AtlasNavigationItemsService, Injectable, AtlasHostNavigationItem, createHostNavigationItems(), documentNavigationItems, normalizeRoutePath(), routeMatches(), RoutePlacement (+2 more)

### Community 334 - "Contributing to Atlas"
Cohesion: 0.15
Nodes (12): Before a Pull Request, Contributing to Atlas, Documentation, File Extensions, Releases, Repository Layout, Setup, 1. Install Atlas (+4 more)
...
### Community 337 - "TerminalPrompter"
Cohesion: 0.24
Nodes (3): UiDriver, UiScenario, TerminalPrompter

### Community 338 - "badge-refresh.ts"
Cohesion: 0.24
...
Cohesion: 0.11
Nodes (23): AtlasRemoteTrustPolicy, absolutizeUrls(), importPrelude(), prepareShadowImports(), readImport(), wrapImport(), wrapPrelude(), adaptRules() (+15 more)
...
### Community 347 - "inspectAtlasHost"
Cohesion: 0.32
...
### Community 348 - "route-matcher.ts"
Cohesion: 0.83
Nodes (3): normalizePath(), routeMatches(), segments()

### Community 349 - "repository"
Cohesion: 0.50
Nodes (4): repository, directory, type, url

## Knowledge Gaps
- **1670 isolated node(s):** `TestProductionSelection`, `TestAssetElement`, `TestStyleLink`, `TestStylesheetDocument`, `RuntimeMount` (+1665 more)
...
- `AtlasDevService` (2× useful, score=0.642991136)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `CliArguments` connect `ts-jest` to `workspace.ts`, `React SDK`, `FailingMutableStorage`, `verify-generated-projects.js`, `PromptTestDouble`, `S3PublicationStorage`, `cli.service.ts`, `navigation-paths.ts`, `delay`, `AtlasGenerateService`, `create-manifest-from-config-input.ts`, `runtime-discovery.ts`, `AngularWidgetOutletController`, `manifest-utils.ts`, `angular-bootstrap.driver.ts`, `atlas-host.driver.ts`, `errorSummary`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `versionPackages()` connect `prepare-release.js` to `content-script.ts`, `angular.ts`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `reference()` connect `atlas-manifest.ts` to `route-matcher.ts`, `Atlas Overview`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **What connects `TestProductionSelection`, `TestAssetElement`, `TestStyleLink` to the rest of the system?**
