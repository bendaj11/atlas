# Graph Report - atlas  (2026-08-09)

## Corpus Check
- 540 files · ~184,124 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4733 nodes · 8020 edges · 328 communities (259 shown, 69 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 86 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `e37a05ab`
...
6. `runAtlasCli()` - 24 edges
7. `runtimeError()` - 24 edges
8. `AtlasGenerateService` - 23 edges
9. `AtlasExtensionManifest` - 23 edges
...
- `HostDevSession` --references--> `AtlasHostManifest`  [EXTRACTED]
  packages/cli/src/development/session/session.ts → packages/schema/src/atlas-host-manifest.ts
...
## Communities (328 total, 69 thin omitted)
...
Cohesion: 0.10
Nodes (18): DevelopmentPortsDriver, PortScenario, AngularBuildPrivateApi, loadAngularHostProxy(), createDevSession(), createLocalDevCatalog(), DevSessionEntry, DevelopmentSessionDriver (+10 more)
...
Cohesion: 0.09
Nodes (25): ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk, createAtlasHostDataSignal(), AngularInjectionDriver, CustomerHostSdk, injectAppLoaded(), injectAtlasAppContext() (+17 more)
...
Cohesion: 0.18
Nodes (12): DomHostOptions, createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, AtlasNativeFederationImporters, AtlasRemoteTrustPolicy (+4 more)
...
Cohesion: 0.08
Nodes (28): DevelopmentScenario, DevServiceDriver, angularComponentCount(), appDocument(), assertSingleComponentDeclaration(), availablePort(), catalogManifestIds(), cliEntrypointPath() (+20 more)

### Community 20 - "AtlasNavigation"
Cohesion: 0.19
Nodes (6): AtlasHostRuntimeOptions, AtlasRuntimeController, createRuntimeMount(), placementKey(), startAtlasHostRuntime(), mount()
...
Cohesion: 0.11
Nodes (35): assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl(), AtlasRuntimeOverride, bytesToBase64(), catalogSelectionError() (+27 more)
...
Cohesion: 0.15
Nodes (13): RegistryScenario, AtlasResolvedWidget, RegistrySnapshot, WidgetRegistryOptions, AtlasAppIndex, AtlasArtifactIndex, AtlasHostCatalog, AtlasHostIndex (+5 more)
...
Cohesion: 0.10
Nodes (14): ControlServerDriver, createControlRequestHandler(), ControlServerDriver, joinControlServer(), pathSegment(), registerOverride(), respondWithSession(), setControlHeaders() (+6 more)

### Community 36 - "loader.specs.ts"
Cohesion: 0.05
Nodes (32): createDeferred(), createHostCatalog(), createRouteManifest(), createRoutePlacement(), createSlotManifest(), createTestContainer(), createTestDocument(), createTestElement() (+24 more)
...
Cohesion: 0.11
Nodes (22): cliActions(), cliSummary(), COMMAND_ALIASES, createCliError(), CliErrorDriver, ErrorScenario, rerunAction(), actionableMessage() (+14 more)
...
### Community 41 - ".run"
Cohesion: 0.14
Nodes (24): completedProcessOutput(), closeServer(), localOrigin(), writeDevOverrideDocument(), hostClientPortFallback(), resolveHostDevPorts(), browserOpenCommand(), DevelopmentProcessDriver (+16 more)
...
Cohesion: 0.11
Nodes (9): CliArguments, SupportedFramework, AtlasInvocation, InteractionDriver, InteractionScenario, resolveInvocation(), PromptTestDouble, title() (+1 more)
...
Cohesion: 0.17
Nodes (18): mapWithConcurrency(), artifactDirectoryUrl(), createNativeFederationImporters(), createTrustedNativeFederationImporters(), federationRemoteName(), fetchRemoteBytes(), hasMountFunction(), importNativeFederationRemote() (+10 more)
...
Cohesion: 0.15
Nodes (16): AtlasEventBus, createAtlasEventBus(), normalizeHttpClient(), sdkError(), assertPropertiesDoNotReplaceCore(), createAtlasCoreSdk(), createAtlasSdk(), createHostData() (+8 more)
...
Cohesion: 0.08
Nodes (43): assertAtlasHostCatalog(), AtlasValidationError, formatAtlasValidationMessage(), AtlasValidationIssue, validateHostCatalog(), validateUniqueManifestIds(), FRAMEWORKS, isRoutePattern() (+35 more)
...
Cohesion: 0.07
Nodes (29): addNavigationState(), AtlasNavigationTarget, createAppNavigator(), AppNavigatorDriver, AtlasAppContext, appendQueryValue(), matchRoutePart(), matchRoutePattern() (+21 more)
...
Cohesion: 0.11
Nodes (16): ActiveWidget, AngularGetWidgetOptions, AngularWidgetBinding, AngularWidgetOutletController, AngularWidgetRuntime, createAngularLoadingRenderer(), createWidgetBinding(), CreateWidgetBindingInput (+8 more)
...
### Community 91 - "ui.ts"
Cohesion: 0.07
Nodes (18): AtlasDeploymentCatalog, AppBootstrap, createExportedWidget(), defineExportedWidget(), AtlasAppEntry, AtlasAppMountRequest, AtlasAppMountResult, AtlasExportedWidgetMountRequest (+10 more)

### Community 92 - "loader.driver.ts"
Cohesion: 0.24
Nodes (16): assertRegistry(), assertWidgetId(), compareNewestFirst(), createRegistryWidgetResolver(), fetchRegistry(), indexWidgets(), isRecord(), LazyRegistry (+8 more)
...
Cohesion: 0.18
Nodes (18): AtlasPublicationStorageSource, isPublicationStorage(), AtlasPublishConfig, AtlasPullRequestLookup, AtlasPullRequestResolver, AtlasPullRequestStatus, defineAtlasPublishConfig(), isNodeError() (+10 more)
...
Cohesion: 0.16
Nodes (17): AtlasBrowserOverrideOptions, loadHostCatalog(), AtlasRuntimeObserver, eventTimestamp(), actionForStage(), AtlasLoadError, AtlasOperationContext, AtlasRetryPolicy (+9 more)
...
Cohesion: 0.16
Nodes (11): Directive, Input, AtlasAnchorComponent, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot (+3 more)
...
Cohesion: 0.10
Nodes (35): AtlasPublicationLease, createPublicationStorage(), environmentBoolean(), storageFromEnvironment(), artifactIndexPath(), artifactPrefix(), assertExpectedRegistryRevision(), AtlasPrPruneResult (+27 more)
...
Cohesion: 0.14
Nodes (19): BootstrapScenario, BootstrapServerDriver, createBootstrapFileMap(), createBootstrapRequestHandler(), createUpgradeRequest(), hasFileExtension(), isBootstrapMethod(), matchesNativeProxyRoute() (+11 more)
...
Cohesion: 0.13
Nodes (18): AtlasAngularHostAnchors, Injectable, AngularHostBootstrapOptions, AngularHostDataInput, AngularHostDataOption, AtlasDefaultHostRouteComponent, AtlasNavigationItemsService, bootstrapAngularHost() (+10 more)
...
Cohesion: 0.22
Nodes (7): assertCatalogMatchesConfig(), DomHostRuntimeInput, resolveDomSlotContainer(), resolveHostConfig(), startDomHostRuntime(), anchorKey(), AtlasHostAnchorRegistry
...
Cohesion: 0.33
Nodes (6): Angular Assets And Styles, App Domain, Deployment Domain, Host Domain, Isolation, Monorepos
...
Cohesion: 0.10
Nodes (17): App Domain, Atlas Overview, Deployment Domain, Host Domain, Learn Next, Mental Model, Vocabulary, Package checks (+9 more)
...
### Community 270 - "React Assets And Styles"
Cohesion: 0.33
Nodes (6): App Domain, Deployment Domain, Host Domain, Isolation, Monorepos, React Assets And Styles
...
### Community 287 - "React Project Guide"
Cohesion: 0.40
...
Cohesion: 0.10
Nodes (26): cliVersion(), configuredArtifactIds(), configuredRuntimeUrls(), positiveInteger(), printVerificationCheck(), publishAndVerify(), rollbackAndVerify(), runAtlasCli() (+18 more)
...
## Knowledge Gaps
- **1627 isolated node(s):** `name`, `version`, `private`, `type`, `build` (+1622 more)
...
- `AtlasDevService` (2× useful, score=1.345120101)
...
- **Why does `mount()` connect `AtlasNavigation` to `loader.specs.ts`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `S3PublicationStorage` connect `resilience.ts` to `ArtifactConfigurationPage.tsx`, `AngularWidgetOutletController`?**
