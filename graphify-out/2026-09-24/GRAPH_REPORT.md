...
## Corpus Check
- 1359 files · ~349,121 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7094 nodes · 16498 edges · 389 communities (313 shown, 76 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 155 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `19cbaf97`
...
Cohesion: 0.08
Nodes (51): AngularLocalManifest, prepareAngularLocalRuntime(), resolveRuntimeManifests(), createFederationRemoteFromWidget(), createFederationRemoteName(), createNativeFederationImporters(), getArtifactDirectoryUrl(), importNativeFederationRemote() (+43 more)

### Community 2 - "AtlasManifest"
Cohesion: 0.05
Nodes (48): extractErrorMessage(), optionalRecord(), parseAbsoluteHttpUrl(), VerifiedManifest, verifyAsset(), verifyExposes(), verifyFederationReferences(), verifyManifestAssets() (+40 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.07
Nodes (37): SdkProviders, startAtlasHostRuntime(), AnchorsListener, AppReadiness, AtlasHostRuntimeOptions, IsMountCurrent, LoadingStateEmitter, PlacementMountRecord (+29 more)

### Community 4 - "workspace.ts"
Cohesion: 0.09
Nodes (22): AtlasAnchorComponent, AtlasAngularHostAnchors, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot, AnchorsRoot (+14 more)
...
Cohesion: 0.12
Nodes (22): groupObjectsByGeneration(), isExpiredGeneration(), pruneUnreferencedPreviewGenerations(), prunePreviewsOnce(), removeClosedPreviews(), removePreviewOnce(), requireRegistry(), PublicationLeaseDriver (+14 more)

### Community 7 - "index.ts"
Cohesion: 0.11
Nodes (29): AtlasArtifactPreviewState, assertPreviewIsCurrent(), PublicationFiles, createPublicationStorage(), createProviderFetch(), PROVIDER_ENVIRONMENT_VARIABLES, PullRequestDriver, readProviderToken() (+21 more)
...
Cohesion: 0.07
Nodes (37): createAtlasHostDataSignal(), injectAtlasSdk(), createAngularAtlasSdk(), CreateAngularAtlasSdkInput, AngularAtlasSdkDriver, WidgetInputs, AngularLoadingRendererRequest, createAngularLoadingRenderer() (+29 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.07
Nodes (46): DeployServiceDriver, PreviewPruningDriver, isRegistryReferencing(), aRegistryWith(), RegistryIoDriver, createManifestDescriptor(), encodeManifestBytes(), isSameDescriptor() (+38 more)
...
Cohesion: 0.08
Nodes (25): WidgetLoaderDriver, WidgetProps, AtlasWidgetAmbiguousError, AtlasResolvedWidget, AtlasWidgetErrorRenderContext, AtlasWidgetRenderContext, AtlasWidgetResolver, DisposeRenderer (+17 more)

### Community 20 - "AtlasNavigation"
Cohesion: 0.08
Nodes (75): collectAtlasHostCatalogIssues(), validateAppManifestList(), collectAtlasHostManifestIssues(), validateAtlasHostManifest(), collectAtlasManifestIssues(), PlacementUniqueness, validateAtlasManifest(), validateExportedWidget() (+67 more)

### Community 21 - "dev.service.ts"
Cohesion: 0.06
Nodes (56): doesPathExist(), captureProcessOutput(), CliProcessDriver, forwardAndCaptureOutput(), ProcessCommand, processOutput, processOutputClosed, ProcessOutputDestinations (+48 more)

### Community 22 - "manifest-utils.ts"
Cohesion: 0.08
Nodes (51): DeploymentWrite, AngularLocalRuntimeDriver, AtlasAppConfig, AtlasBaseConfig, AtlasRouteMount, AtlasSlotMount, AtlasWidgetConfig, REQUIRED_STRING_FIELDS (+43 more)
...
Cohesion: 0.14
Nodes (21): appendUrlPath(), doesRouteMatchPath(), doesSupportAnyHost(), DevelopmentConfigDriver, listConfiguredHostIds(), listRoutePaths(), parsePort(), pickFirstRecordValue() (+13 more)

### Community 25 - "native-federation.ts"
Cohesion: 0.12
Nodes (21): DomSdkOptions, AtlasHostAnchorsContext, AtlasHostProvider(), createHostProviderState(), defineReactHost(), pickCustomHostData(), renderReactHost(), startHost() (+13 more)
...
Cohesion: 0.09
Nodes (43): AtlasHostMountState, assertBytesMatchDescriptor(), assertDeploymentMatchesExpectation(), loadHostDeployment(), loadPublishedManifest(), parseArtifactManifestFromBytes(), parseHostDeploymentFromBytes(), parseJsonFromBytes() (+35 more)
...
### Community 34 - "app.ts"
Cohesion: 0.11
Nodes (23): AngularHostSdkReference, appendAtlasSdkProvider(), ATLAS_HOST_ROUTES, AtlasDefaultHostRouteComponent, bootstrapAngularHost(), defineAngularHost(), startHost(), syncAngularHostDataSignalsToRuntime() (+15 more)
...
Cohesion: 0.13
Nodes (25): AtlasHostRuntimeConfig, isAbsoluteUrl(), resolveRegistryRootUrl(), validateRegistryRootUrl(), ResolveHostRuntimeConfigDriver, isHostRuntimeConfig(), resolveAtlasHostRuntimeConfig(), buildArtifactUrl() (+17 more)
...
Cohesion: 0.08
Nodes (20): DomHostDriver, CreateHostNavigation, EntryBehavior, HostRuntimeDriver, AtlasHostMountEvent, AtlasHostRuntime, PublishActiveLayout, NativeFederationDriver (+12 more)

### Community 41 - ".run"
Cohesion: 0.08
Nodes (41): App(), ArtifactOverrideEditorPage(), initialOverrideSelection(), ArtifactOverrideLocationState, isArtifactOverrideLocationState(), useArtifactOverrideOptions(), artifactVersionFromSelection(), useHostArtifactVersionQuery() (+33 more)

### Community 42 - "FailingMutableStorage"
Cohesion: 0.19
Nodes (15): DomRenderingDriver, collectVisibleRoutePlacementsForHost(), createHostNavigationItems(), HostNavigationDriver, isNavigationItemsEvent(), navigationItemsByDocument, publishAtlasNavigationItems(), readAtlasNavigationItems() (+7 more)
...
Cohesion: 0.18
Nodes (13): AngularAppComponentOptions, AngularAppConfigOptions, AngularAppEntryOptions, AngularAppGeneratorDriver, renderAngularAppComponent(), renderAngularAppConfig(), renderAngularAppDetailsComponent(), renderAngularAppEntry() (+5 more)
...
Cohesion: 0.14
Nodes (21): usesNativeFederationV4ConfigApi(), convertNameToFederationRemoteName(), AngularPackageManifestOptions, AngularFederationConfigOptions, AngularWorkspaceDocumentOptions, buildAngularAppTsconfig(), buildAngularRootTsconfig(), buildAngularWorkspaceDocument() (+13 more)

### Community 47 - "publication-storage.ts"
Cohesion: 0.08
Nodes (40): WINDOW_EVENTS, aHostData(), findAtlasHostTabMock, CachedHost, CachedHostData, clearHostDataCache(), HostDataSnapshot, isHostDataSnapshot() (+32 more)
...
Cohesion: 0.19
Nodes (16): buildLeaseFileId(), buildLeaseFilePath(), ControlServerLease, ControlServerLeaseDriver, ensureLeaseDirectory(), isActiveLease(), isProcessRunning(), LEASE_DIRECTORY (+8 more)
...
Cohesion: 0.05
Nodes (66): fetchDevelopmentSession(), loadForTab(), previewIdentity(), AtlasBootstrapSignatureDriver, hasAtlasBootstrapSignature(), BadgeRefreshDependencies, countDevSessionOverrides(), CountDevSessionOverridesOptions (+58 more)

### Community 52 - "content-script.ts"
Cohesion: 0.28
Nodes (13): closeServer(), buildBrowserOpenCommand(), buildFrameworkServerArguments(), formatFrameworkServerError(), isRemoteEntryReady(), logHostViewUrl(), openBrowserWhenReady(), waitForRemoteEntry() (+5 more)
...
Cohesion: 0.11
Nodes (22): assertOverrideMatchesManifest(), DevelopmentSessionDriver, isSessionRequest(), isMatchingResponse(), requestDevelopmentSession(), assertOverrideDocumentTargetsHost(), OverridesDriver, isOverrideDocumentShape() (+14 more)
...
Cohesion: 0.06
Nodes (47): assertAtlasHostCatalog(), AssertAtlasHostCatalogDriver, ValidateAtlasHostCatalogDriver, validateAtlasHostCatalog(), AtlasValidationError, AtlasValidationErrorDriver, formatAtlasValidationMessage(), AtlasValidationIssue (+39 more)

### Community 77 - "devDependencies"
Cohesion: 0.09
Nodes (52): readPageStateFromHostTabMock, ArtifactVersion, Scope, AtlasRuntimeError, HostData, HostPageState, AtlasArtifactOverride, AtlasOverrideDocument (+44 more)
...
Cohesion: 0.06
Nodes (49): AngularAdapterDriver, EagerSdkHostRoot, HostRoot, HostSdk, startDomHost, StartDomHostForHostSdk, Component, buildDefaultManifestUrl() (+41 more)
...
Cohesion: 0.07
Nodes (41): ArtifactsListPage(), ArtifactsListPageDriver, ArtifactsListTable, NOT_LOADED_HOST_STATUSES, ArtifactOverrideActions(), ArtifactOverrideToggle(), ArtifactsListTable(), ArtifactsListTableToolbar() (+33 more)

### Community 85 - "publish-config.ts"
Cohesion: 0.16
Nodes (16): AtlasNavigateOptions, AtlasUnsubscribe, createHostNavigation(), ReactHostNavigationDriver, connectRouter(), createRouterOptions(), MemoryRouterOptions, pushRouterUrlToHost() (+8 more)
...
Cohesion: 0.07
Nodes (40): readCliVersion(), runAtlasCli(), VERSION_ARGUMENTS, collectConfiguredHostUrls(), printVerificationCheck(), splitUrlList(), verifyHostUrls(), deploy() (+32 more)
...
Cohesion: 0.15
Nodes (25): buildAngularPackageManifest(), convertAngularVersionToRange(), AngularPackageGeneratorDriver, renderAngularIndexHtml(), buildReactPackageManifest(), ReactPackageGeneratorDriver, ReactPackageManifestOptions, renderReactAppIndexHtml() (+17 more)
...
Cohesion: 0.06
Nodes (43): AtlasMountedApp, DeploymentDriver, aDeploymentWith(), aReferenceTo(), DeploymentManifestReference, FetchBytesDriver, FetchBytes, fetchBytesFromNetwork() (+35 more)
...
Cohesion: 0.07
Nodes (20): assertHostConfig(), AtlasBootstrapService, bootstrapDigest(), defaultDependencies, AtlasBootstrapServiceDriver, BuildSetup, AtlasBootstrapBuildResult, AtlasBootstrapDependencies (+12 more)

### Community 110 - "package.json"
Cohesion: 0.10
Nodes (19): bugs, description, engines, node, files, homepage, keywords, license (+11 more)
...
Cohesion: 0.06
Nodes (47): aPublishedArtifact(), aRegistry(), aRegistryArtifactOf(), PublishedArtifact, ArtifactRegistry, ArtifactVersions, createArtifactRegistry(), ArtifactRegistryDriver (+39 more)
...
Cohesion: 0.06
Nodes (27): Choose One Page Type, Do, Do Not, Documentation Guidelines, Keep One Source Of Truth, Notes, Tips, And Warnings, Page Shape, Review Checklist (+19 more)
...
Cohesion: 0.15
Nodes (16): assertMetadata(), assertPayload(), createImmutable(), derivePublicationIdentity(), PublicationFilesDriver, isUnknownOutcome(), preparePublicationFiles(), PublicationFile (+8 more)
...
Cohesion: 0.08
Nodes (40): ArtifactoryClient, ArtifactoryClientDriver, TransportFailureDetails, ArtifactoryHttpStatusError, ArtifactoryTransportError, ArtifactoryUnknownMutationOutcomeError, extractTransportFailureCode(), isSyntaxError() (+32 more)
...
Cohesion: 0.06
Nodes (46): createAtlasEventBus(), EventBusDriver, OrderEvents, OrderListener, AtlasEventBus, AtlasEventListener, AtlasEventMap, EventKey (+38 more)
...
Cohesion: 0.41
Nodes (8): AngularHostFilesOptions, generateAngularHostFiles(), AngularHostGeneratorDriver, renderAngularHostAppConfig(), renderAngularHostBootstrap(), renderAngularHostComponent(), renderAngularHostMain(), renderAngularHostSdkConfig()
...
Cohesion: 0.17
Nodes (6): HostSdk, NavigationItemsConsumer(), ReactAdapterDriver, SdkConsumer(), startDomHost, StartDomHostForHostSdk
...
Cohesion: 0.08
Nodes (20): createHostNavigation(), AngularHostNavigationDriver, createLocationStrategy(), notifyPopStateListeners(), AngularNavigateByUrlOptions, LocationBack, LocationHistoryGo, LocationLike (+12 more)
...
Cohesion: 0.04
Nodes (44): AtlasHostProviderMissingError, AtlasSdkNotReadyError, AtlasAppRouteNotFoundError, AtlasAppLoadError, AtlasHostRetryError, AtlasHostStartError, emitHostError(), emitHostReady() (+36 more)

### Community 183 - "Releasing Atlas packages"
Cohesion: 0.06
Nodes (36): ControlServerDriver, compileAtlasConfig, DevServiceDriver, createDevSession(), createLocalDevCatalog(), createLocalHostPlaceholder(), dedupeManifests(), mergeLocalCatalog() (+28 more)
...
Cohesion: 0.29
Nodes (7): @atlas/schema, @atlas/sdk, css-tree, dependencies, @atlas/schema, @atlas/sdk, css-tree
...
Cohesion: 0.29
Nodes (8): AngularFederationDriver, selectNativeFederationBuilder(), selectNativeFederationPackage(), LEGACY_CONFIG_API_MAJORS, MAIN_PACKAGE_MAJORS, V4_CONFIG_API_MAJORS, V4_PACKAGE_MAJORS, usesNativeFederationV4Package()

### Community 208 - "repository"
Cohesion: 0.07
Nodes (27): BackgroundDriver, clearHostDataCache, fetch, loadDevelopmentSession, addWindowListener, artifactRegistry, BadgeScriptDriver, fetch (+19 more)
...
Cohesion: 0.10
Nodes (21): @angular/compiler, @angular/compiler-cli, @atlas/testkit, esbuild, @faker-js/faker, devDependencies, @angular/compiler, @angular/compiler-cli (+13 more)
...
Cohesion: 0.07
Nodes (29): AtlasDeploymentCatalog, DefineAngularAppDriver, AtlasAppContext, AtlasAppLoading, AtlasAppMountRequest, AtlasAppMountResult, AtlasHostClientEntry, AtlasHostMountRequest (+21 more)
...
Cohesion: 0.42
Nodes (7): generateReactHostFiles(), ReactHostFilesOptions, ReactHostGeneratorDriver, renderReactHostBootstrap(), renderReactHostLayout(), renderReactHostMain(), renderReactHostSdkConfig()

### Community 224 - "Angular Project Guide"
Cohesion: 0.09
Nodes (40): defaultIgnoreFileDependencies, GeneratedFilesDriver, ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS, hasAtlasIgnorePattern(), IgnoreFileDependencies, isContainedBy(), isMissingFileError() (+32 more)
...
Cohesion: 0.40
Nodes (9): AtlasDefaultHostLayout(), AtlasHostLayout(), AtlasHostStatus(), AtlasNavigation(), AtlasRouteOutlet(), AtlasSlot(), getAnchorTagName(), useAtlasHostAnchors() (+1 more)
...
Cohesion: 0.61
Nodes (6): joinControlServer(), buildLocalOrigin(), deleteJson(), fetchFromControlServer(), isAddressInUse(), postJson()
...
### Community 237 - "delay"
Cohesion: 0.05
Nodes (55): CounterWidget, CreateExportedWidgetDriver, Component, Input, WidgetProps, BootstrapApp, BootstrapWidget, WidgetProps (+47 more)
...
Cohesion: 0.29
Nodes (6): ANGULAR_HOST_PATHS, ANGULAR_ROUTED_APP_PATHS, ANGULAR_SINGLE_PAGE_APP_PATHS, REACT_HOST_PATHS, REACT_ROUTED_APP_PATHS, REACT_SINGLE_PAGE_APP_PATHS
...
Cohesion: 0.25
Nodes (15): ControlRequest, ControlRequestHandler, createControlRequestHandler(), extractPathSegmentBetween(), loadPublishedCatalog(), parseControlRequest(), registerOverride(), respondWithDevelopmentSession() (+7 more)
...
Cohesion: 0.16
Nodes (16): generateAngularAppFiles(), GeneratorsDriver, generateAppFiles(), generateHostFiles(), generateWidgetFiles(), generateReactAppFiles(), InvalidFrameworkVersionError, InvalidGeneratorIdError (+8 more)
...
Cohesion: 0.11
Nodes (13): UseArtifactsDriver, ColumbusStateDriver, loadColumbusState, ColumbusStateQueryDriver, loadColumbusState, HostDriver, loadColumbusState, ColumbusStateValue (+5 more)
...
### Community 304 - "Atlas"
Cohesion: 0.18
Nodes (14): ANGULAR_DEPENDENCIES, ANGULAR_DEV_DEPENDENCIES, SupportedGeneratorOptions, INVALID_IDS, aGeneratorOptions(), ALL_GENERATOR_FRAMEWORKS, ALL_STYLESHEET_FORMATS, anAngularGeneratorOptions() (+6 more)
...
Cohesion: 0.12
Nodes (16): @angular/common, @angular/core, @angular/platform-browser, @angular/router, @angular/common, @angular/core, @angular/platform-browser, @angular/router (+8 more)
...
Cohesion: 0.07
Nodes (40): HostFixture(), HostSdk, ReactHostDriver, HostDataDriver, ProjectHostData, ProjectHostSdk, getHostDataListeners(), HOST_DATA_LISTENERS (+32 more)
...
Cohesion: 0.22
Nodes (8): AtlasStyleTargetMissingError, ALL_ISOLATIONS, ALL_KINDS, MountBoundaryDriver, requireStyleTarget(), MountBoundary, MountBoundaryInput, MountBoundaryKind
...
### Community 326 - "app-navigator.ts"
Cohesion: 0.17
...
Cohesion: 0.29
Nodes (4): AppComponent, Component, HostWidgets, Component
...
Cohesion: 0.06
Nodes (56): ArtifactOverrideEditorPageDriver, useArtifactOverrideOptions, HOST_CHANNELS, NOT_ERROR_OVERRIDE_STATUSES, BrowserOverrideScopePicker(), BrowserOverrideScopePickerDriver, ScopePickerProps, ScopePickerProps (+48 more)
...
Cohesion: 0.07
Nodes (31): PortsDriver, anAppConfigSource(), GenerateServiceDriver, WidgetAppsDriver, extractLiteralConfigFieldValue(), formatAvailableAppsMessage(), listConfiguredWidgetApps(), readWidgetApp() (+23 more)
...
## Knowledge Gaps
- **1945 isolated node(s):** `Host Domain`, `App Domain`, `Widgets`, `Workspaces`, `Framework Versions` (+1940 more)
...
- `AtlasDevService` (2× useful, score=0.433524654)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `installFakeChrome()` connect `repository` to `atlas-host.driver.ts`, `devDependencies`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `fetchBytes()` connect `atlas-host.ts` to `atlas-host.driver.ts`, `nx.ts`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **What connects `Host Domain`, `App Domain`, `Widgets` to the rest of the system?**
