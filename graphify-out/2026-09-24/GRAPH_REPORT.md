...
## Corpus Check
- 1358 files · ~347,771 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7053 nodes · 16745 edges · 388 communities (315 shown, 73 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 159 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `5dc933d4`
...
## Communities (388 total, 73 thin omitted)
...
Cohesion: 0.06
Nodes (48): AngularLocalManifest, prepareAngularLocalRuntime(), AtlasRemoteTrustError, createFederationRemoteFromWidget(), createFederationRemoteName(), createNativeFederationImporters(), createTrustedNativeFederationImporters(), NativeFederationDriver (+40 more)

### Community 2 - "AtlasManifest"
Cohesion: 0.21
Nodes (15): VerifiedManifest, verifyAsset(), verifyExposes(), verifyFederationReferences(), verifyManifestAssets(), parseFederationMetadata(), checkContentType(), checkCors() (+7 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.09
Nodes (27): AtlasDuplicateRouteError, AtlasRouteReconciliationError, startAtlasHostRuntime(), AppReadiness, IsMountCurrent, LoadingStateEmitter, PlacementMountRecord, RouteReconcileRequest (+19 more)

### Community 4 - "workspace.ts"
Cohesion: 0.06
Nodes (44): AtlasAnchorComponent, AtlasAngularHostAnchors, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot, AnchorsRoot (+36 more)
...
Cohesion: 0.20
Nodes (19): AngularGenerationDriver, BUILD_NOTIFICATIONS, addUniquePolyfill(), AngularRunnerKey, configureAngularBuildNotifications(), configureAngularDevelopmentTargets(), enableAngularBuildNotifications(), ensureAngularFederationPolyfills() (+11 more)

### Community 7 - "index.ts"
Cohesion: 0.08
Nodes (45): assertPreviewIsCurrent(), prunePreviewsOnce(), removeClosedPreviews(), removePreviewOnce(), requireRegistry(), PublicationFiles, PublicationProgressReporter, verifyDeliveryWhileHeld() (+37 more)
...
Cohesion: 0.10
Nodes (23): createAngularAtlasSdk(), CreateAngularAtlasSdkInput, AngularAtlasSdkDriver, WidgetInputs, AngularLoadingRendererRequest, createAngularLoadingRenderer(), AngularLoadingRendererDriver, Component (+15 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.07
Nodes (45): SelectedAppRelease, DeployServiceDriver, isRegistryReferencing(), aRegistryWith(), RegistryState, createManifestDescriptor(), encodeManifestBytes(), isSameDescriptor() (+37 more)
...
Cohesion: 0.09
Nodes (37): applyOverrides(), applyOverridesDocument, ApplyOverridesDriver, discoverDevelopmentSession, isDevelopmentSessionSeeded, mergeDevelopmentSession, readStoredOverridesDocument, storeDevelopmentSession (+29 more)
...
Cohesion: 0.09
Nodes (25): createWidgetRenderContext(), WidgetLoaderDriver, WidgetProps, AtlasResolvedWidget, AtlasWidgetErrorRenderContext, AtlasWidgetRenderContext, AtlasWidgetResolver, DisposeRenderer (+17 more)

### Community 20 - "AtlasNavigation"
Cohesion: 0.08
Nodes (79): collectAtlasHostCatalogIssues(), validateAppManifestList(), validateAtlasHostCatalog(), collectAtlasHostManifestIssues(), validateAtlasHostManifest(), collectAtlasManifestIssues(), PlacementUniqueness, validateAtlasManifest() (+71 more)

### Community 21 - "dev.service.ts"
Cohesion: 0.11
Nodes (23): AngularHostSdkReference, appendAtlasSdkProvider(), AtlasDefaultHostRouteComponent, AtlasNavigationItemsService, bootstrapAngularHost(), startHost(), syncAngularHostDataSignalsToRuntime(), syncAngularRouterWithBrowserUrl() (+15 more)

### Community 22 - "manifest-utils.ts"
Cohesion: 0.08
Nodes (51): AngularLocalRuntimeDriver, AtlasAppConfig, AtlasBaseConfig, AtlasRouteMount, AtlasSlotMount, AtlasWidgetConfig, AtlasHostManifest, AtlasArtifactManifestBase (+43 more)
...
### Community 34 - "app.ts"
Cohesion: 0.10
Nodes (30): assertAtlasHostCatalog(), assertAtlasHostManifest(), assertAtlasManifest(), assertReleaseVersion(), assertSafeArtifactId(), assertSafeRelativePath(), SafePathsDriver, assertEnvironmentDeployment() (+22 more)
...
Cohesion: 0.13
Nodes (28): importNativeFederationRemote(), PERMISSIVE_TRUST_POLICY, createRouteTitleController(), importAppEntryFromRemote(), mountApp(), AtlasMountAppOptions, RouteTitleController, createMountBoundary() (+20 more)
...
Cohesion: 0.07
Nodes (55): DomRuntimeOptions, AtlasHostMountState, AtlasHostRuntimeOptions, LoadHostDeploymentOptions, LoadPublishedManifestOptions, FetchBytes, AtlasFederationAdapter, NativeFederationImportersOptions (+47 more)

### Community 41 - ".run"
Cohesion: 0.11
Nodes (30): OverrideVersionDropdownDriver, OverrideVersionDropdownProps, isDeployedProductionVersion(), OverrideVersionDropdown(), OverrideVersionDropdownProps, ArtifactOverrideVersion(), OVERRIDE_TYPE_LABELS, Artifacts (+22 more)

### Community 42 - "FailingMutableStorage"
Cohesion: 0.08
Nodes (36): ensureAngularWorkspaceFederationConfig(), defaultIgnoreFileDependencies, GeneratedFilesDriver, ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS, hasAtlasIgnorePattern(), IgnoreFileDependencies, isContainedBy() (+28 more)
...
Cohesion: 0.18
Nodes (24): selectNativeFederationBuilder(), selectNativeFederationPackage(), usesNativeFederationV4ConfigApi(), usesNativeFederationV4Package(), AngularPackageManifestOptions, buildAngularPackageManifest(), convertAngularVersionToRange(), AngularFederationConfigOptions (+16 more)

### Community 47 - "publication-storage.ts"
Cohesion: 0.10
Nodes (36): Scope, AtlasArtifactOverride, AtlasOverrideDocument, reloadHostTab(), LocalOverrideDriver, FederationMetadata, isFederationMetadata(), remoteEntryFailure() (+28 more)
...
Cohesion: 0.09
Nodes (39): addUniqueString(), alignDelegatedAngularFederationConfig(), escapeRegExp(), alignDelegatedTsconfig(), findTsconfigPath(), includeAtlasConfig(), NxDriver, ProjectType (+31 more)
...
Cohesion: 0.10
Nodes (27): AtlasDevSessionDocument, collectVisibleRoutePlacementsForHost(), assertManifestSupportsHost(), assertOverrideMatchesManifest(), CatalogResolutionDriver, indexManifestsById(), resolveRuntimeCatalog(), resolveRuntimeManifests() (+19 more)
...
Cohesion: 0.06
Nodes (23): ArtifactoryOptions, ArtifactoryPublicationStorage, ArtifactoryStorageClient, assertReplaceCondition(), collectBody(), ArtifactoryStorageDriver, DEFAULT_FACTORIES, PublicationStorageDriver (+15 more)
...
Cohesion: 0.07
Nodes (22): AssertAtlasHostCatalogDriver, ValidateAtlasHostCatalogDriver, AtlasValidationError, AtlasValidationErrorDriver, formatAtlasValidationMessage(), AtlasValidationIssue, AssertAtlasHostManifestDriver, ValidateAtlasHostManifestDriver (+14 more)

### Community 77 - "devDependencies"
Cohesion: 0.06
Nodes (57): findAtlasHostTabMock, readPageStateFromHostTabMock, reloadHostTabMock, HostData, HostPageState, normalizeStoredArtifactVersion(), CachedHost, CachedHostData (+49 more)
...
Cohesion: 0.05
Nodes (67): AngularAdapterDriver, EagerSdkHostRoot, HostRoot, HostSdk, startDomHost, StartDomHostForHostSdk, Component, DomHostDriver (+59 more)
...
Cohesion: 0.06
Nodes (55): ArtifactOverrideEditorPageDriver, useArtifactOverrideOptions, HOST_CHANNELS, NOT_ERROR_OVERRIDE_STATUSES, UseHostArtifactVersionQueryDriver, HostArtifactVersionQueryOptions, HOST_SELECTION_TYPES, UseSaveArtifactOverrideMutationDriver (+47 more)

### Community 85 - "publish-config.ts"
Cohesion: 0.15
Nodes (14): readArtifactoryOptionsFromEnvironment(), resolveArtifactoryPublicUrl(), createStorageFromEnvironment(), S3PublicationLockMode, ENVIRONMENT_KEYS, StorageEnvironmentDriver, readEnvironmentBoolean(), readEnvironmentS3LockMode() (+6 more)

### Community 86 - "react.ts"
Cohesion: 0.31
Nodes (8): extractErrorMessage(), verifyCatalog(), verifyCatalogHost(), verifyRouteOwnership(), verifySelectedVersions(), AtlasPlacementDriver, placementTargetsHost(), AtlasDeploymentManifestReference
...
Cohesion: 0.15
Nodes (24): ReactAppBootstrapOptions, ReactAppComponentOptions, renderReactAppBootstrap(), renderReactAppComponent(), renderReactAppDetails(), renderReactAppHome(), renderReactAppRoutes(), renderReactCreateRootImport() (+16 more)
...
Cohesion: 0.12
Nodes (21): AtlasMountedApp, assertBytesMatchDescriptor(), assertDeploymentMatchesExpectation(), loadHostDeployment(), loadPublishedManifest(), parseArtifactManifestFromBytes(), parseHostDeploymentFromBytes(), parseJsonFromBytes() (+13 more)
...
Cohesion: 0.16
Nodes (13): bootstrap(), compileConfig(), develop(), generate(), publish(), resolveProjectArgument(), runWorkspaceCommand(), WorkspaceCommandContext (+5 more)
...
Cohesion: 0.26
Nodes (11): assertMetadata(), assertPayload(), createImmutable(), derivePublicationIdentity(), PublicationFilesDriver, isUnknownOutcome(), preparePublicationFiles(), PublicationFile (+3 more)
...
Cohesion: 0.40
Nodes (3): FederationMetadataDriver, FederationMetadata, SHARED
...
Cohesion: 0.18
Nodes (9): installBridgeMarker(), buildDevelopmentBridgeMarkerSelector(), createBrowserBridgeDependencies(), DevelopmentSessionDriver, matchDevelopmentSessionResponse(), requestDevelopmentSession(), DevelopmentSessionBridgeDependencies, createBrowserFatalErrorDependencies() (+1 more)
...
Cohesion: 0.20
Nodes (13): ATLAS_LOGO, colorize(), colorizeRgb(), formatLogo(), indentContinuationLines(), MessageStatus, RgbColor, STATUS_COLORS (+5 more)
...
Cohesion: 0.12
Nodes (22): createAtlasHostDataSignal(), injectAtlasSdk(), AtlasAppAssets, createAtlasAppAssetFacade(), createAtlasAppAssets(), defineUnavailableAppAssets(), AppAssetsDriver, resolveAssetUrlInsideArtifact() (+14 more)
...
Cohesion: 0.05
Nodes (48): AngularWidgetOutletControllerDriver, HandleWidgetError, Component, WidgetInputs, WidgetSkeleton, createAtlasCoreSdk(), createAtlasSdk(), CommerceHostData (+40 more)
...
Cohesion: 0.24
Nodes (10): parseAbsoluteHttpUrl(), withArtifactUrls(), AtlasVerificationCheck, AtlasVerificationReport, AtlasVerificationStatus, checkMutableCache(), AtlasVerifyService, createContext() (+2 more)
...
Cohesion: 0.10
Nodes (24): parseRegistryRoot(), appendUrlPath(), computeSha256Integrity(), convertDigestToIntegrity(), DigestDriver, Sha256Digest, ErrorsDriver, extractErrorCause() (+16 more)
...
Cohesion: 0.09
Nodes (31): BuildNotificationsDependencies, BuildNotificationsDriver, isFederationRebuildCompleteEvent(), watchHostBuildNotifications(), createBrowserHostLoaderDependencies(), HostLoaderDriver, installHostSharedDependencies, loadHostStyles (+23 more)
...
Cohesion: 0.04
Nodes (43): AtlasHostProviderMissingError, AtlasSdkNotReadyError, AtlasAppRouteNotFoundError, AtlasAppLoadError, AtlasHostRetryError, AtlasHostStartError, AtlasSlotNameMissingError, emitHostError() (+35 more)
...
Cohesion: 0.14
Nodes (12): captureProcessOutput(), CliProcessDriver, forwardAndCaptureOutput(), processOutput, processOutputClosed, ProcessOutputDestinations, readCapturedProcessOutput(), require (+4 more)
...
Cohesion: 0.15
Nodes (13): devDependencies, babel-plugin-react-compiler, @file-services/node, react, @stylable/node, @stylable/optimizer, @wix/wix-ui-icons-common, react (+5 more)
...
Cohesion: 0.09
Nodes (21): BackgroundDriver, clearHostDataCache, fetch, loadDevelopmentSession, addWindowListener, DevelopmentSessionContentDriver, postMessage, windowListeners (+13 more)
...
Cohesion: 0.24
Nodes (12): COMMAND_HELP, ROOT_COMMANDS, ROOT_EXAMPLES, HelpEntry, appendHelpSection(), formatCommandHelp(), formatEntries(), formatExamples() (+4 more)
...
### Community 237 - "delay"
Cohesion: 0.05
Nodes (52): CounterWidget, CreateExportedWidgetDriver, Component, Input, WidgetProps, AngularLocationStrategyDriver, GoThroughHistoryDriver, goThroughHistory() (+44 more)
...
Cohesion: 0.08
Nodes (52): doesPathExist(), FsDriver, isMissingPathError(), isNodeError(), readJsonFile(), readTextFile(), ProcessCommand, runProcess() (+44 more)
...
Cohesion: 0.07
Nodes (30): App(), BrowserOverrideScopePicker(), BrowserOverrideScopePickerDriver, ScopePickerProps, ScopePickerProps, UseArtifactOverrideOptionsDriver, UseArtifactsDriver, ColumbusStateDriver (+22 more)
...
Cohesion: 0.35
Nodes (6): AtlasHostRuntimeConfig, ResolveHostRuntimeConfigDriver, buildArtifactUrl(), buildEnvironmentManifestUrl(), RuntimeUrlsDriver, resolveEnvironmentRegistryUrl()
...
### Community 304 - "Atlas"
Cohesion: 0.13
Nodes (20): ANGULAR_HOST_PATHS, ANGULAR_ROUTED_APP_PATHS, ANGULAR_SINGLE_PAGE_APP_PATHS, REACT_HOST_PATHS, REACT_ROUTED_APP_PATHS, REACT_SINGLE_PAGE_APP_PATHS, ReactViteGeneratorDriver, SupportedGeneratorOptions (+12 more)
...
Cohesion: 0.09
Nodes (25): HostFixture(), HostSdk, ReactHostDriver, AtlasEventListenerError, AtlasSdkError, AtlasSdkErrorOptions, AtlasWidgetMountError, SdkErrorDriver (+17 more)
...
Cohesion: 0.05
Nodes (39): AngularBootstrapDriver, ASSET_BASE_URL, createAppConfig(), CustomerSdk, LOGO_URL, createExportedWidget(), forwardChangedInputs(), AppBootstrap (+31 more)

### Community 329 - "index.ts"
Cohesion: 0.13
Nodes (18): writeDevOverrideDocument(), developmentPreviewUrl(), nonInteractivePrompter, assertLocalPreviewPort(), AtlasDevService, compileAtlasConfig, DevServiceDriver, AppDevelopmentOptions (+10 more)

### Community 330 - "@types/react"
Cohesion: 0.12
Nodes (20): appendNavigationStateToPath(), createAppNavigator(), AppNavigatorDriver, AtlasNavigationTarget, NavigateToApp, AdapterOnlyOptionName, createDomHostSdk(), createSdkProviders() (+12 more)
...
Cohesion: 0.10
Nodes (17): AtlasArtifactPreviewState, AtlasArtifactPreviewStateEntry, AtlasPreviewStateFile, defaultDependencies, isArtifactPreviewStateEntry(), isPreviewNumber(), isPreviewStateFile(), PreviewPruningDriver (+9 more)
...
Cohesion: 0.07
Nodes (43): ArtifactOverrideEditorPage(), initialOverrideSelection(), ArtifactOverrideEditorPageActions(), ArtifactOverrideEditorPageActionsProps, ActionsProps, ArtifactOverrideEditorPageActionsDriver, ArtifactOverrideLocationState, isArtifactOverrideLocationState() (+35 more)

### Community 385 - "workspace.driver.ts"
Cohesion: 0.13
Nodes (19): PortsDriver, anAppConfigSource(), GenerateServiceDriver, WidgetAppsDriver, createdRoots, TemporaryDirectory, MANAGERS, TURBO_BYPASSED_TASKS (+11 more)
...
- `AtlasDevService` (2× useful, score=0.433745083)
...
- **Why does `hydratePublishedArtifactManifest()` connect `manifest-utils.ts` to `atlas-host.ts`, `Atlas Overview`?**
