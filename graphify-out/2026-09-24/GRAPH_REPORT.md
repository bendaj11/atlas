...
## Corpus Check
- 1357 files · ~347,211 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7043 nodes · 16724 edges · 383 communities (309 shown, 74 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 159 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a8682171`
...
## Communities (383 total, 74 thin omitted)
...
Cohesion: 0.09
Nodes (26): AtlasHostProviderMissingError, AtlasSdkNotReadyError, AngularHostSdkReference, appendAtlasSdkProvider(), AtlasDefaultHostRouteComponent, AtlasNavigationItemsService, bootstrapAngularHost(), startHost() (+18 more)
...
Cohesion: 0.07
Nodes (32): EntryBehavior, HostRuntimeDriver, startAtlasHostRuntime(), AppReadiness, AtlasHostRuntime, IsMountCurrent, LoadingStateEmitter, PlacementMountRecord (+24 more)

### Community 4 - "workspace.ts"
Cohesion: 0.05
Nodes (66): AngularAdapterDriver, EagerSdkHostRoot, HostRoot, HostSdk, startDomHost, StartDomHostForHostSdk, Component, DomHostDriver (+58 more)

### Community 5 - "build.driver.ts"
Cohesion: 0.26
Nodes (13): createFederationRemoteFromWidget(), assertAssetUrlIsTrusted(), assertLocalManifestUsesLoopbackUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), createRemoteTrustPolicy(), TrustPolicyDriver, TrustedAssetKind (+5 more)
...
Cohesion: 0.10
Nodes (36): AtlasArtifactPreviewState, assertPreviewIsCurrent(), groupObjectsByGeneration(), isExpiredGeneration(), pruneUnreferencedPreviewGenerations(), prunePreviewsOnce(), removeClosedPreviews(), removePreviewOnce() (+28 more)
...
Cohesion: 0.06
Nodes (38): createAtlasHostDataSignal(), injectAtlasSdk(), createAngularAtlasSdk(), CreateAngularAtlasSdkInput, AngularAtlasSdkDriver, WidgetInputs, AngularLoadingRendererRequest, createAngularLoadingRenderer() (+30 more)
...
Cohesion: 0.11
Nodes (28): assertAtlasHostCatalog(), assertAtlasHostManifest(), assertAtlasManifest(), assertReleaseVersion(), assertSafeArtifactId(), assertSafeRelativePath(), SafePathsDriver, assertEnvironmentDeployment() (+20 more)

### Community 20 - "AtlasNavigation"
Cohesion: 0.09
Nodes (76): collectAtlasHostCatalogIssues(), validateAppManifestList(), validateAtlasHostCatalog(), collectAtlasHostManifestIssues(), validateAtlasHostManifest(), collectAtlasManifestIssues(), PlacementUniqueness, validateExportedWidget() (+68 more)

### Community 21 - "dev.service.ts"
Cohesion: 0.08
Nodes (22): AppComponent, Component, bootstrap(), DemoRouteAnchorComponent, HostMountRequest, Component, HostWidgets, Component (+14 more)
...
Cohesion: 0.07
Nodes (40): requireAppEntryExport(), requireWidgetEntryExport(), createMountBoundary(), requireStyleTarget(), isMountableEntry(), MountableEntry, unwrapDefaultExport(), createWidgetCard() (+32 more)
...
Cohesion: 0.11
Nodes (29): assertBytesMatchDescriptor(), assertDeploymentMatchesExpectation(), DeploymentDriver, loadHostDeployment(), loadPublishedManifest(), parseArtifactManifestFromBytes(), parseHostDeploymentFromBytes(), parseJsonFromBytes() (+21 more)
...
Cohesion: 0.06
Nodes (61): DEPENDENCY_FIELDS, DependencyField, detectExistingFrameworkVersion(), DependenciesDriver, FrameworkVersionInfo, isDependencyDeclared(), isFrameworkManagedDependency(), mergePackageDependencies() (+53 more)
...
Cohesion: 0.20
Nodes (11): LEGACY_CONFIG_API_MAJORS, MAIN_PACKAGE_MAJORS, V4_CONFIG_API_MAJORS, V4_PACKAGE_MAJORS, AngularPackageGeneratorDriver, ANGULAR_DEPENDENCIES, ANGULAR_DEV_DEPENDENCIES, ReactPackageGeneratorDriver (+3 more)
...
Cohesion: 0.17
Nodes (23): AngularFederationDriver, selectNativeFederationBuilder(), selectNativeFederationPackage(), usesNativeFederationV4Package(), buildAngularPackageManifest(), convertAngularVersionToRange(), buildReactPackageManifest(), ReactPackageManifestOptions (+15 more)

### Community 55 - "types.ts"
Cohesion: 0.07
Nodes (58): AngularGenerationDriver, BUILD_NOTIFICATIONS, addUniquePolyfill(), AngularRunnerKey, configureAngularBuildNotifications(), configureAngularDevelopmentTargets(), enableAngularBuildNotifications(), ensureAngularFederationPolyfills() (+50 more)
...
Cohesion: 0.13
Nodes (23): AtlasDevSessionDocument, assertManifestSupportsHost(), assertOverrideMatchesManifest(), CatalogResolutionDriver, indexManifestsById(), resolveRuntimeCatalog(), resolveRuntimeManifests(), assertOverrideDocumentTargetsHost() (+15 more)
...
Cohesion: 0.06
Nodes (43): RenderHostError, RenderHostLoading, RetryHostStart, AtlasHostAnchorRegistry, createAnchorKey(), HostAnchorsDriver, AtlasHostAnchorKind, AtlasHostAnchorListener (+35 more)
...
Cohesion: 0.06
Nodes (41): aReport(), bootstrapBuild, buildServiceConstructor, CliServiceDriver, compileAtlasConfig, constructor(), deployRun, detectWorkspace (+33 more)
...
Cohesion: 0.21
Nodes (13): buildLeaseFileId(), buildLeaseFilePath(), ControlServerLease, ControlServerLeaseDriver, ensureLeaseDirectory(), isActiveLease(), isProcessRunning(), LEASE_DIRECTORY (+5 more)

### Community 90 - "prepare.js"
Cohesion: 0.22
Nodes (12): assertPreviewNumber(), assertUniqueArtifactIdentifiers(), readArtifactCollection(), readDescriptorMap(), readRegistryArtifact(), RecordsDriver, isNonEmptyString(), isRecord() (+4 more)
...
Cohesion: 0.26
Nodes (7): AngularPackageManifestOptions, AngularFederationConfigOptions, AngularWorkspaceDocumentOptions, ReactViteGeneratorDriver, ReactViteConfigOptions, PortsDriver, AtlasProjectType
...
Cohesion: 0.05
Nodes (48): HostFixture(), HostSdk, ReactHostDriver, CounterWidget, CreateExportedWidgetDriver, Component, Input, WidgetProps (+40 more)
...
Cohesion: 0.37
Nodes (11): readActiveControlServerLeases(), startOrJoinControlServer(), joinControlServer(), startOwnedControlServer(), buildLocalOrigin(), deleteJson(), fetchFromControlServer(), isAddressInUse() (+3 more)
...
Cohesion: 0.14
Nodes (16): AtlasAppAssets, createAtlasAppAssetFacade(), createAtlasAppAssets(), defineUnavailableAppAssets(), AppAssetsDriver, resolveAssetUrlInsideArtifact(), throwAppContextMissing(), createWidgetComponentGetter() (+8 more)

### Community 158 - "React SDK"
Cohesion: 0.18
Nodes (7): DevelopmentProcessDriver, FakeChildProcess, linkedResult, spawn, warning, DevSessionRuntime, DevControlServer
...
Cohesion: 0.05
Nodes (34): AngularHostNavigationDriver, createLocationStrategy(), notifyPopStateListeners(), AngularNavigateByUrlOptions, LocationBack, LocationHistoryGo, LocationLike, NavigateByUrl (+26 more)
...
Cohesion: 0.04
Nodes (87): AtlasAppRouteNotFoundError, AtlasAppLoadError, AtlasHostRetryError, AtlasHostStartError, AtlasSlotNameMissingError, emitHostError(), emitHostReady(), emitHostStart() (+79 more)
...
Cohesion: 0.10
Nodes (23): readCliVersion(), runAtlasCli(), VERSION_ARGUMENTS, HttpDriver, info, compileConfig(), COMMAND_ALIASES, ArgumentsDriver (+15 more)
...
Cohesion: 0.11
Nodes (19): devDependencies, @angular/compiler, @angular/compiler-cli, @atlas/testkit, @faker-js/faker, @playwright/test, react-dom, @testing-library/react (+11 more)
...
Cohesion: 0.08
Nodes (25): AtlasAppContext, AtlasAppLoading, AtlasAppMountRequest, AtlasAppMountResult, AtlasHostClientEntry, AtlasMountOutcome, AtlasExportedWidgetMountResult, AtlasScopedNavigation (+17 more)
...
Cohesion: 0.14
Nodes (23): ReactAppGeneratorDriver, ReactAppBootstrapOptions, ReactAppComponentOptions, renderReactAppBootstrap(), renderReactAppComponent(), renderReactAppDetails(), renderReactAppHome(), renderReactAppRoutes() (+15 more)
...
Cohesion: 0.19
Nodes (14): parseAbsoluteHttpUrl(), verifyManifestAssets(), withArtifactUrls(), AtlasVerificationCheck, AtlasVerificationReport, AtlasVerificationStatus, checkMutableCache(), AtlasVerifyService (+6 more)
...
Cohesion: 0.06
Nodes (57): doesPathExist(), FsDriver, isMissingPathError(), isNodeError(), readJsonFile(), readTextFile(), captureProcessOutput(), CliProcessDriver (+49 more)
...
Cohesion: 0.07
Nodes (48): AnchorsListener, AtlasHostRuntimeOptions, AtlasMountedApp, HostPlacement, ReportMountStateChange, ResolvePlacementContainer, RuntimeControllerInput, SubscribeToAnchors (+40 more)
...
### Community 304 - "Atlas"
Cohesion: 0.19
Nodes (15): ANGULAR_HOST_PATHS, ANGULAR_ROUTED_APP_PATHS, ANGULAR_SINGLE_PAGE_APP_PATHS, REACT_HOST_PATHS, REACT_ROUTED_APP_PATHS, REACT_SINGLE_PAGE_APP_PATHS, ValidationDriver, INVALID_IDS (+7 more)
...
Cohesion: 0.07
Nodes (37): HostDataDriver, ProjectHostData, ProjectHostSdk, getHostDataListeners(), HOST_DATA_LISTENERS, HostDataListener, HostDataListenerRegistry, registerHostDataListeners() (+29 more)
...
Cohesion: 0.04
Nodes (64): BootstrapServerDriver, appendUrlPath(), doesRouteMatchPath(), doesSupportAnyHost(), DevelopmentConfigDriver, listConfiguredHostIds(), listRoutePaths(), parsePort() (+56 more)
...
Cohesion: 0.06
Nodes (38): DevelopmentPreflightDriver, buildFrameworkServerArguments, FakeChildProcess, logHostViewUrl, openBrowserWhenReady, SessionRunnerDriver, startControlServer, waitForRemoteEntry (+30 more)
...
## Knowledge Gaps
- **1933 isolated node(s):** `name`, `version`, `private`, `type`, `@atlas/schema` (+1928 more)
...
- `AtlasDevService` (2× useful, score=0.443957115)
...
- **Why does `hydratePublishedArtifactManifest()` connect `manifest-utils.ts` to `Production deployment and CI`, `cli.service.ts`, `atlas-host.ts`?**
