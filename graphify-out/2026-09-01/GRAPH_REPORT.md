...
## Corpus Check
- 591 files · ~204,961 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5007 nodes · 9593 edges · 321 communities (249 shown, 72 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 147 edges (avg confidence: 0.73)
...
## Communities (321 total, 72 thin omitted)
...
Cohesion: 0.05
Nodes (36): MountStateRenderingOptions, prepareStatusElement(), renderErrorState(), renderHostMountState(), renderHostNavigation(), renderLoadingState(), AtlasHostMountEvent, createDeferred() (+28 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.10
Nodes (32): FrameworkVersionInfo, addUniqueString(), defaultIgnoreFileDependencies, GeneratedFilesDriver, IgnoreScenario, ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS, existingPackageName() (+24 more)
...
Cohesion: 0.12
Nodes (24): BootstrapScenario, BootstrapServerDriver, ui, createControlRequestHandler(), developmentSession(), joinControlServer(), pathSegment(), registerOverride() (+16 more)
...
Cohesion: 0.08
Nodes (43): AtlasArtifactPreviewState, AtlasPublicationLease, AtlasPublicationStorage, AtlasPublicationStorageSource, createPublicationStorage(), isPublicationStorage(), AtlasPreviewHeadLookup, AtlasPreviewHeadResolver (+35 more)
...
Cohesion: 0.13
Nodes (13): AtlasRuntimeController, createAppReadiness(), createLoadingEmitter(), createRuntimeMount(), findRoutePlacement(), navigationTargets(), placementKey(), startAtlasHostRuntime() (+5 more)
...
Cohesion: 0.07
Nodes (52): BrowserErrorContext, createBrowserError(), logBrowserError(), emitHostError(), emitHostReady(), emitHostStart(), emitMountState(), reportRetryFailure() (+44 more)
...
Cohesion: 0.05
Nodes (70): createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, RoutePlacement, AtlasHostMountState, AtlasHostRuntimeOptions (+62 more)

### Community 25 - "native-federation.ts"
Cohesion: 0.06
Nodes (26): AtlasDeploymentCatalog, AppBootstrap, createExportedWidget(), defineExportedWidget(), provideAtlasSdk(), createLocationStrategy(), notifyPopState(), PopStateListener (+18 more)

### Community 26 - "ArtifactsOverridesTable.tsx"
Cohesion: 0.05
Nodes (36): cliActions(), cliSummary(), COMMAND_ALIASES, createCliError(), CliErrorDriver, ErrorScenario, errorCauseMessage(), errorCauses() (+28 more)
...
Cohesion: 0.10
Nodes (40): readPublishedCatalog(), mapWithConcurrency(), isMatchingResponse(), requestDevelopmentSession(), assertDescriptorBytes(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust() (+32 more)
...
Cohesion: 0.09
Nodes (16): AtlasBootstrapServiceOptions, CliArguments, AtlasInvocation, InteractionDriver, InteractionScenario, resolveInvocation(), PromptTestDouble, title() (+8 more)
...
Cohesion: 0.20
Nodes (14): SupportedFramework, asStringRecord(), DEPENDENCY_FIELDS, dependencyDeclared(), DependencyField, dependencyManifestPath(), existingFrameworkVersionInfo(), frameworkPrimaryDependency() (+6 more)
...
Cohesion: 0.08
Nodes (16): ControlServerDriver, ControlServerDriver, StartControlServerOptions, createDevSession(), createLocalDevCatalog(), DevSessionEntry, DevelopmentSessionDriver, SessionScenario (+8 more)
...
Cohesion: 0.09
Nodes (28): deployedManifest, VersionDropdownProps, createLoadedHost(), HostContext, HostContextValue, HostLoadResult, readCachedHost(), CreateOverrideDocumentOptions (+20 more)

### Community 86 - "react.ts"
Cohesion: 0.16
Nodes (15): createHostNavigationItems(), documentNavigationItems, normalizeRoutePath(), readAtlasNavigationItems(), routeMatches(), routePlacementsForHost(), subscribeAtlasNavigationItems(), uniqueRoutePlacements() (+7 more)
...
Cohesion: 0.08
Nodes (36): AngularLocalManifest, AngularLocalRuntimeDriver, prepareAngularLocalRuntime(), artifactDirectoryUrl(), AtlasFederationAdapter, createNativeFederationImporters(), createTrustedNativeFederationImporters(), FederationRemote (+28 more)
...
Cohesion: 0.04
Nodes (71): AngularHostSdkReference, renderLoading(), ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk, AtlasSdkFactory, createAtlasHostDataSignal(), AngularInjectionDriver (+63 more)
...
Cohesion: 0.10
Nodes (32): completedProcessOutput(), writeDevOverrideDocument(), browserOpenCommand(), developmentPreviewUrl(), DevelopmentProcessDriver, RemoteEntryScenario, formatFrameworkServerError(), frameworkServerArguments() (+24 more)
...
Cohesion: 0.11
Nodes (33): ArtifactConfigurationPage(), OverrideRadioCard(), OverrideRadioCardProps, OverridesSelectionForm(), OverridesSelectionFormProps, isDeployedProductionVersion(), OverrideVersionDropdown(), ArtifactConfigurationLocationState (+25 more)
...
Cohesion: 0.13
Nodes (5): suggestedDevServerPort(), AtlasGenerateService, availableAppsMessage(), AtlasWorkspace, defaultDevServerPort()
...
Cohesion: 0.07
Nodes (52): DeploymentWrite, AtlasResolvedRelease, assertAtlasManifest(), AtlasArtifactManifestBase, AtlasAppConfig, AtlasBaseConfig, AtlasRouteMount, AtlasSlotMount (+44 more)
...
- **Why does `AtlasManifest` connect `runtime-discovery.ts` to `AtlasManifest`, `loader.specs.ts`, `verify.service.ts`, `remote-assets.ts`, `cli.service.ts`, `process.ts`, `react.ts`, `manifest-utils.ts`, `native-federation.ts`, `angular-host-navigation.ts`, `create-manifest-from-config-input.ts`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `versionPackages()` connect `prepare-release.js` to `prepare.js`, `content-script.ts`?**
