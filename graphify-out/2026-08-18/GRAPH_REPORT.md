# Graph Report - atlas  (2026-08-18)

## Corpus Check
- 538 files · ~186,281 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4751 nodes · 8812 edges · 311 communities (243 shown, 68 thin omitted)
...
## Communities (311 total, 68 thin omitted)
...
Cohesion: 0.10
Nodes (26): AtlasBootstrapService, bootstrapDigest(), cliActions(), cliSummary(), COMMAND_ALIASES, createCliError(), errorCauseMessage(), errorCauses() (+18 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.17
Nodes (4): ControlServerDriver, ControlServerDriver, AtlasDevOverrideDocument, DevControlServer
...
Cohesion: 0.13
Nodes (23): createControlRequestHandler(), joinControlServer(), pathSegment(), readProductionCatalog(), registerOverride(), respondWithCatalog(), respondWithSession(), respondWithVersionIndex() (+15 more)
...
Cohesion: 0.09
Nodes (33): absoluteHttpUrl(), asRecord(), AssetExpectation, AtlasVerificationCheck, AtlasVerificationReport, AtlasVerificationStatus, AtlasVerifyOptions, AtlasVerifyService (+25 more)
...
Cohesion: 0.06
Nodes (57): AssetResolver, createRemoteAssetResolver(), isExternalUrl(), isFragmentUrl(), rewriteCssUrls(), AtlasAssetRewriteRelease, addDocumentStyleRewriteSession(), angularStyleScopeAttributeNames() (+49 more)
...
Cohesion: 0.13
Nodes (7): Assets And Styles, App manifest, Host manifest, Manifests, App Routes And Host Layouts, Routing And Navigation, Troubleshooting
...
Cohesion: 0.10
Nodes (16): AppReadiness, AtlasRuntimeController, createAppReadiness(), createLoadingEmitter(), createRuntimeMount(), findRoutePlacement(), hostPlacements(), navigationTargets() (+8 more)

### Community 21 - "dev.service.ts"
Cohesion: 0.13
Nodes (16): CliErrorDriver, ErrorScenario, actionableMessage(), AtlasError, AtlasErrorOptions, AtlasErrorSurface, ensureActionableError(), errorSummary() (+8 more)

### Community 22 - "manifest-utils.ts"
Cohesion: 0.15
Nodes (25): OverrideVersionDropdown(), VersionDropdownProps, versionOptionLabel(), ArtifactConfigurationLocationState, useArtifactConfiguration(), useArtifacts(), artifactSourceDescription(), baseUrlFromRemoteEntry() (+17 more)
...
Cohesion: 0.09
Nodes (38): MockTab, mapWithConcurrency(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl(), bytesToBase64() (+30 more)
...
Cohesion: 0.16
Nodes (22): addUniquePolyfill(), asObject(), configureAngularBuildNotifications(), enableAngularBuildNotifications(), ensureAngularFederationPolyfills(), ensureAngularHostBuildNotifications(), ensureAngularNativeFederationTargets(), ensureAngularWorkspaceFederationConfig() (+14 more)
...
### Community 34 - "app.ts"
Cohesion: 0.14
Nodes (19): HostProvider(), OverridesContext, OverridesContextValue, OverridesProvider(), SessionContext, SessionContextValue, useSession(), clearAllOverridesInSession() (+11 more)
...
Cohesion: 0.10
Nodes (36): createOverrideDocument(), disabledOverridesKey(), DisabledOverrideStorageLocation, AtlasHostDriver, storageArea(), errorMessage(), findAtlasHostTab(), hasTabId() (+28 more)
...
### Community 41 - ".run"
Cohesion: 0.13
Nodes (24): completedProcessOutput(), writeDevOverrideDocument(), browserOpenCommand(), DevelopmentProcessDriver, RemoteEntryScenario, formatFrameworkServerError(), frameworkServerArguments(), logHostViewUrl() (+16 more)

### Community 42 - "FailingMutableStorage"
Cohesion: 0.10
Nodes (21): createExportedWidget(), defineExportedWidget(), ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk, AtlasSdkFactory, createAtlasHostDataSignal(), AngularInjectionDriver (+13 more)
...
Cohesion: 0.33
Nodes (6): InspectAtlasHostDriver, installPage(), jsonResponse(), manifest(), PageOptions, storage()
...
Cohesion: 0.15
Nodes (13): ArtifactConfigurationActions(), ArtifactConfigurationActionsProps, ArtifactConfigurationActionsDriver, BrowserOverrideScopePicker(), BrowserOverrideScopePickerDriver, ScopePickerProps, OverrideRadioCard(), OverrideRadioCardProps (+5 more)
...
Cohesion: 0.29
Nodes (10): assertArtifactManifest(), assertAtlasManifest(), createManifestFromConfig(), identifierFromRoute(), identifierFromSlot(), placements(), routePlacementId(), slotPlacementId() (+2 more)
...
Cohesion: 0.18
Nodes (13): CreateOverrideDocumentOptions, clearHostDataCache(), HostDataSnapshot, isExtensionPage(), isHostDataSnapshot(), readHostDataCache(), ManifestVersionsDriver, IncludeDisabledAppsOptions (+5 more)
...
Cohesion: 0.06
Nodes (46): SdkProviderInput, RoutePlacement, AtlasHostRuntimeOptions, AtlasLoaderOptions, AtlasMountedApp, AtlasWidgetErrorRenderContext, AtlasWidgetLoaderOptions, AtlasWidgetRenderContext (+38 more)
...
Cohesion: 0.26
Nodes (12): createLoadedHost(), HostContext, HostContextValue, HostLoadResult, readActiveHost(), readDisabledOverrides(), readSuppressedArtifactIds(), normalizeStoredManifest() (+4 more)
...
Cohesion: 0.10
Nodes (22): ATLAS_BROWSER_LOADER, AtlasBootstrapFile, AtlasBootstrapOptions, createAtlasBootstrapFiles(), createBootstrapHtml(), createNginxConfig(), cspSources(), escapeHtml() (+14 more)
...
Cohesion: 0.10
Nodes (6): AtlasEventBus, createAtlasEventBus(), HttpClient, IHttpClient, withBody(), AtlasCoreSdk
...
Cohesion: 0.08
Nodes (23): AngularHostBootstrapOptions, AngularHostDataInput, AngularHostDataOption, AngularHostSdkReference, AngularHostStartServices, AtlasDefaultHostRouteComponent, AtlasNavigationItemsService, bootstrapAngularHost() (+15 more)
...
Cohesion: 0.06
Nodes (31): addNavigationState(), AtlasNavigationTarget, createAppNavigator(), AppNavigatorDriver, BrowserWindowLike, createBrowserNavigation(), appendQueryValue(), matchRoutePart() (+23 more)
...
Cohesion: 0.07
Nodes (49): SupportedFramework, asStringRecord(), DEPENDENCY_FIELDS, dependencyDeclared(), DependencyField, dependencyManifestPath(), existingFrameworkVersionInfo(), frameworkPrimaryDependency() (+41 more)
...
Cohesion: 0.06
Nodes (50): createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), AtlasEventMap, AtlasFetchHttpClient, HttpClientInput, HttpRequest (+42 more)
...
Cohesion: 0.13
Nodes (10): AtlasBootstrapServiceOptions, CliArguments, DevelopmentPortsDriver, PortScenario, hostClientPortFallback(), resolveHostDevPorts(), DevelopmentScenario, DevServiceDriver (+2 more)
...
### Community 265 - "angular-widget.ts"
Cohesion: 0.14
...
Cohesion: 0.08
Nodes (18): AtlasInvocation, InteractionDriver, InteractionScenario, PromptTestDouble, title(), AtlasPrompter, UiDriver, UiScenario (+10 more)
...
Cohesion: 0.07
Nodes (23): App(), ArtifactConfigurationPage(), ArtifactsOverridesPage(), ArtifactName(), ArtifactOverrideActions(), ArtifactOverrideToggle(), ArtifactOverrideVersion(), ArtifactOverrideVersionDriver (+15 more)
...
- **Why does `AtlasManifest` connect `loader.driver.ts` to `index.ts`, `overlay.ts`, `ArtifactConfigurationPage.tsx`, `event-bus.ts`, `build.driver.ts`, `verify.service.ts`, `main.tsx`, `remote-assets.ts`, `Angular SDK`, `cli.service.ts`, `Security`, `runtime-discovery.ts`, `stylesheets.ts`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `fetchJson()` connect `sdk-factory.ts` to `index.ts`, `loader.specs.ts`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `CliArguments` connect `react-router.ts` to `env.ts`, `AtlasManifest`, `navigation-paths.ts`, `nx.ts`, `overlay-controller.ts`, `.run`, `angular.ts`, `ui.specs.ts`, `cli.service.ts`, `AtlasGenerateService`, `CliArguments`, `AngularWidgetOutletController`?**
