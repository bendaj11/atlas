# Graph Report - atlas  (2026-09-06)

## Corpus Check
- 630 files · ~224,613 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5233 nodes · 10078 edges · 341 communities (273 shown, 68 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 158 edges (avg confidence: 0.73)
...
5. `runtimeError()` - 28 edges
6. `AtlasNavigation` - 28 edges
7. `AtlasSdk` - 28 edges
...
## Communities (341 total, 68 thin omitted)

### Community 0 - "index.ts"
Cohesion: 0.08
Nodes (22): AppBootstrap, createExportedWidget(), defineApp(), defineExportedWidget(), provideAtlasSdk(), AtlasAppMountRequest, AtlasAppMountResult, AtlasExportedWidgetMountRequest (+14 more)
...
Cohesion: 0.05
Nodes (30): AtlasHostMountEvent, createDeferred(), createHostCatalog(), createRouteManifest(), createRoutePlacement(), createSlotManifest(), createTestContainer(), createTestDocument() (+22 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.09
Nodes (35): cliActions(), cliSummary(), COMMAND_ALIASES, createCliError(), errorCauseMessage(), errorCauses(), errorStatus(), formatErrorWithCauses() (+27 more)

### Community 4 - "workspace.ts"
Cohesion: 0.39
Nodes (4): FetchJsonDriver, fetchJson(), fetchJsonRequest(), validateIntegrity()

### Community 5 - "build.driver.ts"
Cohesion: 0.11
Nodes (31): PublishServiceDriver, canonicalJson(), isRecord(), registryRevision(), sortJson(), artifactKind(), assertUniqueName(), AtlasRegistryMutation (+23 more)
...
Cohesion: 0.08
Nodes (38): ControlServerDriver, createControlRequestHandler(), developmentSession(), joinControlServer(), ControlServerLease, ensureLeaseDirectory(), isActiveLease(), LEASE_DIRECTORY (+30 more)
...
Cohesion: 0.08
Nodes (37): LocalBootstrapServerOptions, manifestBytes(), absoluteHttpUrl(), asRecord(), AssetExpectation, AtlasVerificationCheck, AtlasVerificationReport, AtlasVerificationStatus (+29 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.11
Nodes (32): withExponentialRetry(), sourceBytes(), writeJson(), createPublicationStorage(), AtlasRegistryConfig, artifactPrefix(), assertExpectedRegistryRevision(), assertMetadata() (+24 more)
...
Cohesion: 0.10
Nodes (21): renderLoading(), HostFixture(), HostSdk, ReactHostDriver, AtlasAppAssets, createAtlasAppAssetFacade(), createAtlasAppAssets(), AppAssetsDriver (+13 more)
...
Cohesion: 0.09
Nodes (29): BrowserErrorContext, createBrowserError(), logBrowserError(), emitHostError(), emitHostReady(), emitHostStart(), emitMountState(), reportRetryFailure() (+21 more)
...
### Community 34 - "app.ts"
Cohesion: 0.12
Nodes (23): BrowserOverrideScopePicker(), BrowserOverrideScopePickerDriver, ScopePickerProps, HostProvider(), OverridesContext, OverridesContextValue, OverridesProvider(), SessionContext (+15 more)
...
Cohesion: 0.08
Nodes (38): AngularLocalManifest, AngularLocalRuntimeDriver, prepareAngularLocalRuntime(), artifactDirectoryUrl(), createNativeFederationImporters(), createTrustedNativeFederationImporters(), FederationRemote, federationRemoteName() (+30 more)
...
### Community 41 - ".run"
Cohesion: 0.40
Nodes (8): assertAtlasRuntimeConfig(), assertDevelopmentSessionUrl(), assertOptionalInteger(), assertRegistryUrl(), assertSegment(), environmentManifestUrl(), environmentRegistryUrl(), isRecord()

### Community 42 - "FailingMutableStorage"
Cohesion: 0.12
Nodes (25): defaultIgnoreFileDependencies, GeneratedFilesDriver, IgnoreScenario, ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS, existingPackageName(), hasAtlasIgnorePattern(), IgnoreFileDependencies (+17 more)
...
Cohesion: 0.12
Nodes (14): AppReadiness, AtlasHostRuntimeOptions, AtlasMountedApp, AtlasRuntimeController, createAppReadiness(), createLoadingEmitter(), createRuntimeMount(), navigationTargets() (+6 more)

### Community 55 - "types.ts"
Cohesion: 0.08
Nodes (39): AtlasHostMountState, AtlasWidgetErrorRenderContext, AtlasWidgetRenderContext, createMountBoundary(), createRoutePlacementPlan(), createRouteTitleController(), createWidgetCard(), createWidgetLoader() (+31 more)
...
Cohesion: 0.08
Nodes (21): Before a Pull Request, Contributing to Atlas, Documentation, File Extensions, Releases, Repository Layout, Setup, Choose One Page Type (+13 more)
...
Cohesion: 0.15
Nodes (13): @angular/core, @angular/platform-browser, react, vite, @angular/core, @angular/platform-browser, react, vite (+5 more)
...
Cohesion: 0.10
Nodes (33): deployedManifest, VersionDropdownProps, useArtifacts(), createLoadedHost(), HostContext, HostContextValue, HostLoadResult, readActiveHost() (+25 more)
...
Cohesion: 0.19
Nodes (11): bridgeMarkerSelector(), defaultDependencies(), DevelopmentSessionBridgeDependencies, DevelopmentSessionDriver, isMatchingResponse(), requestDevelopmentSession(), applyOverrides(), artifactRegistryRoot() (+3 more)
...
Cohesion: 0.08
Nodes (13): ArtifactoryOptions, ArtifactoryPublicationStorage, assertReplaceCondition(), collectBody(), ArtifactoryStorageDriver, StorageClient, AtlasPublicationBody, AtlasPublicationLease (+5 more)
...
Cohesion: 0.11
Nodes (15): ControlServerDriver, createDevSession(), createLocalDevCatalog(), DevSessionEntry, DevelopmentSessionDriver, SessionScenario, HostDevSession, localHostPlaceholder() (+7 more)
...
### Community 117 - "delay"
Cohesion: 0.13
Nodes (9): AtlasBootstrapServiceOptions, CliArguments, AtlasInvocation, InteractionDriver, InteractionScenario, resolveInvocation(), PromptTestDouble, title() (+1 more)

### Community 118 - "lifecycle.ts"
Cohesion: 0.16
...
Cohesion: 0.06
Nodes (33): AngularWidgetRuntime, AtlasEventBus, AtlasEventListener, AtlasEventMap, createAtlasEventBus(), EventKey, notifyListener(), PayloadEventKey (+25 more)

### Community 127 - "framework-api.specs.ts"
Cohesion: 0.18
Nodes (9): AtlasDeployResult, appManifest(), DeployServiceDriver, digest(), file(), hostManifest(), AtlasPublicationReplaceCondition, descriptorFor() (+1 more)

### Community 128 - "HttpClient"
Cohesion: 0.10
Nodes (20): AngularHostSdkReference, AngularBootstrapDriver, ASSET_BASE_URL, createAppConfig(), CustomerSdk, LOGO_URL, AtlasSdk, AngularInjectionDriver (+12 more)

### Community 129 - "angular.specs.ts"
Cohesion: 0.09
Nodes (20): AtlasNavigationItemsService, Injectable, AtlasHostNavigationItem, createHostNavigationItems(), documentNavigationItems, normalizeRoutePath(), routeMatches(), RoutePlacement (+12 more)
...
Cohesion: 0.11
Nodes (18): DomHostOptions, DomHostServices, DomRuntimeOptions, DomHostRuntimeInput, createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties() (+10 more)
...
Cohesion: 0.09
Nodes (25): BrowserWindowLike, createBrowserNavigation(), appendQueryValue(), matchRoutePart(), matchRoutePattern(), normalizePath(), parseQuery(), scopePath() (+17 more)
...
Cohesion: 0.10
Nodes (27): completedProcessOutput(), writeDevOverrideDocument(), hostClientPortFallback(), resolveHostDevPorts(), ResolveHostDevPortsOptions, browserOpenCommand(), developmentPreviewUrl(), DevelopmentProcessDriver (+19 more)

### Community 158 - "React SDK"
Cohesion: 0.17
Nodes (18): isPublicationStorage(), PullRequestDriver, providerFetch(), providerToken(), requiredString(), resolveBitbucketPullRequest(), resolveGitHubPullRequest(), resolveGitLabMergeRequest() (+10 more)

### Community 159 - "angular.ts"
Cohesion: 0.13
Nodes (25): ArtifactoryClient, ArtifactoryConnectionOptions, ArtifactoryDependencies, ArtifactoryResponse, ArtifactUpload, discardResponse(), downloadResponse(), ArtifactoryClientDriver (+17 more)
...
Cohesion: 0.28
Nodes (5): { createReactAppViteConfig, createReactHostViteConfig }, namedExports, PackageFixture, PackageFormat, ReactSharedPackagesDriver
...
Cohesion: 0.27
Nodes (8): RetryDriver, isRetryableHttpStatus(), isTransientError(), RetryOptions, statusCode(), transientNetworkCode(), transientStatus(), wait()

### Community 181 - "AngularWidgetOutletController"
Cohesion: 0.09
Nodes (24): ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdkFactory, createAtlasHostDataSignal(), injectAppLoaded(), injectAtlasAppContext(), injectAtlasSdk(), unavailableAppAssetUrl() (+16 more)

### Community 182 - "process.ts"
Cohesion: 0.20
...
Cohesion: 0.15
Nodes (13): devDependencies, @babel/plugin-syntax-typescript, jest-environment-jsdom, react-router-dom, @types/react, @vitejs/plugin-react, @wix/design-system, jest-environment-jsdom (+5 more)
...
Cohesion: 0.09
Nodes (35): ArtifactConfigurationActions(), ArtifactConfigurationActionsProps, ArtifactConfigurationActionsDriver, ArtifactConfigurationPage(), OverrideRadioCard(), OverrideRadioCardProps, OverridesSelectionForm(), OverridesSelectionFormProps (+27 more)

### Community 242 - "S3PublicationStorage"
Cohesion: 0.08
Nodes (29): artifactoryOptions(), artifactoryPublicUrl(), assertLease(), AtlasPublicationStorage, AtlasPublicationStorageSource, DeploymentLease, PublicationStorageDriver, STORAGE_ENVIRONMENT_KEYS (+21 more)

### Community 244 - "package.json"
Cohesion: 0.50
...
Cohesion: 0.29
Nodes (14): AtlasLoaderDependencies, defaultDependencies(), deploymentReferences(), loadDeployment(), loadInitialCatalog(), mapWithConcurrency(), publishRuntimeSnapshot(), startAtlasLoader() (+6 more)
...
Cohesion: 0.31
Nodes (3): adaptRules(), adaptShadowStyleSheet(), ShadowStylesDriver
...
Cohesion: 0.13
Nodes (8): SupportedFramework, frameworkLabel(), NxDevTargetOptions, displayTarget(), AtlasGenerateService, AtlasNxProjectType, AtlasWorkspace, AngularStylesheetFormat
...
Cohesion: 0.10
Nodes (17): 1. Generate, 2. Choose Where The App Appears, 3. Build Feature UI, 4. Run Inside Host, 5. Test And Continue, Build A React App, App assets, App Domain (+9 more)
...
Cohesion: 0.11
Nodes (38): DeploymentWrite, AtlasArtifactManifestBase, AtlasAppConfig, AtlasBaseConfig, AtlasRouteMount, AtlasSlotMount, AtlasWidgetConfig, AtlasAppDomIsolation (+30 more)

### Community 314 - "@angular/animations"
Cohesion: 0.16
Nodes (13): CliErrorDriver, ErrorScenario, actionableMessage(), AtlasError, AtlasErrorOptions, AtlasErrorSurface, ensureActionableError(), errorSummary() (+5 more)
...
### Community 318 - "@babel/plugin-syntax-jsx"
Cohesion: 0.18
Nodes (17): absolutizeUrls(), loadImport(), prepareShadowImports(), wrapImport(), acquireStylesheet(), AtlasStyleRelease, AtlasStylesheetLoadInput, AtlasStylesheetLoadOptions (+9 more)
...
### Community 325 - "route-matcher.ts"
Cohesion: 0.73
Nodes (5): MountStateRenderingOptions, prepareStatusElement(), renderErrorState(), renderHostMountState(), renderLoadingState()
...
## Knowledge Gaps
- **1660 isolated node(s):** `name`, `version`, `private`, `type`, `@atlas/bootstrap` (+1655 more)
...
- **Why does `createReactAppViteConfig()` connect `generate.service.ts` to `angular.ts`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `delay()` connect `lifecycle.ts` to `Zero to production`, `angular-widget.ts`, `create-manifest-from-config.ts`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
