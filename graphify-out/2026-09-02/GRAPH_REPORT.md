...
## Corpus Check
- 598 files · ~206,216 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5035 nodes · 9666 edges · 331 communities (262 shown, 69 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 148 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `533aafed`
...
## Communities (331 total, 69 thin omitted)
...
Cohesion: 0.07
Nodes (44): RetryDriver, isRetryableHttpStatus(), isTransientError(), RetryOptions, statusCode(), transientNetworkCode(), transientStatus(), wait() (+36 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.09
Nodes (36): withExponentialRetry(), AtlasArtifactPreviewState, AtlasPublicationLease, AtlasPublicationStorage, createPublicationStorage(), AtlasRegistryConfig, artifactPrefix(), assertExpectedRegistryRevision() (+28 more)
...
Cohesion: 0.07
Nodes (31): DomHostOptions, NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, AtlasHostRuntimeOptions, AtlasLoaderOptions, AtlasWidgetLoaderOptions, AtlasWidgetUiOptions (+23 more)
...
Cohesion: 0.18
Nodes (21): BrowserErrorContext, createBrowserError(), logBrowserError(), emitHostError(), emitHostReady(), emitHostStart(), emitMountState(), reportRetryFailure() (+13 more)
...
Cohesion: 0.14
Nodes (12): AtlasMountedApp, AtlasRuntimeController, createAppReadiness(), createLoadingEmitter(), createRuntimeMount(), navigationTargets(), placementKey(), startAtlasHostRuntime() (+4 more)

### Community 25 - "native-federation.ts"
Cohesion: 0.11
Nodes (17): renderLoading(), AtlasAppAssets, createAtlasAppAssetFacade(), AppAssetsDriver, resolveAssetUrl(), AtlasHostDataContext, AtlasRuntimeContext, AtlasSdk (+9 more)
...
Cohesion: 0.08
Nodes (26): ATLAS_BROWSER_LOADER, createBrowserAssetFiles(), ES_MODULE_SHIM, createAtlasBootstrapFiles(), withTrailingNewline(), createBootstrapHtml(), escapeHtml(), validateBootstrapHtml() (+18 more)
...
### Community 34 - "app.ts"
Cohesion: 0.15
Nodes (18): BrowserOverrideScopePicker(), BrowserOverrideScopePickerDriver, ScopePickerProps, OverridesContext, OverridesContextValue, SessionContext, SessionContextValue, clearAllOverridesInSession() (+10 more)
...
Cohesion: 0.12
Nodes (35): readPublishedCatalog(), assertDescriptorBytes(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl(), AtlasBrowserOverrideOptions (+27 more)
...
Cohesion: 0.11
Nodes (19): cliVersion(), configuredHostUrls(), previewSelector(), printVerificationCheck(), runAtlasCli(), runWorkspaceFreeCommand(), splitUrls(), verifyHostUrls() (+11 more)
...
### Community 41 - ".run"
Cohesion: 0.29
Nodes (9): createHostNavigationItems(), documentNavigationItems, normalizeRoutePath(), readAtlasNavigationItems(), routeMatches(), routePlacementsForHost(), subscribeAtlasNavigationItems(), uniqueRoutePlacements() (+1 more)

### Community 42 - "FailingMutableStorage"
Cohesion: 0.09
Nodes (40): SupportedFramework, asStringRecord(), DEPENDENCY_FIELDS, dependencyDeclared(), DependencyField, dependencyManifestPath(), existingFrameworkVersionInfo(), frameworkPrimaryDependency() (+32 more)
...
Cohesion: 0.19
Nodes (13): appendHostStylesheet(), defaultDependencies(), HostLoaderDriver, hasCompletedFederationBuild(), HostLoaderDependencies, installHostSharedDependencies(), loadHostModule(), loadHostStyles() (+5 more)
...
Cohesion: 0.26
Nodes (7): MountStateRenderingOptions, prepareStatusElement(), renderErrorState(), renderHostMountState(), renderLoadingState(), AtlasHostMountEvent, HostRuntimeDriver
...
Cohesion: 0.11
Nodes (30): createLoadedHost(), HostContext, HostContextValue, HostLoadResult, HostProvider(), readCachedHost(), OverridesProvider(), useSession() (+22 more)
...
Cohesion: 0.09
Nodes (35): mapWithConcurrency(), AtlasWidgetErrorRenderContext, AtlasWidgetRenderContext, createMountBoundary(), createRoutePlacementPlan(), createRouteTitleController(), createWidgetCard(), createWidgetLoader() (+27 more)
...
Cohesion: 0.06
Nodes (34): AngularWidgetRuntime, readWidgetRuntime(), AtlasEventBus, AtlasEventListener, AtlasEventMap, createAtlasEventBus(), EventKey, notifyListener() (+26 more)
...
Cohesion: 0.12
Nodes (13): ActiveWidget, AngularAtlasSdk, AngularGetWidgetOptions, AngularWidgetBinding, AngularWidgetOutletController, createAngularLoadingRenderer(), createWidgetBinding(), Directive (+5 more)
...
Cohesion: 0.36
Nodes (6): DevelopmentPortsDriver, PortScenario, hostClientPortFallback(), resolveHostDevPorts(), ResolveHostDevPortsOptions, HostDevPorts
...
Cohesion: 0.07
Nodes (20): AtlasNavigationItemsService, Injectable, AtlasNavigationTarget, AppNavigatorDriver, DomHostServices, DomRuntimeOptions, DomHostRuntimeInput, AtlasHostNavigationItem (+12 more)
...
Cohesion: 0.12
Nodes (27): completedProcessOutput(), writeDevOverrideDocument(), browserOpenCommand(), developmentPreviewUrl(), DevelopmentProcessDriver, RemoteEntryScenario, formatFrameworkServerError(), frameworkServerArguments() (+19 more)
...
Cohesion: 0.08
Nodes (30): createDomHostSdk(), anchorKey(), AtlasHostAnchorRegistry, AtlasHostUi, AtlasHostUiOptions, createHostUi(), renderDefaultError(), renderDefaultLoading() (+22 more)
...
Cohesion: 0.07
Nodes (39): ArtifactConfigurationActions(), ArtifactConfigurationActionsProps, ArtifactConfigurationActionsDriver, ArtifactConfigurationPage(), OverrideRadioCard(), OverrideRadioCardProps, OverridesSelectionForm(), OverridesSelectionFormProps (+31 more)
...
Cohesion: 0.29
Nodes (10): assertDescriptor(), artifactUrl(), assertAtlasRuntimeConfig(), assertDevelopmentSessionUrl(), assertOptionalInteger(), assertRegistryUrl(), assertSegment(), environmentManifestUrl() (+2 more)
...
Cohesion: 0.23
Nodes (11): addNavigationState(), createAppNavigator(), runtimeError(), RuntimeErrorOptions, assertWidgetId(), createRegistryWidgetResolver(), catalog(), host() (+3 more)
...
Cohesion: 0.11
Nodes (38): artifactRegistryRoot(), assertDescriptor(), createLocalOverrides(), Descriptor, manifest(), fetchManifestReference(), fetchWithTimeout(), HostDeployment (+30 more)
...
Cohesion: 0.28
Nodes (14): reference(), AtlasLoaderDependencies, defaultDependencies(), deploymentReferences(), loadDeployment(), loadInitialCatalog(), mapWithConcurrency(), publishRuntimeSnapshot() (+6 more)
...
Cohesion: 0.10
Nodes (23): assertLease(), AtlasPublicationStorageSource, DeploymentLease, PublicationStorageDriver, encodeLease(), environmentBoolean(), environmentS3LockMode(), errorName() (+15 more)
...
Cohesion: 0.05
Nodes (21): CliArguments, AtlasDeployResult, appManifest(), collect(), DeployServiceDriver, digest(), file(), hostManifest() (+13 more)
...
Cohesion: 0.11
Nodes (6): AtlasBootstrapServiceOptions, AtlasGenerateService, availableAppsMessage(), AtlasNxProjectType, AtlasWorkspace, AngularStylesheetFormat
...
### Community 294 - "@angular-architects/native-federation"
Cohesion: 0.67
...
Cohesion: 0.08
Nodes (48): DeploymentWrite, ResolveHostDevTargetOptions, AtlasResolvedRelease, RoutePlacement, RuntimeMount, RuntimePlacement, AtlasArtifactManifestBase, AtlasAppConfig (+40 more)

### Community 315 - "create-manifest-from-config.ts"
Cohesion: 0.26
Nodes (8): AtlasPublicationListedObject, createManifestFromConfig(), identifierFromRoute(), identifierFromSlot(), placements(), routePlacementId(), slotPlacementId(), supportedHosts()
...
## Knowledge Gaps
- **1604 isolated node(s):** `name`, `version`, `private`, `type`, `@atlas/bootstrap` (+1599 more)
...
- `AtlasDevService` (2× useful, score=0.739013267)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `reference()` connect `@types/babel__core` to `atlas-manifest.ts`, `Atlas Overview`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `AtlasManifest` connect `AtlasNavigation` to `loader.specs.ts`, `.run`, `verify.service.ts`, `AtlasRuntimeController`, `extension.specs.ts`, `remote-assets.ts`, `create-manifest-from-config.ts`, `cli.service.ts`, `Registry and storage reference`, `process.ts`, `manifest-utils.ts`, `create-manifest-from-config-input.ts`, `runtime-discovery.ts`, `bootstrap`, `angular-host-navigation.ts`, `AngularWidgetOutletController`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `assertHostDeploymentManifest()` connect `Atlas Overview` to `@types/babel__core`, `loader.specs.ts`, `create-manifest-from-config-input.ts`?**
