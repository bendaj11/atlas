# Graph Report - atlas  (2026-09-25)

## Corpus Check
- 1374 files · ~355,860 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7157 nodes · 16621 edges · 403 communities (331 shown, 72 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 152 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1246c681`
...
- static-server.ts
- BrowserOverrideScopePicker.driver.tsx
- ports.ts
- computeSha256Digest
- App.driver.tsx
- Atlas CLI user experience
...
2. `ArtifactVersion` - 51 edges
3. `AtlasSdk` - 51 edges
4. `CliArguments` - 45 edges
...
- `WorkspaceCommandContext` --references--> `AtlasPrompter`  [EXTRACTED]
  packages/cli/src/cli/workspace-commands/workspace-commands.ts → packages/cli/src/shared/ui/ui.ts
...
## Communities (403 total, 72 thin omitted)
...
Cohesion: 0.11
Nodes (20): AtlasAppMountRequest, AtlasAppMountResult, AtlasExportedWidgetMountResult, createRoutedApp(), CreateRoutedAppDriver, defineApp(), DefineAppDriver, defineExportedWidget() (+12 more)

### Community 2 - "AtlasManifest"
Cohesion: 0.05
Nodes (65): fetchDevelopmentSession(), loadForTab(), previewIdentity(), AtlasBootstrapSignatureDriver, hasAtlasBootstrapSignature(), artifactRegistry, countStoredOverrides(), darkColorScheme (+57 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.06
Nodes (40): appendNavigationStateToPath(), createAppNavigator(), AppNavigatorDriver, AtlasNavigationTarget, NavigateToApp, SdkProviders, collectVisibleRoutePlacementsForHost(), AtlasDuplicateRouteError (+32 more)

### Community 4 - "workspace.ts"
Cohesion: 0.06
Nodes (21): AngularHostNavigationDriver, createLocationStrategy(), notifyPopStateListeners(), AngularNavigateByUrlOptions, LocationBack, LocationHistoryGo, LocationLike, LocationStrategyAdapter (+13 more)
...
Cohesion: 0.14
Nodes (19): lastModified(), groupObjectsByGeneration(), isExpiredGeneration(), pruneUnreferencedPreviewGenerations(), prunePreviewsOnce(), removeClosedPreviews(), removePreviewOnce(), requireRegistry() (+11 more)
...
Cohesion: 0.10
Nodes (24): createAtlasHostDataSignal(), injectAtlasSdk(), createAngularAtlasSdk(), CreateAngularAtlasSdkInput, AngularAtlasSdkDriver, WidgetInputs, AngularLoadingRendererRequest, createAngularLoadingRenderer() (+16 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.19
Nodes (18): PreviewPruningDriver, isRegistryReferencing(), aRegistryWith(), createManifestDescriptor(), encodeManifestBytes(), isSameDescriptor(), computeRegistryRevision(), sortJsonKeys() (+10 more)
...
Cohesion: 0.11
Nodes (25): buildDevelopmentBridgeMarkerSelector(), createBrowserBridgeDependencies(), DevelopmentSessionDriver, matchDevelopmentSessionResponse(), requestDevelopmentSession(), DevelopmentSessionBridgeDependencies, applyOverrides(), applyOverridesDocument (+17 more)
...
Cohesion: 0.06
Nodes (36): createWidgetRenderContext(), WidgetLoaderDriver, WidgetProps, AtlasResolvedWidget, AtlasWidgetErrorRenderContext, AtlasWidgetRenderContext, AtlasWidgetResolver, DisposeRenderer (+28 more)

### Community 20 - "AtlasNavigation"
Cohesion: 0.09
Nodes (71): collectAtlasHostCatalogIssues(), validateAppManifestList(), collectAtlasHostManifestIssues(), collectAtlasManifestIssues(), PlacementUniqueness, validateExportedWidget(), validateExportedWidgets(), validateExposes() (+63 more)

### Community 21 - "dev.service.ts"
Cohesion: 0.12
Nodes (18): PortsDriver, anAppConfigSource(), GenerateServiceDriver, WidgetAppsDriver, CommandsDriver, MANAGERS, TURBO_BYPASSED_TASKS, compileAtlasConfig() (+10 more)

### Community 22 - "manifest-utils.ts"
Cohesion: 0.08
Nodes (52): SelectedAppRelease, AngularLocalRuntimeDriver, AtlasAppConfig, AtlasBaseConfig, AtlasRouteMount, AtlasSlotMount, AtlasWidgetConfig, AtlasHostManifest (+44 more)
...
Cohesion: 0.11
Nodes (24): doesRouteMatchPath(), doesSupportAnyHost(), DevelopmentConfigDriver, listConfiguredHostIds(), listRoutePaths(), parsePort(), pickFirstRecordValue(), readAngularProjectPort() (+16 more)

### Community 25 - "native-federation.ts"
Cohesion: 0.07
Nodes (35): ATLAS_HOST_FILES, ATLAS_INTEGRATION_FILES, DELEGATED_APP_FILES, DELEGATED_HOST_FILES, OverlayDriver, generatedOverlay(), isAngularStylesheet(), alignDelegatedAngularFederationConfig (+27 more)
...
Cohesion: 0.06
Nodes (28): AssertAtlasHostCatalogDriver, ValidateAtlasHostCatalogDriver, validateAtlasHostCatalog(), AtlasValidationError, AtlasValidationErrorDriver, formatAtlasValidationMessage(), AtlasValidationIssue, AssertAtlasHostManifestDriver (+20 more)
...
### Community 34 - "app.ts"
Cohesion: 0.14
Nodes (18): AtlasUnsubscribe, ReactHostNavigationDriver, connectRouter(), createRouterOptions(), ReactRouterDriver, MemoryRouterOptions, pushRouterUrlToHost(), readAtlasInnerUrl() (+10 more)
...
Cohesion: 0.08
Nodes (36): createBrowserAtlasLoaderDependencies(), loadStartupCatalog, publishRuntimeSnapshot, startAtlasLoader(), AtlasLoaderDependencies, LoaderContext, LoaderDocument, collectDeploymentManifestReferences() (+28 more)

### Community 38 - "index.ts"
Cohesion: 0.09
Nodes (37): assertAtlasHostCatalog(), assertAtlasHostManifest(), assertAtlasManifest(), assertReleaseVersion(), validateReleaseVersion(), assertSafeArtifactId(), assertSafeRelativePath(), assertEnvironmentDeployment() (+29 more)
...
Cohesion: 0.08
Nodes (35): createAtlasEventBus(), AtlasEventBus, AtlasEventListener, AtlasEventMap, EventKey, PayloadEventKey, PayloadlessEventKey, StoredEventListener (+27 more)
...
Cohesion: 0.09
Nodes (33): DomHostCustomizationOptions, DomSdkOptions, AtlasDefaultHostLayout(), AtlasHostAnchorsContext, AtlasHostLayout(), AtlasHostProvider(), AtlasHostStatus(), AtlasNavigation() (+25 more)
...
Cohesion: 0.06
Nodes (60): SdkProviderInput, AnchorsListener, AtlasHostRuntimeOptions, AtlasMountedApp, PublishActiveLayout, ReportMountStateChange, ResolvePlacementContainer, RoutePlacementPlan (+52 more)

### Community 47 - "publication-storage.ts"
Cohesion: 0.09
Nodes (25): bootstrap(), compileConfig(), develop(), generate(), publish(), resolveProjectArgument(), runWorkspaceCommand(), WorkspaceCommandContext (+17 more)
...
Cohesion: 0.06
Nodes (67): GeneratorOptionOverrides, doesPathExist(), captureProcessOutput(), CliProcessDriver, forwardAndCaptureOutput(), ProcessCommand, processOutput, processOutputClosed (+59 more)
...
Cohesion: 0.05
Nodes (73): WINDOW_EVENTS, aHostData(), findAtlasHostTabMock, readPageStateFromHostTabMock, reloadHostTabMock, Scope, HostData, HostPageState (+65 more)

### Community 52 - "content-script.ts"
Cohesion: 0.12
Nodes (14): buildBrowserOpenCommand(), DevelopmentProcessDriver, FakeChildProcess, linkedResult, spawn, warning, formatFrameworkServerError(), isRemoteEntryReady() (+6 more)
...
Cohesion: 0.09
Nodes (14): ArtifactoryOptions, ArtifactoryPublicationStorage, ArtifactoryStorageClient, assertReplaceCondition(), collectBody(), ArtifactoryStorageDriver, PublicationStorageDriver, STORAGE_ENVIRONMENT_KEYS (+6 more)

### Community 55 - "types.ts"
Cohesion: 0.07
Nodes (55): AngularGenerationDriver, BUILD_NOTIFICATIONS, addUniquePolyfill(), AngularRunnerKey, configureAngularBuildNotifications(), configureAngularDevelopmentTargets(), enableAngularBuildNotifications(), ensureAngularFederationPolyfills() (+47 more)
...
Cohesion: 0.11
Nodes (28): assertOverrideMatchesManifest(), assertOverrideDocumentTargetsHost(), OverridesDriver, isOverrideDocumentShape(), isOverrideEntryShape(), isRecord(), loadBrowserRuntimeOverrides(), parseDevelopmentOffersFromValue() (+20 more)

### Community 64 - "DirectoryPublicationStorage"
Cohesion: 0.08
Nodes (22): assertHostConfig(), AtlasBootstrapService, bootstrapDigest(), defaultDependencies, AtlasBootstrapServiceDriver, BuildSetup, BootstrapTemplateDependencies, defaultDependencies (+14 more)
...
Cohesion: 0.06
Nodes (39): AtlasAnchorComponent, AtlasAngularHostAnchors, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot, AnchorsRoot (+31 more)

### Community 77 - "devDependencies"
Cohesion: 0.09
Nodes (22): isValidTcpPort(), listConfiguredDevServerPorts(), listJsonDevServerPorts(), listNestedRecords(), listNxTargetPorts(), listProjectDevServerPorts(), listViteDevServerPorts(), parseValidPorts() (+14 more)
...
Cohesion: 0.07
Nodes (23): DomHostDriver, AtlasAppLoadError, AtlasHostRetryError, AtlasHostStartError, AtlasSlotNameMissingError, buildDefaultManifestUrl(), DomHostRuntimeDriver, findOrCreateSlotMountContainer() (+15 more)
...
Cohesion: 0.06
Nodes (63): App(), ArtifactOverrideEditorPage(), initialOverrideSelection(), ArtifactOverrideLocationState, isArtifactOverrideLocationState(), useArtifactOverrideOptions(), artifactVersionFromSelection(), useHostArtifactVersionQuery() (+55 more)
...
Cohesion: 0.18
Nodes (16): optionalRecord(), VerifiedManifest, verifyAsset(), verifyExposes(), verifyFederationReferences(), FederationMetadata, parseFederationMetadata(), checkContentType() (+8 more)
...
Cohesion: 0.12
Nodes (15): action, chrome, InjectionResult, onRemoved, onUpdated, runtime, runtime.onInstalled, runtime.onMessage (+7 more)
...
Cohesion: 0.21
Nodes (19): findAtlasHostTab(), findLocalPreview(), firstInspectable(), HostTab, inspectTab(), isHostTab(), LoadArtifactVersionFromHostTabOptions, localPreviewTabs() (+11 more)
...
Cohesion: 0.07
Nodes (28): readCliVersion(), runAtlasCli(), VERSION_ARGUMENTS, HttpDriver, info, formatHelp(), ActiveStep, ATLAS_LOGO (+20 more)
...
Cohesion: 0.05
Nodes (56): AngularAdapterDriver, EagerSdkHostRoot, HostRoot, HostSdk, startDomHost, StartDomHostForHostSdk, Component, DomHostSdkDriver (+48 more)
...
Cohesion: 0.05
Nodes (61): persistOverrides(), addWindowListener, artifactRegistry, DevelopmentSessionDocument, fetch, inspectAtlasHost, readRuntimeErrors, readVisibleAppIds (+53 more)
...
Cohesion: 0.06
Nodes (38): ProvideAtlasAppDriver, RecordingStylesHost, AngularLocationStrategyDriver, AtlasAppContext, GoThroughHistoryDriver, goThroughHistory(), appendQueryValueToEntry(), ParseQueryDriver (+30 more)

### Community 129 - "Angular Generators"
Cohesion: 0.06
Nodes (61): ArtifactOverrideEditorPageDriver, useArtifactOverrideOptions, HOST_CHANNELS, NOT_ERROR_OVERRIDE_STATUSES, UseArtifactOverrideOptionsDriver, UseHostArtifactVersionQueryDriver, HostArtifactVersionQueryOptions, HOST_SELECTION_TYPES (+53 more)
...
Cohesion: 0.36
Nodes (6): convertIdToPascalCase(), TextDriver, deriveWidgetComponentName(), generateWidgetFilesForFramework(), renderAngularWidgetConfig(), renderWidgetAtlasConfig()
...
Cohesion: 0.23
Nodes (7): AtlasLoaderDriver, HostEntry, HostModule, HostMountRequest, ModuleShimDriver, ImportShim, ModuleShimGlobal
...
Cohesion: 0.07
Nodes (47): emitHostError(), emitHostReady(), emitHostStart(), emitMountState(), startDomHost(), AtlasHostMountState, AngularLocalManifest, prepareAngularLocalRuntime() (+39 more)

### Community 139 - "devDependencies"
Cohesion: 0.10
Nodes (23): createExportedWidget(), CounterWidget, CreateExportedWidgetDriver, Component, Input, WidgetProps, forwardChangedInputs(), AppBootstrap (+15 more)
...
Cohesion: 0.21
Nodes (15): extractErrorMessage(), parseAbsoluteHttpUrl(), verifyManifestAssets(), isHostDeployment(), verifyCatalog(), verifyCatalogHost(), verifyRouteOwnership(), verifySelectedVersions() (+7 more)
...
Cohesion: 0.12
Nodes (27): ArtifactoryClient, ArtifactoryClientDriver, TransportFailureDetails, ArtifactoryHttpStatusError, ArtifactoryTransportError, ArtifactoryUnknownMutationOutcomeError, extractTransportFailureCode(), isSyntaxError() (+19 more)
...
Cohesion: 0.07
Nodes (27): AngularWidgetOutletControllerDriver, HandleWidgetError, Component, WidgetInputs, WidgetSkeleton, WidgetBindingRuntime, AtlasHostData, AtlasHostDataOf (+19 more)
...
Cohesion: 0.05
Nodes (24): AtlasHostProviderMissingError, AtlasSdkNotReadyError, AtlasAppRouteNotFoundError, AtlasAppMountExportMissingError, AtlasCatalogHostMismatchError, AtlasCatalogSelectionError, AtlasOverrideError, AtlasRemoteTrustError (+16 more)
...
Cohesion: 0.33
Nodes (5): LocalOverrideDriver, FederationMetadata, isFederationMetadata(), remoteEntryFailure(), validateLocalOverride()
...
Cohesion: 0.19
Nodes (15): usesNativeFederationV4ConfigApi(), convertNameToFederationRemoteName(), AngularFederationConfigOptions, AngularWorkspaceDocumentOptions, buildAngularWorkspaceDocument(), AngularWorkspaceGeneratorDriver, renderAngularFederationConfig(), selectAngularFederationConfigFileName() (+7 more)
...
Cohesion: 0.08
Nodes (35): FrameworkVersionInfo, defaultIgnoreFileDependencies, GeneratedFilesDriver, ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS, hasAtlasIgnorePattern(), IgnoreFileDependencies, isContainedBy() (+27 more)

### Community 208 - "repository"
Cohesion: 0.07
Nodes (26): BackgroundDriver, clearHostDataCache, fetch, focusPreviewTab, loadDevelopmentSession, BadgeScriptDriver, addWindowListener, DevelopmentSessionContentDriver (+18 more)
...
Cohesion: 0.06
Nodes (42): COMMAND_HELP, DEVELOPMENT_HELP, GENERATION_HELP, PUBLICATION_HELP, ROOT_COMMANDS, ROOT_EXAMPLES, CommandHelp, HelpEntry (+34 more)
...
Cohesion: 0.07
Nodes (56): AdapterOnlyOptionName, createDomHostSdk(), createSdkProviders(), pickHostDefinedSdkProperties(), RUNTIME_ONLY_OPTIONS, RuntimeOnlyOptionName, assertManifestSupportsHost(), indexManifestsById() (+48 more)
...
Cohesion: 0.19
Nodes (15): readArtifactoryOptionsFromEnvironment(), resolveArtifactoryPublicUrl(), createPublicationStorage(), createStorageFromEnvironment(), DEFAULT_FACTORIES, PublicationStorageFactories, ENVIRONMENT_KEYS, StorageEnvironmentDriver (+7 more)
...
Cohesion: 0.17
Nodes (12): BootstrapServerDriver, nonInteractivePrompter, AngularBuildPrivateApi, ProxyConfigDriver, loadAngularHostProxy(), DevPrompts, DevTarget, HostDevTarget (+4 more)
...
Cohesion: 0.21
Nodes (12): ArtifactResolutionDriver, findArtifactsMatching(), resolveRegistryArtifact(), resolveRelease(), StaticRegistryDriver, AtlasRegistryMutation, AtlasResolvedArtifact, AtlasResolvedRelease (+4 more)
...
Cohesion: 0.20
Nodes (13): assertPreviewNumber(), assertStaticRegistry(), assertUniqueArtifactIdentifiers(), StaticRegistryValidationDriver, isSha256Digest(), readArtifactCollection(), readDescriptorMap(), readRegistryArtifact() (+5 more)
...
Cohesion: 0.16
Nodes (18): ANGULAR_HOST_PATHS, ANGULAR_ROUTED_APP_PATHS, ANGULAR_SINGLE_PAGE_APP_PATHS, REACT_HOST_PATHS, REACT_ROUTED_APP_PATHS, REACT_SINGLE_PAGE_APP_PATHS, ReactViteGeneratorDriver, AtlasConfigDriver (+10 more)
...
Cohesion: 0.21
Nodes (4): AtlasVerificationCheck, AtlasVerificationStatus, ChecksDriver, VerificationChecks
...
Cohesion: 0.07
Nodes (22): assertLease(), createExternalPublicationLease(), DeploymentLease, requiredEtag(), S3DeploymentLock, S3LeaseOptions, StoredLease, S3ErrorsDriver (+14 more)
...
Cohesion: 0.13
Nodes (32): applySelection(), buildHostDeploymentManifest(), buildHostDeploymentManifests(), computeRevisionOf(), doesAppTargetHost(), findReleaseDescriptor(), listDeploymentPaths(), planDeployment() (+24 more)
...
### Community 366 - "@angular/animations"
Cohesion: 0.25
Nodes (9): buildLocalOrigin(), closeServer(), assertLocalPreviewPort(), AtlasDevService, DevSessionRuntime, FRAMEWORK_LABELS, resolveFrameworkDevTask(), runDevSession() (+1 more)

### Community 367 - "bootstrap.ts"
Cohesion: 0.22
Nodes (5): AppComponent, Component, mount, HostWidgets, Component

### Community 369 - "validate-host-deployment-manifest.ts"
Cohesion: 0.26
Nodes (10): assertHostDeploymentManifest(), collectHostDeploymentManifestIssues(), ValidateHostDeploymentManifestDriver, validateHostDeploymentManifest(), validateManifestReference(), validateManifestReferences(), assertManifestDescriptor(), ValidateManifestDescriptorDriver (+2 more)

### Community 370 - "registry-config.ts"
Cohesion: 0.23
Nodes (8): isPublicationStorage(), compileConfig(), RegistryConfigDriver, isRegistryConfig(), loadAtlasRegistryConfig(), CliError, formatTypeScriptDiagnostics(), loadTypeScript()
...
Cohesion: 0.35
Nodes (10): collectConfiguredHostUrls(), printVerificationCheck(), splitUrlList(), verifyHostUrls(), deploy(), parsePreviewSelector(), prunePreviews(), removePreview() (+2 more)

### Community 374 - "http.ts"
Cohesion: 0.48
Nodes (8): startOrJoinControlServer(), joinControlServer(), startOwnedControlServer(), deleteJson(), fetchFromControlServer(), isAddressInUse(), postJson(), StartControlServerOptions

### Community 375 - "process.ts"
Cohesion: 0.09
Nodes (20): UseArtifactsDriver, ColumbusStateDriver, loadColumbusState, ColumbusStateQueryDriver, loadColumbusState, HostDriver, loadColumbusState, ColumbusStateValue (+12 more)

### Community 376 - "AtlasDevOverrideDocument"
Cohesion: 0.27
...
### Community 380 - "session-runner.driver.ts"
Cohesion: 0.20
...
### Community 383 - "match-route-pattern.ts"
Cohesion: 0.33
...
### Community 385 - "BrowserOverrideScopePicker.driver.tsx"
Cohesion: 0.36
Nodes (5): BrowserOverrideScopePicker(), BrowserOverrideScopePickerDriver, ScopePickerProps, ScopePickerProps, isScope()

### Community 386 - "ports.ts"
Cohesion: 0.36
Nodes (5): DevelopmentPortsDriver, resolveHostClientPortFallback(), resolveHostDevPorts(), ResolveHostDevPortsOptions, HostDevPorts

### Community 387 - "computeSha256Digest"
Cohesion: 0.46
Nodes (5): computeSha256Digest(), computeSha256Integrity(), convertDigestToIntegrity(), DigestDriver, Sha256Digest

### Community 388 - "App.driver.tsx"
Cohesion: 0.38
...
### Community 392 - "scope-app-path-to-host.driver.ts"
Cohesion: 0.50
...
## Knowledge Gaps
- **1957 isolated node(s):** `Output contract`, `Command inventory`, `Prompts`, `Color and accessibility`, `Design references` (+1952 more)
...
- `AtlasDevService` (2× useful, score=0.424633494) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `AtlasProgressReporter` connect `publication-storage.ts` to `dependencies.ts`, `MemoryPublicationStorage`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `useColumbusState()` connect `help.ts` to `Angular Generators`, `process.ts`, `publication-storage.ts`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `loadBrowserRuntimeOverrides()` connect `deploy.service.driver.ts` to `AtlasManifest`, `angular-widget.ts`, `extension.specs.ts`, `sdk-factory.ts`, `engines`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **What connects `Output contract`, `Command inventory`, `Prompts` to the rest of the system?**
