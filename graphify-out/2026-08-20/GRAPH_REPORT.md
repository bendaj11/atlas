...
## Corpus Check
- 543 files · ~187,286 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4760 nodes · 8833 edges · 315 communities (248 shown, 67 thin omitted)
...
Cohesion: 0.09
Nodes (34): artifactDirectoryUrl(), createNativeFederationImporters(), createTrustedNativeFederationImporters(), federationOptions(), FederationRemote, federationRemoteName(), fetchRemoteBytes(), hasMountFunction() (+26 more)
...
Cohesion: 0.09
Nodes (21): AppBootstrap, createExportedWidget(), defineExportedWidget(), ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk, AtlasSdkFactory, createAtlasHostDataSignal() (+13 more)
...
Cohesion: 0.13
Nodes (21): createControlRequestHandler(), joinControlServer(), pathSegment(), readProductionCatalog(), registerOverride(), respondWithCatalog(), respondWithSession(), respondWithVersionIndex() (+13 more)

### Community 8 - "package.json"
Cohesion: 0.11
Nodes (19): @atlas/generators, @aws-sdk/client-s3, @inquirer/select, dependencies, @atlas/bootstrap, @atlas/generators, @atlas/runtime, @atlas/schema (+11 more)
...
Cohesion: 0.08
Nodes (44): mapWithConcurrency(), AtlasHostMountState, AtlasHostRuntimeOptions, AtlasLoaderOptions, createMountBoundary(), createRoutePlacementPlan(), createRouteTitleController(), createWidgetCard() (+36 more)
...
Cohesion: 0.09
Nodes (12): AtlasBootstrapService, AtlasBootstrapServiceOptions, bootstrapDigest(), CliArguments, SupportedFramework, frameworkLabel(), displayTarget(), suggestedDevServerPort() (+4 more)
...
Cohesion: 0.13
Nodes (23): completedProcessOutput(), localOrigin(), writeDevOverrideDocument(), browserOpenCommand(), DevelopmentProcessDriver, RemoteEntryScenario, formatFrameworkServerError(), frameworkServerArguments() (+15 more)
...
Cohesion: 0.13
Nodes (24): BrowserErrorContext, createBrowserError(), logBrowserError(), emitHostError(), emitHostReady(), emitHostStart(), emitMountState(), reportRetryFailure() (+16 more)
...
Cohesion: 0.11
Nodes (14): AtlasAppMountResult, AtlasExportedWidgetMountResult, AppOptions, renderWithAtlasProviders(), RootAdapter, AtlasRuntimeContext, AtlasSdkProvider(), AppRouterLike (+6 more)
...
Cohesion: 0.12
Nodes (24): AtlasPublicationStorageSource, isPublicationStorage(), AtlasPublishConfig, AtlasPullRequestLookup, AtlasPullRequestResolver, AtlasPullRequestStatus, compilePublishConfig(), defineAtlasPublishConfig() (+16 more)
...
Cohesion: 0.11
Nodes (13): AtlasInvocation, InteractionDriver, InteractionScenario, resolveInvocation(), PromptTestDouble, title(), AtlasPrompter, ATLAS_HOST_FILES (+5 more)
...
Cohesion: 0.10
Nodes (28): AngularWidgetRuntime, AtlasFetchHttpClient, HttpClientInput, HttpRequest, HttpRequestOptions, HttpRequestWithBody, HttpRequestWithBodyAndMethod, HttpRequestWithoutBody (+20 more)
...
Cohesion: 0.10
Nodes (18): BrowserWindowLike, createBrowserNavigation(), appendQueryValue(), matchRoutePart(), matchRoutePattern(), normalizePath(), parseQuery(), scopePath() (+10 more)
...
Cohesion: 0.12
Nodes (24): createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, AtlasWidgetLoaderOptions, AtlasRemoteTrustPolicy, acquireStylesheet() (+16 more)

### Community 159 - "overlay.ts"
Cohesion: 0.20
Nodes (14): assertAtlasManifest(), createManifestFromConfig(), identifierFromRoute(), identifierFromSlot(), placements(), routePlacementId(), slotPlacementId(), supportedHosts() (+6 more)
...
Cohesion: 0.09
Nodes (24): AtlasNavigationItemsService, Injectable, addNavigationState(), AtlasNavigationTarget, createAppNavigator(), AppNavigatorDriver, DomRuntimeOptions, prepareStatusElement() (+16 more)
...
Cohesion: 0.19
Nodes (16): assertRegistry(), AtlasResolvedWidget, compareNewestFirst(), fetchRegistry(), indexWidgets(), isRecord(), LazyRegistry, matchesSelection() (+8 more)
...
Cohesion: 0.09
Nodes (15): RoutePlacement, AtlasWidgetErrorRenderContext, AtlasWidgetRenderContext, MountedWidgetState, RuntimeMount, RuntimePlacement, AtlasNativeFederationImporters, AtlasManifest (+7 more)
...
- **Why does `AtlasManifest` connect `AtlasNativeFederationImporters` to `ArtifactConfigurationPage.tsx`, `AtlasManifest`, `Angular Generators`, `build.driver.ts`, `verify.service.ts`, `verify-generated-projects.js`, `background.ts`, `remote-assets.ts`, `cli.service.ts`, `Workspace integration`, `react.ts`, `runtime-discovery.ts`, `ArtifactsOverridesTable.tsx`, `React SDK`, `overlay.ts`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `HostLoaderDriver` connect `native-federation.ts` to `ArtifactsOverridesTable.tsx`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **Why does `fetchJson()` connect `index.ts` to `ArtifactsOverridesTable.tsx`, `loader.specs.ts`?**
