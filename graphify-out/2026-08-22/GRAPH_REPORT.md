# Graph Report - atlas  (2026-08-22)

## Corpus Check
- 557 files · ~202,109 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4889 nodes · 9370 edges · 320 communities (253 shown, 67 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 136 edges (avg confidence: 0.73)
...
Cohesion: 0.07
Nodes (47): AtlasNavigationItemsService, Injectable, BrowserErrorContext, createBrowserError(), logBrowserError(), emitHostError(), emitHostReady(), emitHostStart() (+39 more)
...
Cohesion: 0.05
Nodes (45): createRouteTitleController(), createWidgetLoader(), defaultManifestTrustPolicy(), createDeferred(), createHostCatalog(), createRouteManifest(), createRoutePlacement(), createSlotManifest() (+37 more)
...
Cohesion: 0.17
Nodes (28): registryRoot(), resolveSourceIdentifier(), artifactKind(), assertDeploymentSelections(), assertDescriptorMap(), assertEnvironmentName(), assertRegistryContents(), assertStaticRegistry() (+20 more)

### Community 6 - "overlay-controller.ts"
Cohesion: 0.06
Nodes (17): collect(), MemoryDeployStorage, StoredObject, AtlasPublicationBody, AtlasPublicationListedObject, AtlasPublicationObjectMetadata, AtlasPublicationReplaceCondition, AtlasPublishResult (+9 more)

### Community 7 - "index.ts"
Cohesion: 0.13
Nodes (20): createControlRequestHandler(), joinControlServer(), pathSegment(), registerOverride(), respondWithDevelopmentSession(), respondWithSession(), setControlHeaders(), startControlServer() (+12 more)
...
Cohesion: 0.09
Nodes (37): absoluteHttpUrl(), asRecord(), AssetExpectation, AtlasVerificationReport, AtlasVerificationStatus, AtlasVerifyOptions, AtlasVerifyService, createReport() (+29 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.10
Nodes (35): withLease(), AtlasPublicationLease, AtlasPublicationStorageSource, createPublicationStorage(), isPublicationStorage(), AtlasPreviewHeadLookup, AtlasPreviewHeadResolver, AtlasRegistryConfig (+27 more)
...
Cohesion: 0.09
Nodes (48): readPublishedCatalog(), mapWithConcurrency(), resolveHostConfig(), assertDescriptorBytes(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost() (+40 more)
...
Cohesion: 0.13
Nodes (13): AtlasHostDriver, MockTab, storageArea(), clearHostDataCache(), HostDataSnapshot, isExtensionPage(), isHostDataSnapshot(), readHostDataCache() (+5 more)
...
Cohesion: 0.13
Nodes (9): AngularLiveDevelopmentDriver, SOURCE_PATH, stopLiveApp(), waitForLiveApp(), delay(), cases, LocalDevelopmentCase, stopAtlasDev() (+1 more)

### Community 37 - "atlas-host.ts"
Cohesion: 0.12
Nodes (34): createOverrideDocument(), disabledOverridesKey(), DisabledOverrideStorageLocation, findAtlasHostTab(), hasTabId(), InspectableTab, inspectTab(), isExtensionPage() (+26 more)
...
Cohesion: 0.15
Nodes (9): AtlasEventBus, AtlasEventListener, createAtlasEventBus(), EventKey, notifyListener(), PayloadEventKey, PayloadlessEventKey, StoredEventListener (+1 more)
...
Cohesion: 0.11
Nodes (6): AtlasBootstrapServiceOptions, AtlasPrompter, AtlasGenerateService, availableAppsMessage(), AtlasNxProjectType, AtlasWorkspace
...
Cohesion: 0.11
Nodes (18): AtlasDeploymentConvergenceError, AtlasDeployResult, AtlasDeployService, APP_ENTRY, appManifest(), bytesResponse(), CrossRegistryTransfer, DeployServiceDriver (+10 more)
...
Cohesion: 0.08
Nodes (46): ProcessCommand, asDependencyMap(), AtlasPackageManager, AtlasTask, AtlasWorkspaceKind, configuredNxOutputPaths(), createFormatGeneratedCommand(), createInstallCommand() (+38 more)
...
Cohesion: 0.10
Nodes (23): CONTENT_TYPES, publicationContentType(), assertLease(), DeploymentLease, PublicationStorageDriver, encodeLease(), environmentBoolean(), environmentS3LockMode() (+15 more)

### Community 63 - "navigation-types.ts"
Cohesion: 0.12
Nodes (24): completedProcessOutput(), localOrigin(), writeDevOverrideDocument(), browserOpenCommand(), DevelopmentProcessDriver, RemoteEntryScenario, formatFrameworkServerError(), frameworkServerArguments() (+16 more)
...
### Community 70 - "nx.ts"
Cohesion: 0.12
Nodes (28): addUniqueString(), alignDelegatedAngularFederationConfig(), angularNativeFederationBuilder(), asObject(), atlasConfigNxTarget(), collectNxPathValues(), commandValues(), declaresAtlasConfigOutput() (+20 more)
...
Cohesion: 0.18
Nodes (13): findRoutePlacement(), normalizePath(), routeMatches(), segments(), AtlasAppConfig, AtlasBaseConfig, AtlasHostConfig, AtlasRouteMount (+5 more)
...
Cohesion: 0.10
Nodes (31): AngularLocalManifest, AngularLocalRuntimeDriver, prepareAngularLocalRuntime(), artifactDirectoryUrl(), AtlasFederationAdapter, createNativeFederationImporters(), createTrustedNativeFederationImporters(), FederationRemote (+23 more)
...
Cohesion: 0.07
Nodes (29): AtlasBootstrapService, bootstrapDigest(), CliArguments, cliVersion(), configuredRuntimeUrls(), previewSelector(), printVerificationCheck(), runAtlasCli() (+21 more)
...
Cohesion: 0.03
Nodes (79): AngularHostSdkReference, AngularHostStartServices, renderLoading(), ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk, AtlasSdkFactory, createAtlasHostDataSignal() (+71 more)
...
Cohesion: 0.10
Nodes (16): App Domain, Consumer Testing, Deployment Domain, Host Domain, Local Integration, What To Test, 1. Generate, 2. Declare Placement (+8 more)
...
Cohesion: 0.06
Nodes (24): AppBootstrap, createExportedWidget(), defineExportedWidget(), AtlasAppContext, AtlasAppEntry, AtlasAppMountRequest, AtlasAppMountResult, AtlasExportedWidgetMountRequest (+16 more)
...
Cohesion: 0.10
Nodes (24): createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, AtlasHostRuntimeOptions, AtlasLoaderOptions, AtlasWidgetErrorRenderContext (+16 more)
...
Cohesion: 0.14
Nodes (30): affectedHostIds(), asAsyncIterable(), assertBytes(), assertResponseMetadata(), assertSelectedManifestIdentity(), assertStoredMetadata(), collectWidgetProviderIds(), createHostProjections() (+22 more)
...
Cohesion: 0.07
Nodes (51): SupportedFramework, asStringRecord(), DEPENDENCY_FIELDS, dependencyDeclared(), DependencyField, dependencyManifestPath(), existingFrameworkVersionInfo(), frameworkPrimaryDependency() (+43 more)
...
Cohesion: 0.17
Nodes (22): AtlasDomIsolation, AtlasExposeMap, AtlasFramework, AtlasDeploymentCatalog, AtlasAppManifest, AtlasMetadata, AtlasMetadataValue, AtlasPlacement (+14 more)
...
Cohesion: 0.08
Nodes (36): AtlasHostAnchorListener, AtlasHostUi, AtlasHostMountState, createMountBoundary(), createRoutePlacementPlan(), createWidgetCard(), LoadingEmitter, MountedWidgetState (+28 more)
...
Cohesion: 0.10
Nodes (25): ATLAS_BROWSER_LOADER, createBrowserAssetFiles(), MODULE_SHIM_SOURCE, require, createAtlasBootstrapFiles(), requiredRuntime(), runtimeAssetOrigins(), validateRuntime() (+17 more)
...
## Knowledge Gaps
- **1584 isolated node(s):** `name`, `version`, `private`, `type`, `@atlas/schema` (+1579 more)
...
- **Why does `AtlasManifest` connect `Static registry` to `index.ts`, `dom-host-runtime.ts`, `Contributing to Atlas`, `Angular Troubleshooting`, `prepare-release.specs.ts`, `Atlas Overview`, `verify.service.ts`, `generation.driver.ts`, `remote-assets.ts`, `Angular SDK`, `cli.service.ts`, `react.ts`, `AngularLiveDevelopmentDriver`, `runtime-discovery.ts`, `react-router.ts`, `AtlasManifest`?**
...
- **Why does `AtlasProject` connect `navigation-types.ts` to `dom-host-runtime.ts`, `cli.service.ts`, `angular.ts`, `cli.service.ts`, `@types/babel__core`, `target.ts`?**
