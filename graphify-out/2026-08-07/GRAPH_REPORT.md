# Graph Report - atlas  (2026-08-07)

## Corpus Check
- 538 files · ~182,836 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4722 nodes · 8691 edges · 312 communities (248 shown, 64 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 96 edges (avg confidence: 0.68)
...
7. `generateAngularAppFiles()` - 25 edges
8. `AtlasHostManifest` - 25 edges
9. `runAtlasCli()` - 24 edges
10. `startDomHostRuntime()` - 24 edges
...
## Communities (312 total, 64 thin omitted)

### Community 0 - "index.ts"
Cohesion: 0.07
Nodes (47): createLocalDevCatalog(), HostDevSession, localHostPlaceholder(), uniqueArtifacts(), uniqueManifests(), AtlasDevSessionDocument, assertAtlasHostCatalog(), assertAtlasManifest() (+39 more)
...
Cohesion: 0.19
Nodes (16): removeDelegatedReactViteConfigs(), takeOverAppSource(), writeGenerated(), readJsonFile(), assertSafeId(), assertWritable(), isNodeError(), parseProjectPath() (+8 more)
...
Cohesion: 0.10
Nodes (40): AtlasPublicationStorage, createPublicationStorage(), artifactIndexPath(), artifactPrefix(), assertExpectedRegistryRevision(), assertPublicationMetadata(), AtlasPrPruneResult, AtlasPrRemovalResult (+32 more)
...
Cohesion: 0.05
Nodes (65): DomHostOptions, createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, RoutePlacement, AtlasHostMountEvent (+57 more)
...
Cohesion: 0.09
Nodes (31): absoluteHttpUrl(), asRecord(), AssetExpectation, AtlasVerificationReport, AtlasVerificationStatus, AtlasVerifyOptions, AtlasVerifyService, createReport() (+23 more)
...
Cohesion: 0.10
Nodes (43): addDocumentStyleRewriteSession(), angularStyleScopeAttributeNames(), AssetResolver, AtlasAssetRewriteRelease, createRemoteAssetResolver(), cssEscape(), documentStyleRewriteRegistries, DocumentStyleRewriteRegistry (+35 more)
...
Cohesion: 0.11
Nodes (14): Assets And Styles, App Domain, Deployment Domain, Host Domain, Monorepos, React Assets And Styles, App Files, Choose Your Role (+6 more)
...
Cohesion: 0.12
Nodes (12): AppReadiness, AtlasMountedApp, AtlasRuntimeController, createAppReadiness(), createLoadingEmitter(), createRuntimeMount(), hostPlacements(), navigationTargets() (+4 more)

### Community 21 - "dev.service.ts"
Cohesion: 0.17
Nodes (15): DomRuntimeOptions, assertCatalogMatchesConfig(), resolveDomSlotContainer(), resolveHostConfig(), startDomHostRuntime(), prepareStatusElement(), renderErrorState(), renderHostMountState() (+7 more)
...
Cohesion: 0.07
Nodes (55): mapWithConcurrency(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl(), AtlasBrowserOverrideOptions, bytesToBase64() (+47 more)
...
Cohesion: 0.18
Nodes (15): AngularHostBootstrapOptions, AngularHostDataInput, AngularHostDataOption, AtlasDefaultHostRouteComponent, bootstrapAngularHost(), HostMountRequest, HostOptions, HostSdkOptions (+7 more)
...
Cohesion: 0.08
Nodes (13): createTestContainer(), createTestElement(), createAssetElement(), createHostStatusContainer(), createStylesheetDocument(), isTestAssetElement(), isTestStyleLink(), renderLoading() (+5 more)
...
### Community 41 - ".run"
Cohesion: 0.08
Nodes (33): ControlServerDriver, completedProcessOutput(), writeDevOverrideDocument(), hostClientPortFallback(), resolveHostDevPorts(), browserOpenCommand(), DevelopmentProcessDriver, RemoteEntryScenario (+25 more)
...
Cohesion: 0.17
Nodes (6): SupportedFramework, frameworkLabel(), NxDevTargetOptions, displayTarget(), AtlasGenerateService, AtlasNxProjectType
...
Cohesion: 0.07
Nodes (34): AngularWidgetRuntime, AtlasEventBus, AtlasEventListener, createAtlasEventBus(), EventKey, notifyListener(), PayloadEventKey, PayloadlessEventKey (+26 more)

### Community 56 - "target.ts"
Cohesion: 0.12
Nodes (26): asDependencyMap(), AtlasPackageManager, AtlasTask, AtlasWorkspaceKind, configuredNxOutputPaths(), createFormatGeneratedCommand(), createTaskCommand(), declaredNxOutputPaths() (+18 more)
...
### Community 70 - "nx.ts"
Cohesion: 0.16
Nodes (26): addUniqueString(), writeJsonFile(), alignDelegatedAngularFederationConfig(), alignDelegatedTsconfig(), angularNativeFederationBuilder(), asObject(), collectNxPathValues(), commandValues() (+18 more)
...
Cohesion: 0.24
Nodes (13): BrowserErrorContext, createBrowserError(), logBrowserError(), emitHostError(), emitHostReady(), emitHostStart(), emitMountState(), reportRetryFailure() (+5 more)
...
Cohesion: 0.38
Nodes (10): findHostRoute(), isAbsolutePath(), isIdentifier(), isRecord(), isValidRoutePath(), normalizePath(), routeMatches(), segments() (+2 more)
...
Cohesion: 0.12
Nodes (31): artifactDirectoryUrl(), createNativeFederationImporters(), createTrustedNativeFederationImporters(), federationRemoteName(), fetchRemoteBytes(), hasMountFunction(), importNativeFederationRemote(), normalizeAppEntry() (+23 more)
...
Cohesion: 0.07
Nodes (27): ATLAS_BROWSER_LOADER, AtlasBootstrapFile, AtlasBootstrapOptions, createAtlasBootstrapFiles(), createBootstrapHtml(), createNginxConfig(), cspSources(), escapeHtml() (+19 more)
...
Cohesion: 0.10
Nodes (19): Apps, Architecture, Browser loader, Deliberate limits, Host client, One selection model, Release data flow, Rollback boundaries (+11 more)
...
Cohesion: 0.16
Nodes (10): assertLease(), DeploymentLease, PublicationStorageDriver, environmentBoolean(), randomBackoffMs(), s3ClientConfig(), S3Options, storageFromEnvironment() (+2 more)
...
Cohesion: 0.07
Nodes (24): Before a Pull Request, Contributing to Atlas, Documentation, File Extensions, Releases, Repository Layout, Setup, App Domain (+16 more)
...
Cohesion: 0.06
Nodes (35): ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk, createAtlasHostDataSignal(), AngularInjectionDriver, CustomerHostSdk, injectAppLoaded(), injectAtlasAppContext() (+27 more)
...
Cohesion: 0.18
Nodes (11): devDependencies, @babel/plugin-syntax-typescript, react-router-dom, @testing-library/user-event, @types/react-dom, @wix/wix-ui-icons-common, react-router-dom, @types/react-dom (+3 more)
...
Cohesion: 0.10
Nodes (20): AtlasEventMap, AtlasSlotRenderRequest, AtlasHostDataContext, AtlasRuntimeContext, AtlasSdk, AtlasSdkContext, useAppLoaded(), useAtlasSdk() (+12 more)
...
Cohesion: 0.06
Nodes (23): createLocationStrategy(), notifyPopState(), PopStateListener, readInnerUrl(), LocationLike, LocationStrategyAdapter, RouterLike, addBrokenRoute() (+15 more)
...
- **Why does `createWidgetComponent()` connect `@testing-library/user-event` to `loader.specs.ts`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `renderLoading()` connect `loader.specs.ts` to `@testing-library/user-event`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `AtlasManifest` connect `index.ts` to `index.ts`, `Atlas Overview`, `publishFiles`, `verify.service.ts`, `publication-context.ts`, `remote-assets.ts`, `cli.service.ts`, `help.ts`, `AtlasNavigation`, `@testing-library/user-event`, `@types/node`, `runtime-discovery.ts`, `sdk-factory.ts`?**
