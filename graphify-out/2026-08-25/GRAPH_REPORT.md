# Graph Report - atlas  (2026-08-25)

## Corpus Check
- 587 files · ~212,891 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5070 nodes · 9853 edges · 327 communities (261 shown, 66 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 150 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a09eb82b`
...
## Communities (327 total, 66 thin omitted)

### Community 0 - "index.ts"
Cohesion: 0.08
Nodes (32): anchorKey(), AtlasHostAnchorListener, AtlasHostAnchorRegistry, readAtlasNavigationItems(), subscribeAtlasNavigationItems(), AtlasHostUi, AtlasHostUiOptions, createHostUi() (+24 more)
...
Cohesion: 0.05
Nodes (38): AtlasHostMountState, createDeferred(), createHostCatalog(), createRouteManifest(), createRoutePlacement(), createSlotManifest(), createTestContainer(), createTestDocument() (+30 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.14
Nodes (22): createControlRequestHandler(), joinControlServer(), readActiveControlServerLeases(), pathSegment(), readPublishedCatalog(), registerOverride(), respondWithDevelopmentSession(), respondWithSession() (+14 more)

### Community 4 - "workspace.ts"
Cohesion: 0.35
Nodes (11): createLocalOverrides(), manifest(), inspectAtlasHost(), loadSnapshotVersions(), readRegistry(), readRuntimeErrors(), readRuntimeSnapshot(), readStoredOverrideDocument() (+3 more)
...
Cohesion: 0.07
Nodes (12): collect(), MemoryDeployStorage, StoredObject, AtlasPublicationBody, AtlasPublicationListedObject, AtlasPublicationObjectMetadata, AtlasPublicationReplaceCondition, collect() (+4 more)
...
Cohesion: 0.09
Nodes (40): AtlasDevSessionDocument, absoluteHttpUrl(), asRecord(), AssetExpectation, AtlasVerificationCheck, AtlasVerificationReport, AtlasVerificationStatus, AtlasVerifyOptions (+32 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.10
Nodes (31): withLease(), AtlasArtifactPreviewState, AtlasPublicationLease, AtlasPublicationStorage, createPublicationStorage(), AtlasRegistryConfig, artifactPrefix(), assertExpectedRegistryRevision() (+23 more)
...
Cohesion: 0.11
Nodes (33): ArtifactConfigurationPage(), OverrideRadioCard(), OverrideRadioCardProps, OverridesSelectionForm(), OverridesSelectionFormProps, OverrideVersionDropdown(), VersionDropdownProps, ArtifactConfigurationLocationState (+25 more)
...
Cohesion: 0.07
Nodes (61): requireInitializedRemoteName(), assertDescriptorBytes(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl(), bytesToBase64() (+53 more)
...
Cohesion: 0.10
Nodes (37): createOverrideDocument(), disabledOverridesKey(), DisabledOverrideStorageLocation, AtlasHostDriver, errorMessage(), findAtlasHostTab(), hasTabId(), InspectableTab (+29 more)

### Community 38 - "index.ts"
Cohesion: 0.09
Nodes (14): assertHostConfig(), AtlasBootstrapBuildResult, AtlasBootstrapDependencies, AtlasBootstrapService, AtlasBootstrapServiceOptions, bootstrapDigest(), defaultDependencies, AtlasBootstrapServiceDriver (+6 more)
...
### Community 41 - ".run"
Cohesion: 0.06
Nodes (36): Input, AtlasAnchorComponent, AtlasAngularHostAnchors, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot (+28 more)

### Community 42 - "FailingMutableStorage"
Cohesion: 0.29
Nodes (11): applyOverrides(), artifactRegistryRoot(), descriptorReference(), fetchDevSession(), hasDevSessionPort(), isValidPort(), mergeDevSessionCatalog(), removeDevSessionPortFromAddressBar() (+3 more)
...
Cohesion: 0.16
Nodes (10): createDevSession(), createLocalDevCatalog(), DevSessionEntry, DevelopmentSessionDriver, SessionScenario, HostDevSession, localHostPlaceholder(), uniqueArtifacts() (+2 more)
...
Cohesion: 0.03
Nodes (76): renderLoading(), ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk, AtlasSdkFactory, createAtlasHostDataSignal(), AngularInjectionDriver, CustomerHostSdk (+68 more)
...
Cohesion: 0.17
Nodes (9): HostLoaderDriver, ModuleShimDriver, moduleShim, HostEntry, HostModule, HostMountRequest, ModuleShimGlobal, RemoteMetadata (+1 more)
...
### Community 70 - "nx.ts"
Cohesion: 0.11
Nodes (33): addUniqueString(), writeJsonFile(), alignDelegatedAngularFederationConfig(), alignDelegatedTsconfig(), angularNativeFederationBuilder(), asObject(), atlasCommand(), atlasConfigNxTarget() (+25 more)
...
Cohesion: 0.23
Nodes (11): ControlServerLease, isActiveLease(), LEASE_DIRECTORY, leaseId(), leasePath(), processExists(), readLease(), removeControlServerLease() (+3 more)
...
Cohesion: 0.09
Nodes (29): createLoadedHost(), HostContext, HostContextValue, HostLoadResult, readActiveHost(), readCachedHost(), CreateOverrideDocumentOptions, MockTab (+21 more)
...
Cohesion: 0.06
Nodes (43): SupportedFramework, readHostBaseUrls(), FrameworkVersionInfo, defaultIgnoreFileDependencies, GeneratedFilesDriver, IgnoreScenario, ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS (+35 more)
...
Cohesion: 0.05
Nodes (78): mapWithConcurrency(), createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, RoutePlacement, AtlasHostRuntimeOptions (+70 more)
...
Cohesion: 0.13
Nodes (24): ATLAS_BROWSER_LOADER, createBrowserAssetFiles(), MODULE_SHIM_SOURCE, require, createAtlasBootstrapFiles(), withTrailingNewline(), createBootstrapHtml(), escapeHtml() (+16 more)
...
Cohesion: 0.07
Nodes (20): AppBootstrap, createExportedWidget(), defineExportedWidget(), AtlasAppContext, AtlasAppMountRequest, AtlasAppMountResult, AtlasExportedWidgetMountResult, AtlasHostClientEntry (+12 more)
...
Cohesion: 0.15
Nodes (13): dependencies, @angular/platform-browser, @angular/router, @atlas/schema, es-module-shims, rxjs, tslib, @angular/platform-browser (+5 more)
...
Cohesion: 0.07
Nodes (28): CliArguments, cliVersion(), configuredHostUrls(), previewSelector(), printVerificationCheck(), runAtlasCli(), runWorkspaceFreeCommand(), splitUrls() (+20 more)
...
Cohesion: 0.14
Nodes (11): AppReadiness, AtlasRuntimeController, createRoutePlacementPlan(), createRuntimeMount(), logRouteConflict(), navigationTargets(), normalizeRoutePath(), placementKey() (+3 more)
...
Cohesion: 0.26
Nodes (14): absoluteUrl(), assertAtlasHostDiscovery(), assertAtlasManifestUrl(), assertDiscoveryBinding(), assertExternalRegistries(), assertPublicUrl(), isLoopback(), isRecord() (+6 more)
...
Cohesion: 0.13
Nodes (38): affectedHostIds(), asAsyncIterable(), assertBytes(), assertExpectedRevision(), assertResponseMetadata(), assertSelectedManifestIdentity(), assertStoredMetadata(), AtlasDeployService (+30 more)
...
Cohesion: 0.18
Nodes (20): AtlasLoaderDependencies, defaultDependencies(), deploymentReferences(), loadDeployment(), loadInitialCatalog(), mapWithConcurrency(), publishRuntimeSnapshot(), resolveRuntime() (+12 more)
...
Cohesion: 0.21
Nodes (8): findRoutePlacement(), normalizePath(), routeMatches(), segments(), AtlasRouteMount, AtlasPlacementKind, AtlasRouteContribution, AtlasRouteNavigation
...
Cohesion: 0.12
Nodes (12): ControlServerDriver, ControlServerDriver, StartControlServerOptions, DevelopmentPortsDriver, PortScenario, AngularBuildPrivateApi, loadAngularHostProxy(), AtlasDevOverrideDocument (+4 more)

### Community 179 - "[Unreleased]"
Cohesion: 0.40
Nodes (4): Added, Changed, Changelog, [Unreleased]

### Community 181 - "./federation-config"
Cohesion: 0.67
Nodes (3): default, types, ./angular

### Community 182 - "react-router.ts"
Cohesion: 0.11
Nodes (36): AtlasArtifactManifestBase, AtlasAppConfig, AtlasBaseConfig, AtlasHostConfig, AtlasSlotMount, AtlasWidgetConfig, AtlasAppDomIsolation, AtlasDomIsolation (+28 more)
...
Cohesion: 0.14
Nodes (27): assertDescriptor(), Descriptor, fetchManifestReference(), fetchWithTimeout(), HostDeployment, loadArtifactVersion(), loadCachedManifest(), loadedManifests (+19 more)

### Community 232 - "index.driver.ts"
Cohesion: 0.33
Nodes (3): ArtifactConfigurationActions(), ArtifactConfigurationActionsProps, ArtifactConfigurationActionsDriver

### Community 234 - "dependencies.ts"
Cohesion: 0.28
...
### Community 240 - "delay"
Cohesion: 0.12
Nodes (11): AngularLiveDevelopmentDriver, PACKAGE_PATH, SOURCE_PATH, stopLiveApp(), waitForLiveApp(), delay(), cases, LocalDevelopmentCase (+3 more)
...
Cohesion: 0.08
Nodes (19): App(), ArtifactsOverridesPage(), ArtifactName(), ArtifactOverrideActions(), ArtifactOverrideToggle(), ArtifactsOverridesTable(), OverridesTableToolbarDriver, OverridesTableToolbar() (+11 more)
...
### Community 289 - "create-manifest-from-config.ts"
Cohesion: 0.18
...
### Community 333 - "verify-bootstrap-container.ts"
Cohesion: 0.47
...
### Community 336 - "Releasing Atlas packages"
Cohesion: 0.33
...
### Community 338 - "Angular Project Guide"
Cohesion: 0.40
Nodes (5): Angular Project Guide, App Files, Choose Your Role, Host Files, Task Guides

### Community 340 - "Angular Production Build and Publication"
Cohesion: 0.67
Nodes (3): Angular Production Build and Publication, Native Federation, Verify

## Knowledge Gaps
- **1630 isolated node(s):** `name`, `version`, `private`, `type`, `@atlas/bootstrap` (+1625 more)
...
- `AtlasDevService` (2× useful, score=0.886825962) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `createReactAppViteConfig()` connect `generate.service.ts` to `overlay-controller.ts`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `loadBrowserRuntimeOverrides()` connect `runtime-discovery.ts` to `native-federation.ts`, `AtlasManifest`, `help.ts`, `loader.driver.ts`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `AtlasManifest` connect `loader.driver.ts` to `create-manifest-from-config.ts`, `angular.ts`, `verify.service.ts`, `angular-widget.ts`, `remote-assets.ts`, `cli.service.ts`, `@babel/core`, `react-router.ts`, `runtime-discovery.ts`, `native-federation.ts`, `widget-registry.driver.ts`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
