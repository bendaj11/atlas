...
## Summary
- 5276 nodes · 10170 edges · 341 communities (270 shown, 71 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 157 edges (avg confidence: 0.73)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1d918de4`
...
## Communities (341 total, 71 thin omitted)

### Community 0 - "index.ts"
Cohesion: 0.06
Nodes (37): AngularHostSdkReference, createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, RoutePlacement, AtlasHostRuntimeOptions (+29 more)
...
Cohesion: 0.10
Nodes (35): AtlasPreviewHeadResolver, AtlasPublishResult, PublishServiceDriver, canonicalJson(), isRecord(), registryRevision(), sortJson(), artifactKind() (+27 more)
...
Cohesion: 0.07
Nodes (48): BrowserErrorContext, createBrowserError(), logBrowserError(), AppReadiness, AtlasHostMountState, AtlasMountedApp, AtlasRuntimeController, createAppReadiness() (+40 more)

### Community 7 - "index.ts"
Cohesion: 0.09
Nodes (36): ui, createControlRequestHandler(), developmentSession(), joinControlServer(), ControlServerLease, ensureLeaseDirectory(), isActiveLease(), LEASE_DIRECTORY (+28 more)
...
Cohesion: 0.06
Nodes (75): mapWithConcurrency(), loadAndMountHostCatalog(), requiredManifestUrl(), AngularLocalManifest, AngularLocalRuntimeDriver, prepareAngularLocalRuntime(), artifactDirectoryUrl(), createNativeFederationImporters() (+67 more)
...
Cohesion: 0.08
Nodes (22): ATLAS_BROWSER_LOADER, createBrowserAssetFiles(), ES_MODULE_SHIM, createAtlasBootstrapFiles(), withTrailingNewline(), createBootstrapHtml(), escapeHtml(), validateBootstrapHtml() (+14 more)
...
Cohesion: 0.05
Nodes (70): emitHostError(), emitHostReady(), emitHostStart(), emitMountState(), reportRetryFailure(), toError(), DomHostOptions, DomHostServices (+62 more)
...
Cohesion: 0.04
Nodes (66): ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk, AtlasSdkFactory, createAtlasHostDataSignal(), AngularInjectionDriver, CustomerHostSdk, injectAppLoaded() (+58 more)
...
Cohesion: 0.08
Nodes (60): ATLAS_LOGO, UiDriver, UiScenario, formatLogo(), indentContinuationLines(), RgbColor, Status, STATUS_COLORS (+52 more)
...
Cohesion: 0.06
Nodes (42): renderLoading(), AngularBootstrapDriver, ASSET_BASE_URL, createAppConfig(), CustomerSdk, LOGO_URL, HostFixture(), HostSdk (+34 more)
...
Cohesion: 0.10
Nodes (21): ControlServerDriver, ControlServerDriver, createDevSession(), createLocalDevCatalog(), DevSessionEntry, DevelopmentSessionDriver, SessionScenario, HostDevSession (+13 more)
...
Cohesion: 0.22
Nodes (9): devDependencies, @angular/compiler, @angular/compiler-cli, @types/css-tree, @types/react, @angular/compiler, @angular/compiler-cli, @types/react (+1 more)
...
Cohesion: 0.11
Nodes (33): AtlasDeployService, digest(), envPath(), hostManifests(), hostPath(), isLoopback(), isSecureRegistryProtocol(), message() (+25 more)
...
Cohesion: 0.08
Nodes (24): AtlasAngularHostAnchors, Injectable, AngularHostBootstrapOptions, AngularHostDataInput, AngularHostDataOption, AngularHostStartServices, AtlasDefaultHostRouteComponent, AtlasNavigationItemsService (+16 more)
...
Cohesion: 0.09
Nodes (32): AtlasBootstrapServiceOptions, CliArguments, completedProcessOutput(), localOrigin(), writeDevOverrideDocument(), DevelopmentPortsDriver, PortScenario, hostClientPortFallback() (+24 more)
...
Cohesion: 0.09
Nodes (39): asStringRecord(), DEPENDENCY_FIELDS, dependencyDeclared(), DependencyField, dependencyManifestPath(), existingFrameworkVersionInfo(), frameworkPrimaryDependency(), FrameworkVersionInfo (+31 more)
...
Cohesion: 0.20
Nodes (5): SupportedFramework, frameworkLabel(), displayTarget(), AtlasGenerateService, AngularStylesheetFormat
...
Cohesion: 0.08
Nodes (49): DeploymentWrite, assertAtlasManifest(), AtlasArtifactManifestBase, AtlasAppConfig, AtlasBaseConfig, AtlasRouteMount, AtlasSlotMount, AtlasWidgetConfig (+41 more)
...
## Knowledge Gaps
- **1663 isolated node(s):** `name`, `version`, `private`, `type`, `@atlas/bootstrap` (+1658 more)
