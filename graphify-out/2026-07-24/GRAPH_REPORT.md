# Graph Report - atlas  (2026-07-24)

## Corpus Check
- 447 files · ~259,236 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4121 nodes · 7401 edges · 281 communities (223 shown, 58 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 83 edges (avg confidence: 0.69)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cbf230d6`
...
Cohesion: 0.11
Nodes (35): mapWithConcurrency(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl(), bytesToBase64(), catalogSelectionError() (+27 more)
...
Cohesion: 0.05
Nodes (60): asObject(), assertUsableAngularBuildPackage(), AtlasDevBuildService, AtlasDevOverrideDocument, AtlasDevService, BootstrapResponseOptions, browserOpenCommand(), closeServer() (+52 more)
...
Cohesion: 0.08
Nodes (20): renderLoading(), AppOptions, RootAdapter, AtlasRuntimeContext, AtlasSdk, AtlasSdkContext, useAtlasSdk(), AppRouterLike (+12 more)
...
Cohesion: 0.06
Nodes (63): Injectable, AtlasDefaultHostRouteComponent, AtlasNavigationItemsService, HostOptions, startHost(), syncAngularRouterWithBrowserUrl(), Component, BrowserErrorContext (+55 more)
...
Cohesion: 0.13
Nodes (9): App(), ArtifactsOverridesPage(), ArtifactsOverridesTable(), EmptyHostDataStateDriver, EmptyHostDataState(), EmptyHostDataStateProps, AppProvider(), root (+1 more)
...
Cohesion: 0.08
Nodes (51): availableAppsMessage(), addUniqueString(), ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS, existingPackageName(), hasAtlasIgnorePattern(), isContainedBy(), isMissingFileError() (+43 more)

### Community 36 - "Community 36"
Cohesion: 0.16
Nodes (16): cliActions(), cliSummary(), COMMAND_ALIASES, createCliError(), rerunAction(), actionableMessage(), AtlasError, AtlasErrorOptions (+8 more)
...
Cohesion: 0.09
Nodes (40): AtlasDevSessionDocument, RegistrySnapshot, WidgetRegistryOptions, assertAtlasManifest(), AtlasAppIndex, AtlasArtifactIndex, AtlasArtifactManifestBase, AtlasAppConfig (+32 more)
...
Cohesion: 0.15
Nodes (17): HostProvider(), OverridesContext, OverridesContextValue, OverridesProvider(), SessionContext, SessionContextValue, useSession(), clearAllOverridesInSession() (+9 more)
...
Cohesion: 0.11
Nodes (24): createLoadedHost(), HostContext, HostContextValue, HostLoadResult, loadCachedHost(), readActiveHost(), BadgeCountMessage, CreateOverrideDocumentOptions (+16 more)
...
Cohesion: 0.10
Nodes (33): createOverrideDocument(), disabledOverridesKey(), DisabledOverrideStorageLocation, AtlasHostDriver, MockTab, storageArea(), errorMessage(), findAtlasHostTab() (+25 more)
...
Cohesion: 0.08
Nodes (16): createDevSessionStore(), DevSessionStore, readJsonRequest(), startOwnedControlServer(), writeError(), writeJson(), AppReadiness, AtlasRuntimeController (+8 more)
...
Cohesion: 0.13
Nodes (26): formatEnvValue(), isMissingFileError(), loadEnvFile(), loadEnvFiles(), parseEnvLine(), parseEnvValue(), saveWorkspaceLocalEnv(), formatHelp() (+18 more)
...
Cohesion: 0.20
Nodes (9): VersionDropdownProps, InspectAtlasHostDriver, installPage(), jsonResponse(), manifest(), PageOptions, storage(), ManifestVersionsDriver (+1 more)
...
Cohesion: 0.17
Nodes (14): ArtifactName(), ArtifactOverrideActions(), ArtifactOverrideToggle(), ArtifactOverrideVersion(), ArtifactOverrideVersionDriver, createArtifact(), manifest(), OVERRIDE_TYPE_LABELS (+6 more)
...
Cohesion: 0.05
Nodes (63): DomHostOptions, SdkProviderInput, RoutePlacement, AtlasHostRuntimeOptions, AtlasLoaderOptions, AtlasMountedApp, AtlasWidgetErrorRenderContext, AtlasWidgetLoaderOptions (+55 more)

### Community 123 - "Manifests"
Cohesion: 0.17
Nodes (14): CONTENT_TYPES, publicationContentType(), AtlasPublicationStorage, assertPublicationMetadata(), createImmutable(), isPublicationInventory(), publicationBytes(), publicationMetadata() (+6 more)
...
### Community 130 - "startOwnedControlServer"
Cohesion: 0.18
...
Cohesion: 0.08
Nodes (36): mount(), AtlasHostMountState, artifactDirectoryUrl(), AtlasFederationAdapter, createNativeFederationImporters(), createTrustedNativeFederationImporters(), federationRemoteName(), fetchRemoteBytes() (+28 more)

### Community 132 - "Community 132"
Cohesion: 0.12
Nodes (17): CliArguments, AtlasBootstrapBuildResult, AtlasBootstrapService, BootstrapBuildService, bootstrapDigest(), isFileNotFoundError(), loadBootstrapTemplate(), compileAtlasConfig() (+9 more)
...
### Community 145 - "LocationStrategyAdapter"
Cohesion: 0.20
Nodes (3): { createAngularFederationConfig }, { createAngularFederationConfig }, { createAngularFederationConfig }

### Community 146 - "create-manifest-from-config.ts"
Cohesion: 0.21
Nodes (19): requireInitializedRemoteName(), runtimeError(), RuntimeErrorOptions, assertRegistry(), assertWidgetId(), compareNewestFirst(), createRegistryWidgetResolver(), fetchRegistry() (+11 more)
...
Cohesion: 0.14
Nodes (5): SupportedFramework, AtlasGenerateService, frameworkLabel(), displayTarget(), AtlasWorkspace
...
### Community 170 - "native-federation.ts"
Cohesion: 0.29
...
### Community 185 - "navigation-types.ts"
Cohesion: 0.20
Nodes (6): AtlasInnerLocation, AtlasNavigateOptions, AtlasNavigationListener, AtlasRouteContext, createMemoryNavigation(), splitPath()
...
Cohesion: 0.12
Nodes (16): App Domain, Atlas Overview, Deployment Domain, Host Domain, Learn Next, Mental Model, Vocabulary, HTTP controls (+8 more)

### Community 190 - "angular-host-navigation.ts"
Cohesion: 0.22
Nodes (3): LocationLike, RouterLike, AtlasLocation
...
### Community 200 - "generate-files.ts"
Cohesion: 0.14
...
Cohesion: 0.09
Nodes (27): AtlasEventBus, createAtlasEventBus(), EventKey, notifyListener(), StoredEventListener, AtlasFetchHttpClient, AtlasHttpClientInput, AtlasHttpRequestOptions (+19 more)
...
Cohesion: 0.11
Nodes (33): assertAppConfig(), AtlasArtifactManifest, AtlasBuildService, buildTimestamp(), discoverExportedWidgets(), discoverStylesheets(), findArtifactRoot(), findArtifactRootIfPresent() (+25 more)
...
### Community 250 - "Exported Widgets"
Cohesion: 0.25
...
### Community 251 - "startOwnedControlServer"
Cohesion: 0.43
Nodes (4): BrowserOverrideScopePicker(), BrowserOverrideScopePickerDriver, ScopePickerProps, Scope
...
- `Columbus` (2× useful, score=1.975543452)
- `AtlasDevService` (2× useful, score=1.915546292) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `AtlasManifest` connect `angular-generator.ts` to `Community 1`, `AtlasWorkspace`, `Community 131`, `publication-context.ts`, `generate-files.ts`, `create-manifest-from-config.ts`, `Community 20`, `Community 21`, `generate.ts`, `react-context.ts`, `Community 31`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `AtlasPublicationObjectMetadata` connect `Community 92` to `Community 40`, `Community 2`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
