# Graph Report - atlas  (2026-08-05)

## Corpus Check
- 539 files · ~199,106 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4668 nodes · 8563 edges · 319 communities (256 shown, 63 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 95 edges (avg confidence: 0.67)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `023666c6`
...
1. `AtlasManifest` - 47 edges
2. `CliArguments` - 39 edges
3. `addIssue()` - 33 edges
4. `runtimeError()` - 29 edges
5. `runAtlasCli()` - 25 edges
6. `detectWorkspace()` - 25 edges
7. `generateAngularAppFiles()` - 25 edges
8. `AtlasGenerateService` - 24 edges
9. `AtlasExtensionManifest` - 23 edges
10. `AtlasExportedWidgetManifest` - 23 edges
...
- 3-file cycle: `packages/cli/src/generation/nx/nx.ts -> packages/cli/src/generation/paths.ts -> packages/cli/src/workspace/workspace/workspace.ts -> packages/cli/src/generation/nx/nx.ts`
...
- 4-file cycle: `packages/cli/src/generation/files/files.ts -> packages/cli/src/generation/paths.ts -> packages/cli/src/workspace/workspace/workspace.ts -> packages/cli/src/generation/nx/nx.ts -> packages/cli/src/generation/files/files.ts`
- 4-file cycle: `packages/cli/src/generation/json.ts -> packages/cli/src/generation/paths.ts -> packages/cli/src/workspace/workspace/workspace.ts -> packages/cli/src/generation/nx/nx.ts -> packages/cli/src/generation/json.ts`
...
- 5-file cycle: `packages/cli/src/generation/angular.ts -> packages/cli/src/generation/json.ts -> packages/cli/src/generation/paths.ts -> packages/cli/src/workspace/workspace/workspace.ts -> packages/cli/src/generation/nx/nx.ts -> packages/cli/src/generation/angular.ts`
...
## Communities (319 total, 63 thin omitted)

### Community 0 - "index.ts"
Cohesion: 0.12
Nodes (28): AtlasAppIndex, AtlasArtifactIndex, AtlasArtifactManifestBase, AtlasAppConfig, AtlasBaseConfig, AtlasHostConfig, AtlasRouteMount, AtlasSlotMount (+20 more)

### Community 1 - "react-generator.ts"
Cohesion: 0.06
Nodes (81): angularAppAppComponent(), angularAppConfig(), angularAppDetailsComponent(), angularAppEntry(), angularAppHomeComponent(), angularAppMain(), angularAppRoutes(), angularSinglePageAppComponent() (+73 more)

### Community 2 - "AtlasManifest"
Cohesion: 0.05
Nodes (60): AtlasHostAnchorListener, AppReadiness, AtlasHostMountState, AtlasMountedApp, AtlasRuntimeController, createAppNavigator(), createAppReadiness(), createLoadingEmitter() (+52 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.09
Nodes (42): BrowserErrorContext, createBrowserError(), logBrowserError(), emitHostError(), emitHostReady(), emitHostStart(), emitMountState(), reportRetryFailure() (+34 more)
...
Cohesion: 0.10
Nodes (34): createPublicationStorage(), environmentBoolean(), storageFromEnvironment(), artifactIndexPath(), artifactPrefix(), assertExpectedRegistryRevision(), AtlasPrPruneResult, AtlasPrRemovalResult (+26 more)
...
Cohesion: 0.11
Nodes (30): createDevSession(), angularComponentCount(), appDocument(), assertSingleComponentDeclaration(), atlasPackageRange(), availablePort(), catalogManifestIds(), cliEntrypointPath() (+22 more)

### Community 20 - "AtlasNavigation"
Cohesion: 0.08
Nodes (26): createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, AtlasHostRuntimeOptions, AtlasLoaderOptions, AtlasWidgetLoaderOptions (+18 more)

### Community 21 - "dev.service.ts"
Cohesion: 0.08
Nodes (24): ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk, injectAppLoaded(), injectAtlasAppContext(), injectAtlasHostData(), injectAtlasSdk(), ActiveWidget (+16 more)
...
Cohesion: 0.10
Nodes (35): mapWithConcurrency(), resolveHostConfig(), assertManifestSupportsHost(), AtlasBrowserOverrideOptions, AtlasRuntimeOverride, bytesToBase64(), catalogSelectionError(), defaultFetchBytes() (+27 more)

### Community 25 - "native-federation.ts"
Cohesion: 0.07
Nodes (36): start(), bootstrapActions(), describeFatalError(), FatalErrorDriver, showFatalError(), FetchJsonDriver, fetchJson(), validateIntegrity() (+28 more)
...
Cohesion: 0.07
Nodes (31): Input, AtlasAnchorComponent, AtlasAngularHostAnchors, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot, Component (+23 more)
...
Cohesion: 0.07
Nodes (32): angularComponentCount(), appDocument(), assertSingleComponentDeclaration(), atlasPackageRange(), availablePort(), catalogManifestIds(), closeServer(), closingJoinedAppPreservesHost() (+24 more)
...
### Community 41 - ".run"
Cohesion: 0.14
Nodes (22): completedProcessOutput(), AtlasDevService, writeDevOverrideDocument(), hostClientPortFallback(), resolveHostDevPorts(), assertUsableAngularBuildPackage(), CorruptAngularBuildPackage, findCorruptAngularBuildPackage() (+14 more)
...
Cohesion: 0.08
Nodes (48): artifactDirectoryUrl(), AtlasFederationAdapter, createNativeFederationImporters(), createTrustedNativeFederationImporters(), federationRemoteName(), fetchRemoteBytes(), hasMountFunction(), importNativeFederationRemote() (+40 more)
...
Cohesion: 0.07
Nodes (30): AtlasAppContext, appendQueryValue(), matchRoutePart(), matchRoutePattern(), normalizePath(), parseQuery(), scopePath(), splitRoutePath() (+22 more)
...
Cohesion: 0.47
Nodes (7): isManifest(), isRecord(), isRegistry(), readCatalog(), readJson(), readManifestIndex(), readRegistry()

### Community 56 - "target.ts"
Cohesion: 0.12
Nodes (34): asObject(), configuredHostIds(), firstObjectValue(), hostIdFromRoute(), isBaseHostUrl(), isHostConfig(), objectValue(), parsePort() (+26 more)
...
Cohesion: 0.06
Nodes (13): CONTENT_TYPES, publicationContentType(), AtlasPublicationLease, AtlasPublicationObjectMetadata, AtlasProjectBuilder, emptyRegistryText(), LeaseLossStorage, StoredPublicationObject (+5 more)
...
### Community 70 - "nx.ts"
Cohesion: 0.13
Nodes (29): addUniqueString(), writeJsonFile(), alignDelegatedAngularFederationConfig(), alignDelegatedTsconfig(), angularNativeFederationBuilder(), asObject(), atlasConfigNxTarget(), collectNxPathValues() (+21 more)
...
Cohesion: 0.15
Nodes (9): createProject(), createWidgetWorkspace(), AtlasInvocation, InteractionDriver, resolveInvocation(), createPromptDriver(), PromptTestDouble, title() (+1 more)
...
Cohesion: 0.10
Nodes (22): cliActions(), cliSummary(), COMMAND_ALIASES, createCliError(), rerunAction(), actionableMessage(), AtlasError, AtlasErrorOptions (+14 more)
...
Cohesion: 0.11
Nodes (8): AtlasBootstrapServiceOptions, SupportedFramework, AtlasGenerateService, frameworkLabel(), displayTarget(), AtlasScaffoldOptions, AtlasWorkspace, AngularStylesheetFormat

### Community 86 - "react.ts"
Cohesion: 0.16
Nodes (22): readAtlasNavigationItems(), subscribeAtlasNavigationItems(), anchorTag(), AtlasDefaultHostLayout(), AtlasHostAnchorsContext, AtlasHostProvider(), AtlasHostProviderProps, AtlasHostStatus() (+14 more)
...
Cohesion: 0.07
Nodes (21): createLocationStrategy(), notifyPopState(), PopStateListener, readInnerUrl(), LocationStrategyAdapter, addBrokenRoute(), addSecondCatalogRelease(), addVersionFixtures() (+13 more)
...
Cohesion: 0.15
Nodes (23): ATLAS_BROWSER_LOADER, createAtlasBootstrapFiles(), createBootstrapHtml(), createNginxConfig(), cspSources(), escapeHtml(), MODULE_SHIM_SOURCE, normalizedOrigins() (+15 more)
...
Cohesion: 0.11
Nodes (14): AtlasBootstrapFile, AtlasBootstrapOptions, isFileNotFoundError(), loadBootstrapTemplate(), AtlasBootstrapBuildResult, AtlasBootstrapDependencies, AtlasBootstrapService, BootstrapBuildService (+6 more)
...
Cohesion: 0.18
Nodes (11): `@atlas/runtime`, `@atlas/schema`, `@atlas/sdk/host`, `@atlas/sdk/overlay`, Custom SDK methods, Events between apps, Framework Adapters, Loading and failure UI (+3 more)
...
Cohesion: 0.13
Nodes (18): isRecord(), loadHostProxyConfig(), parseProxyConfig(), validateProxyPath(), validateProxyRoute(), createLocalDevCatalog(), DevSessionEntry, HostDevSession (+10 more)

### Community 128 - "HttpClient"
Cohesion: 0.10
Nodes (6): AtlasEventBus, createAtlasEventBus(), AtlasHttpClient, HttpClient, withBody(), AtlasCoreSdk
...
Cohesion: 0.20
Nodes (17): cliVersion(), configuredArtifactIds(), configuredRuntimeUrls(), positiveInteger(), printVerificationCheck(), publishAndVerify(), rollbackAndVerify(), runAtlasCli() (+9 more)
...
Cohesion: 0.15
Nodes (4): DirectoryPublicationStorage, isMissingFile(), publicationFixture(), LeaseLossStorage
...
Cohesion: 0.50
Nodes (3): packageJson, cli, runCli()
...
Cohesion: 0.23
Nodes (17): addUniquePolyfill(), asObject(), enableAngularBuildNotifications(), ensureAngularFederationPolyfills(), ensureAngularHostBuildNotifications(), ensureAngularNativeFederationTargets(), ensureAngularWorkspaceFederationConfig(), existingNativeFederationBuilder() (+9 more)
...
Cohesion: 0.06
Nodes (42): renderLoading(), AngularWidgetRuntime, AtlasEventMap, HostDataListener, hostDataListeners, AtlasFetchHttpClient, AtlasHttpClientInput, AtlasHttpRequestOptions (+34 more)
...
Cohesion: 0.17
Nodes (10): RoutePlacement, AtlasWidgetErrorRenderContext, AtlasWidgetRenderContext, RuntimeMount, RuntimePlacement, AtlasNativeFederationImporters, AtlasResolvedWidget, AtlasManifest (+2 more)
...
### Community 240 - "verify.service.testkit.ts"
Cohesion: 0.40
...
Cohesion: 0.25
Nodes (10): capturedProcessOutput(), captureProcessOutput(), forwardAndCapture(), ProcessCommand, processOutput, processOutputClosed, require, runProcess() (+2 more)

### Community 268 - "bootstrap.specs.ts"
Cohesion: 0.40
Nodes (5): scripts, build, test, test:e2e, typecheck

### Community 269 - "cli.driver.ts"
Cohesion: 0.50
...
Cohesion: 0.15
Nodes (11): UiDriver, indentContinuationLines(), Status, STATUS_COLORS, STATUS_SYMBOLS, style(), TerminalPrompter, UiColor (+3 more)

### Community 302 - "angular.driver.ts"
Cohesion: 0.24
Nodes (3): createAppContext(), files(), splitUrl()

### Community 303 - "files.specs.ts"
Cohesion: 0.16
Nodes (23): ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS, existingPackageName(), hasAtlasIgnorePattern(), isContainedBy(), isMissingFileError(), readFileIfPresent(), removeDelegatedReactViteConfigs() (+15 more)

### Community 306 - "prepare-release.driver.ts"
Cohesion: 0.67
Nodes (3): createReleaseWorkspace(), packageDirectories, writeJson()

### Community 312 - "./federation"
Cohesion: 0.67
Nodes (3): ./federation, default, types

### Community 315 - "repository"
Cohesion: 0.67
...
## Knowledge Gaps
- **1582 isolated node(s):** `name`, `version`, `private`, `type`, `build` (+1577 more)
...
- `AtlasDevService` (2× useful, score=1.481490201) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `AtlasPublicationObjectMetadata` connect `navigation-types.ts` to `React SDK`, `build.driver.ts`, `resilience.ts`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `AtlasManifest` connect `AtlasManifest` to `index.ts`, `AtlasManifest`, `dom-host-runtime.ts`, `Atlas Overview`, `verify.service.ts`, `angular-anchors.ts`, `publication-storage.ts`, `remote-assets.ts`, `React Routing`, `cli.service.ts`, `AtlasNavigation`, `sdk-factory.ts`, `types.ts`, `runtime-discovery.ts`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `FailingMutableStorage` connect `navigation-types.ts` to `React SDK`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
...
- **Should `react-generator.ts` be split into smaller, more focused modules?**
  _Cohesion score 0.0634828188701223 - nodes in this community are weakly interconnected._
