...
## Corpus Check
- 542 files · ~187,000 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4757 nodes · 8425 edges · 317 communities (254 shown, 63 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 121 edges (avg confidence: 0.71)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `ad75516b`
...
- `readDisabledOverrides()` --indirect_call--> `manifest()`  [INFERRED]
  apps/columbus/src/scripts/host/atlas-host/atlas-host.ts → apps/columbus/src/scripts/host/inspect-atlas-host/inspect-atlas-host.driver.ts
...
Cohesion: 0.07
Nodes (23): DomHostOptions, createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, AtlasWidgetResolver, AtlasDeploymentCatalog (+15 more)
...
Cohesion: 0.11
Nodes (15): ControlServerDriver, ControlServerDriver, joinControlServer(), startControlServer(), nonInteractivePrompter, AngularBuildPrivateApi, loadAngularHostProxy(), AppDevelopmentOptions (+7 more)
...
Cohesion: 0.16
Nodes (31): affectedHostIds(), artifactKey(), assertArtifactManifest(), assertSafeRegistryId(), assertStaticRegistry(), AtlasRegistryResult, compareArtifactIdentity(), compareNewestFirst() (+23 more)

### Community 6 - "overlay-controller.ts"
Cohesion: 0.08
Nodes (11): CONTENT_TYPES, publicationContentType(), AtlasPublicationLease, AtlasPublicationObjectMetadata, AtlasProjectBuilder, DirectoryPublicationStorage, FailingMutableStorage, isMissingFile() (+3 more)

### Community 7 - "index.ts"
Cohesion: 0.18
Nodes (11): createControlRequestHandler(), pathSegment(), readProductionCatalog(), registerOverride(), respondWithCatalog(), respondWithSession(), respondWithVersionIndex(), setControlHeaders() (+3 more)
...
Cohesion: 0.24
Nodes (12): AtlasVerifyService, errorMessage(), fail(), parseJson(), pass(), verifyContentType(), verifyImmutableCache(), verifyIntegrity() (+4 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.09
Nodes (30): AngularWidgetRuntime, AtlasFetchHttpClient, HttpClientInput, HttpRequest, HttpRequestOptions, HttpRequestWithBody, HttpRequestWithBodyAndMethod, HttpRequestWithoutBody (+22 more)
...
Cohesion: 0.15
Nodes (4): Assets And Styles, App Routes And Host Layouts, Routing And Navigation, Troubleshooting
...
Cohesion: 0.11
Nodes (13): AppReadiness, AtlasMountedApp, AtlasRuntimeController, createAppReadiness(), createLoadingEmitter(), createRuntimeMount(), findRoutePlacement(), hostPlacements() (+5 more)

### Community 21 - "dev.service.ts"
Cohesion: 0.16
Nodes (23): AtlasAppIndex, AtlasArtifactIndex, AtlasArtifactManifestBase, AtlasAppConfig, AtlasBaseConfig, AtlasHostConfig, AtlasRouteMount, AtlasSlotMount (+15 more)

### Community 22 - "manifest-utils.ts"
Cohesion: 0.11
Nodes (29): ArtifactConfigurationActions(), ArtifactConfigurationActionsProps, ArtifactConfigurationActionsDriver, OverrideRadioCard(), OverrideRadioCardProps, OverridesSelectionForm(), OverridesSelectionFormProps, OverrideVersionDropdown() (+21 more)
...
Cohesion: 0.10
Nodes (43): assertCatalogMatchesConfig(), DomHostRuntimeInput, resolveDomSlotContainer(), resolveHostConfig(), startDomHostRuntime(), assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust() (+35 more)

### Community 25 - "native-federation.ts"
Cohesion: 0.06
Nodes (42): start(), bootstrapActions(), describeFatalError(), FatalErrorDriver, showFatalError(), FetchJsonDriver, fetchJson(), validateIntegrity() (+34 more)

### Community 26 - "ArtifactsOverridesTable.tsx"
Cohesion: 0.14
Nodes (11): AtlasAppMountRequest, AppOptions, RootAdapter, AtlasRuntimeContext, AppRouterLike, connectRouter(), createRouterOptions(), readAtlasInnerUrl() (+3 more)
...
Cohesion: 0.21
Nodes (19): addUniquePolyfill(), asObject(), configureAngularBuildNotifications(), enableAngularBuildNotifications(), ensureAngularFederationPolyfills(), ensureAngularHostBuildNotifications(), ensureAngularNativeFederationTargets(), ensureAngularWorkspaceFederationConfig() (+11 more)
...
Cohesion: 0.05
Nodes (33): createDeferred(), createHostCatalog(), createRouteManifest(), createRoutePlacement(), createSlotManifest(), createTestContainer(), createTestDocument(), createTestElement() (+25 more)

### Community 37 - "atlas-host.ts"
Cohesion: 0.09
Nodes (38): readActiveHost(), createOverrideDocument(), disabledOverridesKey(), DisabledOverrideStorageLocation, AtlasHostDriver, MockTab, storageArea(), errorMessage() (+30 more)
...
### Community 41 - ".run"
Cohesion: 0.13
Nodes (16): capturedProcessOutput(), completedProcessOutput(), DevelopmentPortsDriver, PortScenario, hostClientPortFallback(), resolveHostDevPorts(), browserOpenCommand(), DevelopmentProcessDriver (+8 more)

### Community 42 - "FailingMutableStorage"
Cohesion: 0.09
Nodes (24): AngularHostSdkReference, ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk, AtlasSdkFactory, createAtlasHostDataSignal(), AngularInjectionDriver, CustomerHostSdk (+16 more)
...
Cohesion: 0.12
Nodes (18): VersionDropdownProps, CreateOverrideDocumentOptions, HostDataSnapshot, InspectAtlasHostDriver, installPage(), jsonResponse(), manifest(), PageOptions (+10 more)
...
Cohesion: 0.11
Nodes (31): AtlasHostRuntimeOptions, AtlasLoaderOptions, AtlasWidgetErrorRenderContext, AtlasWidgetLoaderOptions, AtlasWidgetRenderContext, AtlasWidgetUiOptions, createMountBoundary(), createRoutePlacementPlan() (+23 more)
...
Cohesion: 0.11
Nodes (8): AtlasBootstrapServiceOptions, bootstrapDigest(), SupportedFramework, frameworkLabel(), displayTarget(), AtlasGenerateService, AtlasWorkspace, AngularStylesheetFormat

### Community 56 - "target.ts"
Cohesion: 0.12
Nodes (24): asDependencyMap(), AtlasNxProjectType, AtlasPackageManager, AtlasScaffoldOptions, AtlasTask, AtlasWorkspaceKind, configuredNxOutputPaths(), createFormatGeneratedCommand() (+16 more)
...
Cohesion: 0.15
Nodes (19): assertLease(), DeploymentLease, encodeLease(), environmentBoolean(), environmentS3LockMode(), errorName(), errorStatus(), externalPublicationLease() (+11 more)
...
Cohesion: 0.08
Nodes (17): wait(), NetworkLimiter, docker(), execute, requireOk(), root, waitForHealth(), Bytes (+9 more)
...
Cohesion: 0.18
Nodes (14): normalizePath(), routeMatches(), segments(), AtlasPlacement, AtlasPlacementKind, AtlasRouteContribution, AtlasRouteNavigation, createManifestFromConfig() (+6 more)
...
### Community 70 - "nx.ts"
Cohesion: 0.11
Nodes (31): addUniqueString(), alignDelegatedAngularFederationConfig(), alignDelegatedTsconfig(), angularNativeFederationBuilder(), asObject(), atlasConfigNxTarget(), collectNxPathValues(), commandValues() (+23 more)
...
Cohesion: 0.14
Nodes (44): assertAtlasHostCatalog(), AtlasValidationError, formatAtlasValidationMessage(), AtlasValidationIssue, validateHostCatalog(), validateUniqueManifestIds(), FRAMEWORKS, isRoutePattern() (+36 more)
...
Cohesion: 0.12
Nodes (18): createReleaseWorkspace(), packageDirectories, writeJson(), main(), nextVersion(), prepareRelease(), releaseForArgument(), releaseTypes (+10 more)
...
Cohesion: 0.17
Nodes (9): createDevSession(), createLocalDevCatalog(), DevSessionEntry, DevelopmentSessionDriver, SessionScenario, HostDevSession, localHostPlaceholder(), uniqueArtifacts() (+1 more)
...
Cohesion: 0.23
Nodes (10): captureProcessOutput(), CliProcessDriver, forwardAndCapture(), processOutput, processOutputClosed, ProcessOutputDestinations, require, runProcess() (+2 more)
...
Cohesion: 0.25
Nodes (12): createLoadedHost(), HostContext, HostContextValue, HostLoadResult, readDisabledOverrides(), normalizeStoredManifest(), extractActiveOverrideManifests(), includeDisabledAppsInCatalog() (+4 more)
...
Cohesion: 0.32
Nodes (8): angularWidgetConfigArgument(), angularWidgetConfigImport(), angularWidgetConfigPath(), createAngularWidgetEntries(), createReactWidgetEntries(), reactWidgetEntry(), widgetNames(), writeWidgetEntry()
...
Cohesion: 0.14
Nodes (12): AtlasBootstrapFile, AtlasBootstrapOptions, AtlasBootstrapBuildResult, AtlasBootstrapDependencies, AtlasBootstrapService, AtlasRuntimeConfigRenderResult, BootstrapBuildService, defaultDependencies (+4 more)
...
Cohesion: 0.06
Nodes (37): execute(), ExecuteOptions, ExecuteResult, require, spawn, isPublished(), options, packageOrder (+29 more)

### Community 126 - "types.ts"
Cohesion: 0.21
Nodes (11): AtlasNavigationItemsService, Injectable, DomHostServices, DomRuntimeOptions, prepareStatusElement(), renderErrorState(), renderHostMountState(), renderHostNavigation() (+3 more)
...
Cohesion: 0.14
Nodes (11): AppComponent, Component, bootstrap(), DemoRouteAnchorComponent, HostMountRequest, Component, HostLayout(), HostMountRequest (+3 more)
...
Nodes (7): {
  ...
  createAngularFederationConfig,
}, createAngularFederationConfig(), createAngularFederationOptions(), projectPath(), sourcePath()
...
Cohesion: 0.08
Nodes (21): Input, AtlasAnchorComponent, AtlasAngularHostAnchors, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet, AtlasSlot (+13 more)
...
Cohesion: 0.10
Nodes (21): appendQueryValue(), matchRoutePart(), matchRoutePattern(), normalizePath(), parseQuery(), scopePath(), splitRoutePath(), toInnerPath() (+13 more)
...
Cohesion: 0.09
Nodes (34): AtlasPublicationStorage, artifactIndexPath(), artifactPrefix(), assertPublicationMetadata(), AtlasPrPruneResult, AtlasPrRemovalResult, AtlasPublicationInventory, AtlasPublishOptions (+26 more)
...
Cohesion: 0.17
Nodes (8): AtlasNativeFederationImporters, AtlasResolvedWidget, RegistrySnapshot, AtlasManifest, AtlasProductionSelection, AtlasStaticRegistry, AtlasSlotRenderRequest, AtlasAppEntry

### Community 158 - "React SDK"
Cohesion: 0.18
Nodes (11): renderLoading(), AtlasHostDataContext, AtlasSdk, AtlasSdkContext, useAppLoaded(), useAtlasSdk(), createReactAtlasSdk(), createWidgetComponent() (+3 more)
...
Cohesion: 0.13
Nodes (22): BootstrapScenario, BootstrapServerDriver, createBootstrapFileMap(), createBootstrapRequestHandler(), createUpgradeRequest(), hasFileExtension(), isBootstrapMethod(), matchesNativeProxyRoute() (+14 more)
...
Cohesion: 0.11
Nodes (28): defaultIgnoreFileDependencies, GeneratedFilesDriver, IgnoreScenario, ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS, existingPackageName(), hasAtlasIgnorePattern(), IgnoreFileDependencies (+20 more)
...
Cohesion: 0.26
Nodes (5): AtlasDevService, DevelopmentScenario, DevServiceDriver, AtlasDevBuildService, testTypeScriptConfig()

### Community 178 - "verify-bootstrap-container.js"
Cohesion: 0.20
Nodes (14): absoluteHttpUrl(), asRecord(), AssetExpectation, AtlasVerificationCheck, AtlasVerificationStatus, createReport(), FederationMetadata, httpOrigin() (+6 more)

### Community 179 - "[Unreleased]"
Cohesion: 0.40
Nodes (4): Added, Changed, Changelog, [Unreleased]

### Community 180 - "event-bus.ts"
Cohesion: 0.40
...
Cohesion: 0.10
Nodes (14): CliArguments, AtlasInvocation, InteractionDriver, InteractionScenario, resolveInvocation(), PromptTestDouble, title(), AtlasPrompter (+6 more)
...
Cohesion: 0.18
Nodes (11): devDependencies, @file-services/node, react-router-dom, @testing-library/user-event, @types/react-dom, @wix/wix-ui-icons-common, react-router-dom, @types/react-dom (+3 more)
...
Cohesion: 0.25
Nodes (13): ATLAS_BROWSER_LOADER, createAtlasBootstrapFiles(), createBootstrapHtml(), createNginxConfig(), cspSources(), escapeHtml(), MODULE_SHIM_SOURCE, normalizedOrigins() (+5 more)

### Community 240 - "WidgetRetryDriver"
Cohesion: 0.40
...
Cohesion: 0.35
Nodes (12): cliVersion(), configuredArtifactIds(), configuredRuntimeUrls(), positiveInteger(), printVerificationCheck(), publishAndVerify(), rollbackAndVerify(), runAtlasCli() (+4 more)
...
Cohesion: 0.12
Nodes (31): mapWithConcurrency(), artifactDirectoryUrl(), createNativeFederationImporters(), createTrustedNativeFederationImporters(), federationRemoteName(), fetchRemoteBytes(), hasMountFunction(), importNativeFederationRemote() (+23 more)
...
Cohesion: 0.10
Nodes (17): ArtifactOverrideVersion(), ArtifactOverrideVersionDriver, createArtifact(), manifest(), OVERRIDE_TYPE_LABELS, ArtifactsOverridesTable(), OverridesTableToolbarDriver, OverridesTableToolbar() (+9 more)

### Community 268 - "bootstrap.specs.ts"
Cohesion: 0.40
Nodes (5): scripts, build, test, test:e2e, typecheck

### Community 269 - "Consumer Testing"
Cohesion: 0.16
...
### Community 279 - ".run"
Cohesion: 0.48
Nodes (7): createPublicationStorage(), assertExpectedRegistryRevision(), AtlasPublishService, cleanupSupersededPublications(), publicationOrder(), readRegistry(), withPublicationLease()

### Community 285 - "app-navigator.ts"
Cohesion: 0.36
Nodes (5): addNavigationState(), AtlasNavigationTarget, createAppNavigator(), AppNavigatorDriver, AtlasNavigationState

### Community 286 - "host-navigation.ts"
Cohesion: 0.31
Nodes (7): createHostNavigationItems(), documentNavigationItems, normalizeRoutePath(), routeMatches(), RoutePlacement, routePlacementsForHost(), uniqueRoutePlacements()
...
### Community 313 - "package.json"
Cohesion: 0.50
Nodes (3): name, private, version

### Community 314 - "Manifests"
Cohesion: 0.67
Nodes (3): App manifest, Host manifest, Manifests

### Community 317 - "ArtifactOverrideVersion.driver.tsx"
Cohesion: 0.13
Nodes (7): App(), ArtifactConfigurationPage(), ArtifactsOverridesPage(), AppProvider(), root, RoutesDriver, ArtifactProps
...
## Knowledge Gaps
- **1622 isolated node(s):** `OVERRIDE_TYPE_LABELS`, `OverridesTableToolbarProps`, `CreateCustomManifestOptions`, `AtlasReleaseChannel`, `AtlasArtifactOverride` (+1617 more)
...
- `AtlasDevService` (2× useful, score=1.043511226) _(code changed — re-verify)_

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `startRemoteAssetRewrite()` connect `remote-assets.ts` to `Workspace integration`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `AtlasManifest` connect `Exported Widgets` to `index.ts`, `control-server.ts`, `Angular Generators`, `build.driver.ts`, `event-bus.ts`, `verify.service.ts`, `AtlasRuntimeController`, `verify-bootstrap-container.js`, `cli.service.ts`, `Security`, `dev.service.ts`, `host-navigation.ts`, `stylesheets.ts`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `HostLoaderDriver` connect `native-federation.ts` to `Angular Generators`?**
  _High betweenness centrality (0.010) - this node is a cross-community bridge._
- **What connects `OVERRIDE_TYPE_LABELS`, `OverridesTableToolbarProps`, `CreateCustomManifestOptions` to the rest of the system?**
