...
## Summary
- 4734 nodes · 8777 edges · 311 communities (246 shown, 65 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 129 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `57cfeb29`
...
## Communities (311 total, 65 thin omitted)
...
Cohesion: 0.20
Nodes (13): mapWithConcurrency(), artifactDirectoryUrl(), AtlasFederationAdapter, createNativeFederationImporters(), createTrustedNativeFederationImporters(), federationRemoteName(), fetchRemoteBytes(), hasMountFunction() (+5 more)
...
Cohesion: 0.18
Nodes (16): readWidgetRuntime(), sdkError(), SdkErrorOptions, assertPropertiesDoNotReplaceCore(), connectAtlasNavigationResolver(), createAtlasCoreSdk(), createAtlasSdk(), createHostData() (+8 more)
...
Cohesion: 0.15
Nodes (13): AngularWidgetRuntime, createHostDataListeners(), HOST_DATA_LISTENERS, HostDataListener, HostDataListenerRegistry, readHostDataListeners(), subscribeAtlasHostData(), updateAtlasHostData() (+5 more)
...
Cohesion: 0.08
Nodes (17): AtlasAppContext, AtlasAppMountRequest, AtlasAppMountResult, AtlasExportedWidgetMountRequest, AtlasExportedWidgetMountResult, AtlasRouteContext, AtlasScopedNavigation, AppOptions (+9 more)
...
### Community 41 - ".run"
Cohesion: 0.13
Nodes (22): completedProcessOutput(), writeDevOverrideDocument(), browserOpenCommand(), DevelopmentProcessDriver, RemoteEntryScenario, formatFrameworkServerError(), frameworkServerArguments(), logHostViewUrl() (+14 more)

### Community 42 - "FailingMutableStorage"
Cohesion: 0.11
Nodes (18): AngularHostSdkReference, withAtlasSdkProvider(), AppBootstrap, createExportedWidget(), defineExportedWidget(), ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk (+10 more)
...
Cohesion: 0.07
Nodes (49): createDomHostSdk(), createSdkProviders(), NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, AtlasLoaderOptions, AtlasWidgetErrorRenderContext, AtlasWidgetLoaderOptions (+41 more)
...
Cohesion: 0.09
Nodes (11): AtlasBootstrapService, AtlasBootstrapServiceOptions, bootstrapDigest(), CliArguments, SupportedFramework, frameworkLabel(), displayTarget(), AtlasGenerateService (+3 more)
...
Cohesion: 0.05
Nodes (94): cliActions(), cliSummary(), COMMAND_ALIASES, createCliError(), CliErrorDriver, ErrorScenario, errorCauseMessage(), errorCauses() (+86 more)
...
Cohesion: 0.15
Nodes (22): AtlasPublicationStorageSource, isPublicationStorage(), AtlasPublishConfig, AtlasPullRequestLookup, AtlasPullRequestResolver, AtlasPullRequestStatus, compilePublishConfig(), defineAtlasPublishConfig() (+14 more)
...
Cohesion: 0.09
Nodes (12): AtlasFetchHttpClient, HttpClient, HttpClientInput, HttpRequest, HttpRequestOptions, HttpRequestWithBody, HttpRequestWithBodyAndMethod, HttpRequestWithoutBody (+4 more)
...
Cohesion: 0.14
Nodes (14): documentNavigationItems, normalizeRoutePath(), routeMatches(), RoutePlacement, routePlacementsForHost(), uniqueRoutePlacements(), AtlasHostRuntimeOptions, RuntimeMount (+6 more)
...
Cohesion: 0.10
Nodes (36): BrowserErrorContext, createBrowserError(), logBrowserError(), emitHostError(), emitHostReady(), emitHostStart(), emitMountState(), reportRetryFailure() (+28 more)
...
Cohesion: 0.18
Nodes (8): DevelopmentPortsDriver, PortScenario, hostClientPortFallback(), resolveHostDevPorts(), DevelopmentScenario, DevServiceDriver, HostDevPorts, testTypeScriptConfig()
...
Cohesion: 0.11
Nodes (25): anchorKey(), readAtlasNavigationItems(), subscribeAtlasNavigationItems(), anchorTag(), AtlasDefaultHostLayout(), AtlasHostAnchorsContext, AtlasHostLayout(), AtlasHostProvider() (+17 more)
...
Cohesion: 0.14
Nodes (25): addNavigationState(), AtlasNavigationTarget, createAppNavigator(), AppNavigatorDriver, runtimeError(), RuntimeErrorOptions, assertRegistry(), assertWidgetId() (+17 more)
...
Cohesion: 0.07
Nodes (22): App(), ArtifactConfigurationPage(), ArtifactsOverridesPage(), ArtifactName(), ArtifactOverrideActions(), ArtifactOverrideToggle(), ArtifactOverrideVersion(), OVERRIDE_TYPE_LABELS (+14 more)
...
Cohesion: 0.09
Nodes (19): AtlasInvocation, InteractionDriver, InteractionScenario, resolveInvocation(), PromptTestDouble, title(), AtlasPrompter, UiDriver (+11 more)
...
## Knowledge Gaps
- **1604 isolated node(s):** `name`, `version`, `private`, `type`, `build` (+1599 more)
...
- **Why does `fetchJson()` connect `native-federation.ts` to `DirectoryPublicationStorage`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
- **Why does `AtlasManifest` connect `Exported Widgets` to `ArtifactConfigurationPage.tsx`, `AtlasManifest`, `Angular Generators`, `build.driver.ts`, `dom-host-runtime.ts`, `verify.service.ts`, `AtlasRuntimeController`, `remote-assets.ts`, `cli.service.ts`, `AtlasNavigation`, `Workspace integration`, `Security`, `runtime-discovery.ts`, `ArtifactsOverridesTable.tsx`, `stylesheets.ts`?**
  _High betweenness centrality (0.009) - this node is a cross-community bridge._
