# Graph Report - atlas  (2026-09-23)

## Corpus Check
- 1340 files · ~341,465 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 6922 nodes · 15774 edges · 391 communities (303 shown, 88 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 136 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `1f66706b`
...
- angular-federation.specs.ts
- package.json
- graphify reference: extra exports and benchmark
- dev.service.driver.ts
- Host bootstrap
...
- files
- atlas-manifest.ts
- federation-runtime.specs.ts
- playwright.config.ts
- clean-package-output.js
- tsconfig.json
- ts-jest
- runtime-config.specs.ts
- navigation.ts
- Atlas Overview
- pr-state-file.ts
- delay
...
- PublishServiceDriver
- arguments.driver.ts
- native-federation.driver.ts
- overrides.specs.ts
- @atlas/runtime
- @stylable/core
- scripts
- angular-local-runtime.ts
- angular-anchors.driver.ts
- workspace-commands.ts
- package.json
- mount-boundary.driver.ts
- jest-environment-jsdom
- remote-assets.driver.ts
- WidgetLoaderDriver
- AppNavigatorDriver
- @vitejs/plugin-react
- host-anchors.driver.ts
- host-ui.driver.ts
- ArtifactOverrideEditorPageActions.driver.tsx
- OverrideRadioCard.driver.tsx
- angular-local-runtime.driver.ts
- catalog-resolution.driver.ts
- trust-policy.driver.ts
- asset-url.driver.ts
...
1. `CliArguments` - 65 edges
2. `ArtifactVersion` - 53 edges
3. `AtlasWorkspace` - 40 edges
4. `toRecord()` - 39 edges
5. `readRequiredString()` - 38 edges
6. `AtlasRuntimeError` - 37 edges
7. `AtlasPublicationStorage` - 37 edges
8. `AtlasPublicationLease` - 35 edges
9. `recordOrEmpty()` - 35 edges
10. `AtlasSdk` - 34 edges

## Surprising Connections (you probably didn't know these)
- `bootstrap()` --indirect_call--> `AtlasAngularHostAnchors`  [INFERRED]
  examples/hosts/demo-angular-host/src/bootstrap.ts → packages/runtime/src/adapters/angular-anchors.ts
...
- `IsArtifactVersionSupportedByHostOptions` --references--> `ArtifactVersion`  [EXTRACTED]
  apps/columbus/src/scripts/artifact-versions/artifact-version-utils/artifact-version-utils.ts → apps/columbus/src/types/artifact-version.ts
- `readDeployedCatalog()` --indirect_call--> `isAppArtifactVersion()`  [INFERRED]
  apps/columbus/src/scripts/host/host-catalog/host-catalog.ts → apps/columbus/src/types/artifact-version.ts
- `LoadArtifactVersionFromHostTabOptions` --references--> `ArtifactVersion`  [EXTRACTED]
  apps/columbus/src/scripts/host/host-tabs/host-tabs.ts → apps/columbus/src/types/artifact-version.ts
...
Cohesion: 0.13
Nodes (31): aHostConfig(), anAppConfig(), aHostCatalog(), aHostRuntimeConfig(), createTestHostSdk(), aHostManifest(), ALL_CHANNELS, ALL_FRAMEWORKS (+23 more)

### Community 1 - "react-generator.ts"
Cohesion: 0.06
Nodes (38): App(), BrowserOverrideScopePickerDriver, ScopePickerProps, UseArtifactOverrideOptionsDriver, UseArtifactsDriver, ColumbusStateUpdater, ColumbusStateValue, ColumbusStateDriver (+30 more)

### Community 2 - "AtlasManifest"
Cohesion: 0.07
Nodes (33): AdapterOnlyOptionName, RUNTIME_ONLY_OPTIONS, RuntimeOnlyOptionName, DomHostSdkInput, SdkProviderInput, SdkProviders, DomHostOptions, AtlasHostRuntimeOptions (+25 more)

### Community 3 - "dom-host-runtime.ts"
Cohesion: 0.07
Nodes (40): appendNavigationStateToPath(), createAppNavigator(), AtlasNavigationTarget, NavigateToApp, startAtlasHostRuntime(), AnchorsListener, AppReadiness, HostPlacement (+32 more)

### Community 4 - "workspace.ts"
Cohesion: 0.09
Nodes (42): ArtifactOverrideEditorPage(), initialOverrideSelection(), BrowserOverrideScopePicker(), ScopePickerProps, ArtifactOverrideLocationState, useArtifactOverrideOptions(), artifactVersionFromSelection(), useHostArtifactVersionQuery() (+34 more)
...
Cohesion: 0.12
Nodes (33): aHostCatalog(), aHostManifest(), REQUIRED_STRING_FIELDS, ATLAS_DOM_ISOLATIONS, ATLAS_FRAMEWORKS, AtlasStylesheet, ATLAS_VERSION_CHANNELS, anAppManifest() (+25 more)
...
Cohesion: 0.09
Nodes (33): createAtlasHostDataSignal(), injectAtlasSdk(), createAngularAtlasSdk(), CreateAngularAtlasSdkInput, AngularAtlasSdkDriver, WidgetInputs, AngularLoadingRendererRequest, createAngularLoadingRenderer() (+25 more)

### Community 11 - "verify-generated-projects.js"
Cohesion: 0.08
Nodes (45): PreviewPruningDriver, isRegistryReferencing(), aRegistryWith(), RegistryState, createManifestDescriptor(), encodeManifestBytes(), isSameDescriptor(), ArtifactResolutionDriver (+37 more)
...
Cohesion: 0.10
Nodes (31): StartupCatalog, applyOverrides(), applyOverridesDocument, ApplyOverridesDriver, discoverDevelopmentSession, mergeDevelopmentSession, readStoredOverridesDocument, storeDevelopmentSession (+23 more)
...
Cohesion: 0.07
Nodes (31): Directive, Input, AtlasAnchorComponent, AtlasAngularHostAnchors, AtlasHostLayout, AtlasHostStatus, AtlasNavigation, AtlasRouteOutlet (+23 more)
...
Cohesion: 0.06
Nodes (50): RenderPlacementLoading, HostNavigationItemsInput, NavigateToItem, NavigationItemsListener, UnsubscribeNavigationItems, AtlasHostMountState, DeploymentManifestReference, LoadHostDeploymentOptions (+42 more)

### Community 22 - "manifest-utils.ts"
Cohesion: 0.09
Nodes (48): SelectedAppRelease, AtlasAppConfig, AtlasBaseConfig, AtlasHostConfig, AtlasRouteMount, AtlasSlotMount, AtlasWidgetConfig, assertAtlasManifest() (+40 more)
...
Cohesion: 0.18
Nodes (23): ControlRequest, ControlRequestHandler, createControlRequestHandler(), extractPathSegmentBetween(), loadPublishedCatalog(), parseControlRequest(), registerOverride(), respondWithDevelopmentSession() (+15 more)

### Community 25 - "native-federation.ts"
Cohesion: 0.15
Nodes (17): AtlasSdkProvider(), AtlasSdkProviderProps, AtlasHostDataContext, AtlasRuntimeContext, AtlasSdkContext, AtlasStyleTargetContext, AppLoadedConsumer(), UseAppLoadedDriver (+9 more)
...
Cohesion: 0.08
Nodes (25): bugs, description, engines, node, exports, files, homepage, atlas (+17 more)

### Community 30 - "publish.service.ts"
Cohesion: 0.12
Nodes (27): AtlasHostRuntimeConfig, isAbsoluteUrl(), resolveRegistryRootUrl(), validateRegistryRootUrl(), ResolveHostRuntimeConfigDriver, isHostRuntimeConfig(), resolveAtlasHostRuntimeConfig(), buildArtifactUrl() (+19 more)
...
Cohesion: 0.10
Nodes (20): bugs, description, engines, node, exports, homepage, license, main (+12 more)

### Community 33 - "package.json"
Cohesion: 0.06
Nodes (34): bugs, dependencies, @atlas/schema, @atlas/sdk, @faker-js/faker, description, engines, node (+26 more)

### Community 34 - "app.ts"
Cohesion: 0.15
Nodes (19): OverrideVersionDropdownDriver, OverrideVersionDropdownProps, isDeployedProductionVersion(), OverrideVersionDropdown(), OverrideVersionDropdownProps, ArtifactOverrideVersion(), OVERRIDE_TYPE_LABELS, createCustomArtifactVersion() (+11 more)
...
Cohesion: 0.14
Nodes (24): AngularPackageManifestOptions, buildAngularPackageManifest(), convertAngularVersionToRange(), AngularPackageGeneratorDriver, ANGULAR_DEPENDENCIES, ANGULAR_DEV_DEPENDENCIES, AngularFederationConfigOptions, ReactPackageGeneratorDriver (+16 more)

### Community 37 - "atlas-host.ts"
Cohesion: 0.14
Nodes (25): assertManifestSupportsHost(), assertOverrideMatchesManifest(), indexManifestsById(), resolveRuntimeCatalog(), resolveRuntimeManifests(), isMatchingResponse(), requestDevelopmentSession(), AtlasOverrideError (+17 more)

### Community 38 - "index.ts"
Cohesion: 0.09
Nodes (33): AngularBootstrapDriver, ASSET_BASE_URL, createAppConfig(), CustomerSdk, LOGO_URL, createExportedWidget(), forwardChangedInputs(), AppBootstrap (+25 more)

### Community 39 - "compilerOptions"
Cohesion: 0.06
Nodes (34): apps/**/*.driver.ts, apps/**/*.driver.tsx, apps/**/*.specs.ts, apps/**/*.specs.tsx, dist, jest, node, node_modules (+26 more)

### Community 40 - "Production deployment and CI"
Cohesion: 0.08
Nodes (38): createDomHostSdk(), pickHostDefinedSdkProperties(), DomHostSdk, AtlasHostAnchorRegistry, createAnchorKey(), AtlasHostAnchorKind, AtlasHostAnchorListener, ReleaseAnchor (+30 more)

### Community 41 - ".run"
Cohesion: 0.07
Nodes (22): createHostNavigation(), AngularHostNavigationDriver, createLocationStrategy(), AngularLocationStrategyDriver, notifyPopState(), AngularNavigateByUrlOptions, LocationBack, LocationHistoryGo (+14 more)

### Community 42 - "FailingMutableStorage"
Cohesion: 0.17
Nodes (9): DeploymentDriver, aDeploymentWith(), aReferenceTo(), DevelopmentSessionDriver, isSessionRequest(), MountHostCatalogDriver, aSha256DigestOf(), encodeTextAsBytes() (+1 more)
...
Cohesion: 0.06
Nodes (50): AtlasMountedApp, assertBytesMatchDescriptor(), assertDeploymentMatchesExpectation(), loadHostDeployment(), loadPublishedManifest(), parseArtifactManifestFromBytes(), parseHostDeploymentFromBytes(), parseJsonFromBytes() (+42 more)
...
Cohesion: 0.11
Nodes (23): HostFixture(), HostSdk, ReactHostDriver, AtlasAppAssets, createAtlasAppAssetFacade(), createAtlasAppAssets(), defineUnavailableAppAssets(), AppAssetsDriver (+15 more)
...
Cohesion: 0.08
Nodes (30): fetchDevelopmentSession(), loadForTab(), previewIdentity(), assertControlPort(), assertDevelopmentSession(), assertPreviewUrl(), DevelopmentSessionDependencies, DevelopmentSessionRequest (+22 more)

### Community 52 - "content-script.ts"
Cohesion: 0.13
Nodes (22): AngularFederationDriver, selectNativeFederationBuilder(), selectNativeFederationPackage(), LEGACY_CONFIG_API_MAJORS, MAIN_PACKAGE_MAJORS, V4_CONFIG_API_MAJORS, V4_PACKAGE_MAJORS, usesNativeFederationV4ConfigApi() (+14 more)

### Community 53 - "Workspace integration"
Cohesion: 0.15
Nodes (17): ControlServerDriver, buildLeaseFileId(), buildLeaseFilePath(), ControlServerLease, ControlServerLeaseDriver, ensureLeaseDirectory(), isActiveLease(), isProcessRunning() (+9 more)

### Community 54 - "AtlasGenerateService"
Cohesion: 0.08
Nodes (43): AtlasAppLoadError, AtlasHostRetryError, AtlasHostStartError, emitHostError(), emitHostReady(), emitHostStart(), emitMountState(), buildDefaultManifestUrl() (+35 more)
...
Cohesion: 0.06
Nodes (32): compilerOptions, baseUrl, composite, declaration, declarationMap, exactOptionalPropertyTypes, lib, module (+24 more)
...
Cohesion: 0.15
Nodes (14): createAtlasEventBus(), EventBusDriver, OrderEvents, OrderListener, AtlasEventBus, AtlasEventListener, AtlasEventMap, EventKey (+6 more)
...
Cohesion: 0.15
Nodes (20): collectConfiguredHostUrls(), printVerificationCheck(), splitUrlList(), verifyHostUrls(), deploy(), parsePreviewSelector(), prunePreviews(), removePreview() (+12 more)

### Community 64 - "DirectoryPublicationStorage"
Cohesion: 0.08
Nodes (26): readArtifactoryOptionsFromEnvironment(), resolveArtifactoryPublicUrl(), createStorageFromEnvironment(), DEFAULT_FACTORIES, PublicationStorageDriver, STORAGE_ENVIRONMENT_KEYS, isPublicationStorage(), AtlasPublicationStorageSource (+18 more)
...
### Community 70 - "nx.ts"
Cohesion: 0.12
Nodes (13): FetchJsonDriver, validateIntegrity, REQUEST_URLS, ValidateIntegrityDriver, validateIntegrity(), assertBytesMatchDescriptor(), AssertBytesMatchDescriptorDriver, assertBytesMatchDescriptor (+5 more)
...
Cohesion: 0.17
Nodes (12): esbuild, @faker-js/faker, devDependencies, @atlas/testkit, esbuild, @faker-js/faker, @atlas/testkit, @faker-js/faker (+4 more)
...
Cohesion: 0.06
Nodes (35): closeServer(), writeDevOverrideDocument(), DevelopmentPortsDriver, resolveHostClientPortFallback(), resolveHostDevPorts(), ResolveHostDevPortsOptions, assertUsableAngularBuildPackage(), CorruptAngularBuildPackage (+27 more)
...
Cohesion: 0.17
Nodes (15): ArtifactsListPageDriver, ArtifactsListTable, NOT_LOADED_HOST_STATUSES, ActionsDisabledDriver, HostValue, OverridesValue, NOT_APPLYING_OVERRIDE_STATUSES, NOT_LOADED_HOST_STATUSES (+7 more)

### Community 85 - "publish-config.ts"
Cohesion: 0.07
Nodes (23): aReport(), bootstrapBuild, buildServiceConstructor, CliServiceDriver, compileAtlasConfig, constructor(), deployRun, detectWorkspace (+15 more)
...
Cohesion: 0.52
Nodes (6): collectReexportedNames(), commonJsNamedExports(), initializeLexerOnce(), parseCommonJsEntry(), parseReexportedModule(), RESERVED_EXPORT_NAMES

### Community 102 - "Atlas Overview"
Cohesion: 0.07
Nodes (43): defaultIgnoreFileDependencies, GeneratedFilesDriver, ensureAtlasGeneratedFilesIgnored(), EQUIVALENT_ATLAS_IGNORE_PATTERNS, hasAtlasIgnorePattern(), IgnoreFileDependencies, isContainedBy(), isMissingFileError() (+35 more)
...
Cohesion: 0.33
Nodes (6): actionableMessage(), federationConfigError, FederationConfigErrorOptions, loadBundledTypescript(), loadProjectTypescript(), readProjectCompilerOptions()
...
Cohesion: 0.09
Nodes (21): bugs, description, engines, node, homepage, license, main, name (+13 more)
...
Cohesion: 0.24
Nodes (12): DEVELOPMENT_FACADE_DIRECTORY, DevelopmentFacadeOptions, reactBootstrapEntryPath(), writeReactDevelopmentFacade(), planReactFederationBuild(), composeReactViteConfig(), createReactAppViteConfig(), createReactHostViteConfig() (+4 more)

### Community 113 - "Build An Angular Host"
Cohesion: 0.12
Nodes (25): GeneratorsDriver, generateAppFiles(), generateHostFiles(), generateWidgetFiles(), InvalidFrameworkVersionError, InvalidGeneratorIdError, UnsupportedGeneratorFrameworkError, UnverifiedFrameworkVersionError (+17 more)
...
Cohesion: 0.16
Nodes (18): AtlasLocation, createHostNavigation(), ReactHostNavigationDriver, connectRouter(), createRouterOptions(), ReactRouterDriver, MemoryRouterOptions, pushRouterUrlToHost() (+10 more)

### Community 118 - "detectWorkspace"
Cohesion: 0.08
Nodes (30): parseRegistryRoot(), resolveRegistryLocations(), RegistryLocations, appendUrlPath(), computeSha256Integrity(), convertDigestToIntegrity(), DigestDriver, Sha256Digest (+22 more)
...
Cohesion: 0.07
Nodes (37): createBrowserAtlasLoaderDependencies(), AtlasLoaderDriver, loadStartupCatalog, publishRuntimeSnapshot, startAtlasLoader(), AtlasLoaderDependencies, LoaderContext, LoaderDocument (+29 more)
...
Cohesion: 0.25
Nodes (12): AtlasConfigDriver, renderAtlasAppConfig(), renderAtlasAppRoutes(), renderAtlasBootstrapHtml(), renderAtlasHostConfig(), convertIdToPascalCase(), convertIdToTitle(), TextDriver (+4 more)

### Community 130 - "create-release-bundle.js"
Cohesion: 0.10
Nodes (12): archives, artifacts, expectedArchives, packageDirectory, packageManifest, releaseDirectory, root, sha256() (+4 more)
...
Cohesion: 0.06
Nodes (48): assertAtlasHostCatalog(), AssertAtlasHostCatalogDriver, ValidateAtlasHostCatalogDriver, validateAtlasHostCatalog(), AtlasValidationError, AtlasValidationErrorDriver, formatAtlasValidationMessage(), AtlasValidationIssue (+40 more)
...
Cohesion: 0.19
Nodes (16): declaredPackageRanges(), exportMapSubpaths(), InstalledPackageInfo, matchesExportKey(), ProjectPackageJson, readInstalledPackageInfo(), resolveSharedEntry(), validateSharedSubpath() (+8 more)
...
Cohesion: 0.05
Nodes (51): readCliVersion(), runAtlasCli(), VERSION_ARGUMENTS, bootstrap(), compileConfig(), develop(), generate(), publish() (+43 more)
...
Cohesion: 0.24
Nodes (12): assertMetadata(), assertPayload(), createImmutable(), derivePublicationIdentity(), PublicationFilesDriver, isUnknownOutcome(), preparePublicationFiles(), PublicationFile (+4 more)

### Community 152 - "react.specs.ts"
Cohesion: 0.27
Nodes (11): ANGULAR_FEDERATION_SKIP, ANGULAR_SHARED_DEPENDENCY_OPTIONS, atlasExposesFor(), createAngularFederationConfig(), createAngularFederationOptions(), AngularFederationConfigOptions, AngularFederationOptions, AngularProjectExpose (+3 more)
...
Cohesion: 0.07
Nodes (28): BackgroundDriver, clearHostDataCache, fetch, loadDevelopmentSession, addWindowListener, artifactRegistry, BadgeScriptDriver, fetch (+20 more)
...
Cohesion: 0.06
Nodes (49): AngularWidgetOutletControllerDriver, WidgetInputs, sdkError(), createAtlasCoreSdk(), createAtlasSdk(), CommerceHostData, CommerceHostDataOption, CommerceHostSdk (+41 more)
...
Cohesion: 0.05
Nodes (62): AtlasBootstrapSignatureDriver, hasAtlasBootstrapSignature(), BadgeRefreshDependencies, countDevSessionOverrides(), CountDevSessionOverridesOptions, createBadgeRefresher(), DevSessionBadgeState, BadgeRefreshDriver (+54 more)
...
Cohesion: 0.06
Nodes (47): ArtifactRegistry, ArtifactVersions, createArtifactRegistry(), ArtifactRegistryDriver, fetchVerifiedManifest, fetchWithTimeout, readRegistry(), Registry (+39 more)
...
Cohesion: 0.09
Nodes (23): createDevSession(), createLocalDevCatalog(), createLocalHostPlaceholder(), dedupeManifests(), mergeLocalCatalog(), createDevSessionStore(), createHostDevSession(), DevSessionEntry (+15 more)

### Community 176 - "verify.service.ts"
Cohesion: 0.18
Nodes (12): MountAppDriver, acquireStylesheet(), createStylesheetRelease(), StylesheetOutcome, StylesheetsDriver, getLoadedStylesOfTarget(), loadedStylesByTarget, loadManifestStyles() (+4 more)
...
Cohesion: 0.10
Nodes (48): createRemoteAssetResolver(), hasSchemeOrIsProtocolRelative(), isFragmentUrl(), rewriteCssUrls(), addDocumentStyleRewriteSession(), createDocumentStyleRewriteRegistry(), createDocumentStyleRewriteSession(), documentStyleRewriteRegistries (+40 more)

### Community 182 - "asset-checks.ts"
Cohesion: 0.10
...
Cohesion: 0.08
Nodes (55): normalizeStoredArtifactVersion(), clearHostDataCache(), HostDataSnapshot, isHostDataSnapshot(), readHostDataCache(), writeHostDataCache(), ActiveHostData, readPersistedOverrideDocument (+47 more)
...
Cohesion: 0.18
Nodes (11): @atlas/bootstrap, @atlas/schema, @atlas/sdk, css-tree, dependencies, @atlas/bootstrap, @atlas/schema, dependencies (+3 more)

### Community 200 - "HostRuntimeDriver"
Cohesion: 0.15
Nodes (12): compilerOptions, declaration, exactOptionalPropertyTypes, module, moduleResolution, noEmitOnError, skipLibCheck, strict (+4 more)
...
Cohesion: 0.18
Nodes (11): devDependencies, @atlas/testkit, @faker-js/faker, @stylable/optimizer, @testing-library/dom, vite, @atlas/testkit, @faker-js/faker (+3 more)

### Community 207 - "keywords"
Cohesion: 0.40
Nodes (6): keywords, keywords, app, generator, native-federation, runtime

### Community 208 - "repository"
Cohesion: 0.22
Nodes (10): RenderHostError, RenderHostLoading, RetryHostStart, applyHostStateToContainer(), createHostUi(), renderDefaultError(), renderDefaultLoading(), AtlasHostUi (+2 more)
...
Cohesion: 0.13
Nodes (19): ArtifactUrlRejectedError, ArtifactVerificationFailedError, BootstrapError, BootstrapErrorCause, BootstrapTemplateInvalidError, CatalogInvalidError, DeploymentInvalidError, BootstrapErrorClass (+11 more)
...
### Community 212 - "files"
Cohesion: 0.22
Nodes (9): files, dist/**/*.d.ts, dist/**/*.js, dist/**/*.cjs, dist/**/*.d.cts, federation-config.cjs, federation-config.d.cts, federation-config.d.mts (+1 more)
...
Cohesion: 0.06
Nodes (23): AngularAdapterDriver, EagerSdkHostRoot, HostRoot, HostSdk, startDomHost, StartDomHostForHostSdk, Component, DomHostDriver (+15 more)

### Community 215 - "scripts"
Cohesion: 0.09
Nodes (25): @angular/compiler, @angular/compiler-cli, @angular/core, @angular/platform-browser, @atlas/testkit, devDependencies, @angular/compiler, @angular/compiler-cli (+17 more)
...
Cohesion: 0.08
Nodes (30): AtlasDeploymentCatalog, AtlasAppLoading, AtlasAppEntry, AtlasAppMountRequest, AtlasAppMountResult, AtlasHostClientEntry, AtlasHostMountRequest, AtlasMountOutcome (+22 more)
...
### Community 226 - "files"
Cohesion: 0.40
Nodes (5): files, files, dist/**/*.d.ts, dist/index.js, dist/**/*.js

### Community 227 - "atlas-manifest.ts"
Cohesion: 0.14
Nodes (21): createBootstrapFileMap(), createBootstrapRequestHandler(), createUpgradeRequest(), BootstrapServerDriver, hasFileExtension(), isBootstrapMethod(), matchesNativeProxyRoute(), matchesProxyContext() (+13 more)

### Community 228 - "federation-runtime.specs.ts"
Cohesion: 0.14
...
Cohesion: 0.28
Nodes (12): isModuleCallee(), isRuntimeImport(), runtimeModuleSpecifier(), runtimeModuleSpecifiers(), isSourceFile(), rootPackageName(), SOURCE_EXTENSIONS, TypeScriptModule (+4 more)
...
Cohesion: 0.27
Nodes (6): AtlasStyleTargetMissingError, createMountBoundary(), requireStyleTarget(), MountBoundary, MountBoundaryInput, MountBoundaryKind
...
Cohesion: 0.39
Nodes (6): extractLiteralConfigFieldValue(), formatAvailableAppsMessage(), listConfiguredWidgetApps(), readWidgetApp(), resolveWidgetApp(), WidgetAppSelection
...
Cohesion: 0.09
Nodes (40): extractErrorMessage(), parseAbsoluteHttpUrl(), VerifiedManifest, verifyAsset(), verifyExposes(), verifyFederationReferences(), verifyManifestAssets(), isHostDeployment() (+32 more)
...
Cohesion: 0.09
Nodes (47): AngularGenerationDriver, addUniquePolyfill(), AngularRunnerKey, configureAngularBuildNotifications(), configureAngularDevelopmentTargets(), enableAngularBuildNotifications(), ensureAngularFederationPolyfills(), ensureAngularNativeFederationTargets() (+39 more)
...
Cohesion: 0.29
Nodes (10): createAngularWidgetEntries(), createReactWidgetEntries(), exportedWidgetNames(), GeneratedWidgetEntry, ReactWidgetEntriesOptions, writeWidgetEntry(), WriteWidgetEntryRequest, angularWidgetEntry() (+2 more)
...
Cohesion: 0.08
Nodes (54): doesPathExist(), ProcessCommand, runProcess(), spawn, spawnProcess(), buildTurboTaskCommand(), buildWorkspaceTaskCommand(), createFormatGeneratedCommand() (+46 more)

### Community 285 - "AtlasVerifyService"
Cohesion: 0.15
Nodes (19): proxyModuleSource(), createSharedModuleProxy(), { loadSharedProxy }, SharedModuleProxyDriver, loadSharedProxy(), LoadSharedProxyRequest, sharedProxyId(), LoadSharedEntryInfo (+11 more)
...
### Community 290 - "PublishServiceDriver"
Cohesion: 0.67
...
Cohesion: 0.11
Nodes (16): ATLAS_LOGO, colorize(), colorizeRgb(), UiDriver, UiScenario, formatLogo(), indentContinuationLines(), MessageStatus (+8 more)
...
Cohesion: 0.43
Nodes (4): adaptRuleSelectors(), adaptShadowStyleSheet(), hasNestedRules(), isImportRule()
...
Cohesion: 0.09
Nodes (19): buildFrameworkServerArguments, FakeChildProcess, logHostViewUrl, openBrowserWhenReady, SessionRunnerDriver, startControlServer, waitForRemoteEntry, waitForShutdown (+11 more)
...
### Community 309 - "ArtifactsListTableToolbar.tsx"
Cohesion: 0.47
...
Cohesion: 0.27
Nodes (6): Angular Production Build and Publication, Native Federation, Verify, Change Gate, Coverage Inventory, Documentation Coverage
...
### Community 319 - "version-profiles.testkit.ts"
Cohesion: 0.09
Nodes (34): ArtifactOverrideEditorPageDriver, useArtifactOverrideOptions, HOST_CHANNELS, NOT_ERROR_OVERRIDE_STATUSES, UseHostArtifactVersionQueryDriver, HostArtifactVersionQueryOptions, HOST_SELECTION_TYPES, UseSaveArtifactOverrideMutationDriver (+26 more)
...
Cohesion: 0.16
Nodes (11): EventStreamClient, federationBuildNotificationsPlugin(), federationMetadataPlugin(), FederationMetadataPluginOptions, FederationExposeMetadata, FederationMetadata, FederationSharedMetadata, reactSourceReloadPlugin() (+3 more)

### Community 325 - "keywords"
Cohesion: 0.50
...
### Community 329 - "index.ts"
Cohesion: 0.06
Nodes (42): SdkErrorOptions, GoThroughHistoryDriver, goThroughHistory(), MatchRoutePatternDriver, matchRoutePart(), matchRoutePattern(), PartMatch, RoutePartRequest (+34 more)

### Community 331 - "Consumer Testing"
Cohesion: 0.40
Nodes (5): App Files, Choose Your Role, Host Files, React Project Guide, Task Guides

### Community 333 - "EmptyHostDataState.tsx"
Cohesion: 0.47
...
### Community 335 - "local-development.specs.ts"
Cohesion: 0.25
...
### Community 357 - "records.driver.ts"
Cohesion: 0.50
Nodes (4): scripts, build, test, typecheck

### Community 359 - "PublishServiceDriver"
Cohesion: 0.40
Nodes (5): dependencies, @atlas/schema, es-module-shims, @atlas/schema, es-module-shims

### Community 360 - "arguments.driver.ts"
Cohesion: 0.19
Nodes (8): installBridgeMarker(), buildDevelopmentBridgeMarkerSelector(), createBrowserBridgeDependencies(), DevelopmentSessionDriver, matchDevelopmentSessionResponse(), requestDevelopmentSession(), DevelopmentSessionBridgeDependencies, createBrowserFatalErrorDependencies()

### Community 362 - "overrides.specs.ts"
Cohesion: 0.43
Nodes (4): OverridesDriver, ALL_OVERRIDE_REASONS, anOverrideDocument(), anOverrideOf()

### Community 364 - "@stylable/core"
Cohesion: 0.53
...
### Community 367 - "angular-anchors.driver.ts"
Cohesion: 0.40
Nodes (3): AnchorsRoot, AngularAnchorsDriver, Component

### Community 369 - "package.json"
Cohesion: 0.50
Nodes (3): name, private, version

### Community 370 - "mount-boundary.driver.ts"
Cohesion: 0.50
Nodes (3): ALL_ISOLATIONS, ALL_KINDS, MountBoundaryDriver

### Community 381 - "ArtifactOverrideEditorPageActions.driver.tsx"
Cohesion: 0.38
...
### Community 382 - "OverrideRadioCard.driver.tsx"
Cohesion: 0.04
Nodes (36): AtlasHostProviderMissingError, AtlasSdkNotReadyError, AtlasAppRouteNotFoundError, AtlasSlotNameMissingError, AtlasDuplicateRouteError, AtlasRouteReconciliationError, AtlasAppMountExportMissingError, AtlasCatalogHostMismatchError (+28 more)

## Knowledge Gaps
- **1905 isolated node(s):** `navigationItemsByDocument`, `REQUEST_POLICY`, `networkIntegrityChecks`, `loadedStylesByTarget`, `WidgetProps` (+1900 more)
...
- `AtlasDevService` (2× useful, score=0.44636838)

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `createOverrideDocument()` connect `Releasing Atlas packages` to `ts-jest`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `AtlasPublishedArtifactManifest` connect `verify-generated-projects.js` to `cli-error.ts`, `index.ts`, `ts-jest`, `AtlasNavigation`, `manifest-utils.ts`, `AngularWidgetOutletController`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `loadBrowserRuntimeOverrides()` connect `atlas-host.ts` to `dev.service.ts`, `AtlasGenerateService`, `Releasing Atlas packages`?**
  _High betweenness centrality (0.037) - this node is a cross-community bridge._
- **What connects `navigationItemsByDocument`, `REQUEST_POLICY`, `networkIntegrityChecks` to the rest of the system?**
