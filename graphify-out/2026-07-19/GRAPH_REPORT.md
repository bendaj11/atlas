...
## Corpus Check
- 386 files · ~143,657 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3785 nodes · 6787 edges · 256 communities (216 shown, 40 thin omitted)
...
## Communities (256 total, 40 thin omitted)
...
Cohesion: 0.08
Nodes (35): AtlasHostUi, AtlasHostUiOptions, createMountBoundary(), createRoutePlacementPlan(), createRouteTitleController(), createWidgetCard(), createWidgetLoader(), defaultManifestTrustPolicy() (+27 more)
...
Cohesion: 0.10
Nodes (27): assertUsableAngularBuildPackage(), AtlasDevOverrideDocument, AtlasDevSessionDocument, BootstrapResponseOptions, CorruptAngularBuildPackage, createLocalDevCatalog(), deleteJson(), DevSessionEntry (+19 more)
...
Cohesion: 0.28
Nodes (16): artifactKey(), createOverrideDocument(), disabledOverridesKey(), errorMessage(), readDisabledOverrides(), writeDisabledOverrides(), createAppViewModel(), normalizeStoredManifest() (+8 more)

### Community 17 - "Community 17"
Cohesion: 0.06
Nodes (79): actionableMessage(), ensureActionableError(), suggestedActionFor(), assertAtlasManifest(), AtlasAppIndex, AtlasArtifactIndex, AtlasArtifactManifestBase, AtlasAppConfig (+71 more)
...
Cohesion: 0.17
Nodes (14): atlasDevActivationUrl(), AtlasDevBuildService, browserOpenCommand(), closeServer(), DevControlServer, frameworkServerArguments(), hostClientPortFallback(), logHostViewUrl() (+6 more)
...
Cohesion: 0.19
Nodes (17): channelRank(), supportsHost(), uniqueVersions(), versionKey(), Editor(), VersionDropdown(), versionOptionLabel(), baseUrlFromRemoteEntry() (+9 more)
...
Cohesion: 0.16
Nodes (22): assertLocalManifestUrls(), assertManifestAssetTrust(), assertManifestStylesTrust(), assertManifestSupportsHost(), assertTrustedAssetUrl(), bytesToBase64(), defaultFetchJson(), FetchBytes (+14 more)
...
Cohesion: 0.21
Nodes (19): findAtlasHostTab(), hasTabId(), InspectableTab, inspectTab(), isLoopbackPage(), isStoredManifest(), isStoredOverride(), isStoredOverrideDocument() (+11 more)
...
Cohesion: 0.18
Nodes (15): AtlasExtensionManifest, EditorProps, EditorOption(), EditorOptionProps, BrowserOverrideScopePicker(), ScopePickerProps, VersionDropdownProps, EditorDraft (+7 more)
...
Cohesion: 0.18
Nodes (10): AtlasArtifactOverride, AtlasHostData, AtlasOverrideDocument, AtlasReleaseChannel, hostEnvironment(), HostSummary(), HostSummaryProps, ChromeMockOptions (+2 more)
...
Cohesion: 0.26
Nodes (8): AtlasDevService, configuredHostIds(), isBaseHostUrl(), isHostConfig(), resolveHostId(), routeBasePaths(), urlWithBasePath(), AtlasConfig
...
Cohesion: 0.05
Nodes (25): AppBootstrap, ATLAS_APP_CONTEXT, ATLAS_SDK, AtlasSdk, injectAppLoaded(), injectAtlasAppContext(), AtlasSlotRenderRequest, AtlasAppContext (+17 more)
...
### Community 202 - "widget-registry.ts"
Cohesion: 0.68
...
Cohesion: 0.09
Nodes (28): DomHostOptions, NON_SDK_OPTION_NAMES, readSdkProperties(), SdkProviderInput, RoutePlacement, AtlasHostRuntimeOptions, AtlasLoaderOptions, AtlasWidgetErrorRenderContext (+20 more)
...
Cohesion: 0.10
Nodes (32): SupportedFramework, AtlasGenerateService, asStringRecord(), DEPENDENCY_FIELDS, dependencyDeclared(), DependencyField, dependencyManifestPath(), existingFrameworkVersionInfo() (+24 more)
...
### Community 261 - "generate-overlay.ts"
Cohesion: 0.33
...
- **Why does `manifest()` connect `Community 16` to `Community 1`, `Community 33`, `Community 36`, `Community 102`, `Community 39`, `Community 40`, `Community 42`, `Community 49`, `Community 17`, `Community 19`, `Community 20`, `Community 21`, `Community 83`, `Community 55`, `Community 51`, `Community 61`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `cleanupSupersededPublications()` connect `Community 61` to `Community 16`, `.hasFlag`, `Community 60`, `publish-config.ts`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Why does `AtlasManifest` connect `React Assets And Styles` to `Community 1`, `Community 98`, `react-router.ts`, `Community 102`, `Community 42`, `Community 17`, `Community 83`, `Community 20`, `Community 21`, `Community 51`, `Community 23`, `.hasFlag`, `Community 123`, `Community 31`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
